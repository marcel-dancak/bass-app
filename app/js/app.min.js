...
!function(){"use strict";function e(){return{scope:!1,link:function(e,t,o,a){window.SimpleScrollbar&&SimpleScrollbar.width>0?SimpleScrollbar.initEl(t[0],o.glScrollbar):t.css("overflow","auto")}}}function t(e,t,o,a,n,i,l,r,s,u,c,d,m,p,g,b,f,h){function v(){c.bufferLoader.onError=function(){n.show(n.simple().toastClass("error").textContent("Failed to load sound sample!").position("bottom center"))}}e.Note=g,e.settings=s,e.language="en",e.setLanguage=function(t){e.language=t,a.use(t),localStorage.setItem("preferences.lang",t)};var w=localStorage.getItem("preferences.lang");w&&e.setLanguage(w),e.ui={selectTrack:angular.noop,playlist:{},zoom:100,scale:1},e.setAppZoom=function(t){document.body.parentElement.setAttribute("zoom",t),document.body.setAttribute("zoom",t),e.ui.scale=100/t,e.ui.zoom=t,window.scale=100/t,localStorage.setItem("preferences.zoom",t)},e.setAppZoom(localStorage.getItem("preferences.zoom")||100),e.player={mode:l.hash()?1:0,playing:!1,play:angular.noop,input:c.input,countdown:!1,loop:!0,speed:100,playbackRange:{start:1,end:1,max:1},playbackRangeChanged:angular.noop,progress:{max:0,value:0},setProgress:angular.noop,graphEnabled:!1,visibleBeatsOnly:!1,playlist:[]},e.playlistLabel=function(t){var o=e.player.playlist[t-1];return o},c.bufferLoader=new BufferLoader(r,f),c.bufferLoader.loadResource("sounds/drums/drumstick",v,function(){c.bufferLoader.serverUrl=h,v()}),c.fetchResourcesWithProgress=function(o){var a=t.defer();return e.player.loading=!0,this.fetchResources(o).then(function(){a.resolve()},a.reject).finally(function(){e.player.loading=!1}),a.promise},c.input._volume=.75,e.bass={playingStyles:[{name:"finger",label:"FINGER"},{name:"slap",label:"SLAP"},{name:"pop",label:"POP"},{name:"pick",label:"PICK"},{name:"tap",label:"TAP"},{name:"hammer",label:"HAMMER_ON"},{name:"pull",label:"PULL_OFF"},{name:"ring",label:"LET_RING"}],settings:{label:"name-and-fret",colors:!0}},e.projectManager=m,e.workspace=u,e.barLabels={3:["trip","let"],4:["e","and","a"]},Object.defineProperty(g,"map",{value:"static",writable:!0}),g.map={};for(var y in g){var S=g[y];g.map[S.value]=S.symbol}e.Note=g,e.toggleVolumeMute=function(e){e.muted?e.audio.gain.value=e._volume||e.audio.gain.value:(e._volume=e.audio.gain.value,e.audio.gain.value=1e-4),e.muted=!e.muted},e.toggleInputMute=function(t){if(e.toggleVolumeMute(t),t.muted)console.log("mute microphone");else if(!t.source){var o=function(e){t.stream=e,t.source=r.createMediaStreamSource(e),t.source.connect(t.audio),d.activate(t.audio),t.audio.connect(r.destination)},a=function(){alert("Stream generation failed.")};navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia,navigator.getUserMedia({audio:!0},o,a)}},e.slidesSizeChanged=function(){d.updateSize()},e.showHelp=function(){i.show({templateUrl:"views/help/help.html",autoWrap:!1,clickOutsideToClose:!0,propagateContainerEvents:!0})},e.initSliders=function(){e.$broadcast("rzSliderForceRender")},p.Drums.icon="drums",p.Percussions.icon="percussions",document.addEventListener("visibilitychange",function(t){e.player.playing&&"hidden"===document.visibilityState&&(e.player.playing=!1,c.stop(),e.$apply())}),window.workspace=u,window.pm=m,window.av=d,window.oncontextmenu=function(){return!1}}t.$inject=["$scope","$q","$timeout","$translate","$mdToast","$mdDialog","$location","context","settings","workspace","audioPlayer","audioVisualiser","projectManager","Drums","Note","dataUrl","localSoundsUrl","soundsUrl"],angular.module("bd.app").controller("AppController",t).value("context",new AudioContext).value("workspace",{}).value("settings",{fretboard:{size:19}}).constant("Note",{Whole:{label:"WHOLE",symbol:"whole-note",value:1},Half:{label:"HALF",symbol:"half-note",value:2},Quarter:{label:"QUARTER",symbol:"quarter-note",value:4},Eighth:{label:"EIGHTH",symbol:"eighth-note",value:8},Sixteenth:{label:"SIXTEENTH",symbol:"sixteenth-note",value:16},ThirtySecond:{label:"THIRTYSECOND",symbol:"thirty-second-note",value:32}}).run(["$mdDialog",function(e){function t(){var e=Math.min(window.innerWidth,window.screen.width),t=1048,o=e/t;if(e<t){var a=document.head.querySelector('meta[name="viewport"]');a.setAttribute("content","initial-scale="+o+", maximum-scale=1, minimum-scale="+o+", width="+e)}}if(/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)&&(window.addEventListener("orientationchange",t),window.addEventListener("resize",function(){document.body.style.minHeight=window.innerHeight+"px"}),setTimeout(t,500)),!window.chrome){var o=e.alert().title("Warning").textContent("It is highly recommended to use Blink/Webkit based browser (Chrome, Chromium, Opera). Application may not work properly in other browsers.").ok("Close");e.show(o)}}]).directive("prettyScrollbar",e).config(["$mdThemingProvider",function(e){e.theme("default").primaryPalette("blue").accentPalette("blue-grey")}])}();
...
!function(){"use strict";function e(e){return{require:"ngModel",link:function(e,t,n,a){a.$validators.step&&delete a.$validators.step}}}function t(e){return function(t,n,a){var i=e(a.ngRightClick);n.bind("contextmenu",function(e){t.$apply(function(){e.preventDefault(),i(t,{$event:e})})})}}function n(e){return{scope:{model:"=bdTextarea"},template:'<textarea aria-label="Text" spellcheck="false" md-no-resize ng-model="model" ng-blur="setEditMode(false)"></textarea><span ng-click="setEditMode(true)" ng-bind="model"></span>',controller:["$scope","$element",function(t,n){t.editMode=!0,t.setEditMode=function(a){t.editMode=a,a&&e(function(){n[0].querySelector("textarea").focus(),t.$broadcast("md-resize-textarea")})}}]}}function a(e){return function(t,n,a){function i(e){e.stopPropagation(),e.preventDefault();var n=e.dataTransfer.files,a=n[0],i=new FileReader;i.onload=function(e){t.$apply(function(){var e={$file:{filename:a.name,content:i.result}};o(t,e)})},i.readAsText(a)}function r(e){e.stopPropagation(),e.preventDefault(),e.dataTransfer.dropEffect="copy"}var o=e(a.bdFileDrop);n.on("dragover",r),n.on("drop",i)}}n.$inject=["$timeout"],t.$inject=["$parse"],a.$inject=["$parse"],e.$inject=["$parse"],angular.module("bd.app").directive("bdTextarea",n).directive("ngRightClick",t).directive("bdFileDrop",a).directive("bdDisableStepValidator",e)}();
...
!function(){"use strict";function e(e,a,t,n,r){function o(){e.section.meta.chords.sort(function(e,a){var t=1e3*e.start[0]+10*e.start[1]+e.start[2],n=1e3*a.start[0]+10*a.start[1]+a.start[2];return t-n})}function i(){e.section.meta.chords.length&&e.selectChord(e.section.meta.chords[0])}function s(a){a.meta||(a.meta={chords:[]}),e.section=a,e.form={chord:null},i()}e.close=function(){o(),t.close(),n.un("sectionLoaded",s)},e.selectChord=function(a){e.form.chord=a},e.updatePosition=function(){r(),o()},e.updateChord=function(){var a=e.form.chord;a.root&&(a.root=a.root.replace("#","♯").replace("b","♭")),a.bass&&(a.bass=a.bass.replace("#","♯").replace("b","♭")),r()},e.newChord=function(){var a=[1,1,1];if(e.section.meta.chords.length){var t=e.section.meta.chords[e.section.meta.chords.length-1];a=[t.start[0]+1,1,1]}var n={start:a};e.section.meta.chords.push(n),e.selectChord(n)},e.keyPressed=function(a){if(46===a.keyCode){var t=e.section.meta.chords.indexOf(e.form.chord);t!==-1&&(e.form.chord=null,e.section.meta.chords.splice(t,1),i(),r())}},s(a.section),n.on("sectionLoaded",s)}function a(e,a,t,n,r,o,i,s,c,l,p,d,u,y,b,g,f){function m(){var e=b.lastSlide-b.firstSlide+1;if(e>I.beatsPerView)return!0}function k(a){if(!e.player.visibleBeatsOnly){var n=a.flatIndex-b.firstSlide,r=a.startTime-a.eventTime;a.flatIndex<b.barSwiper.snapIndex&&(n=b.lastSlide+n+1);var o=n-b.barSwiper.snapIndex;o>=I.slideOnBeat&&setTimeout(function(){e.player.playing&&b.slideTo(b.barSwiper.snapIndex+o,I.animationDuration,!0)},parseInt(1e3*r))}if(!c.enabled&&e.player.graphEnabled){var s=e.player.input.muted?i.track.audio:e.player.input.audio;console.log("activating track visualization"),c.activate(s)}c.enabled&&!e.player.graphEnabled&&c.deactivate(),c.enabled&&c.beatSync(a),L.beatSync(a),g.beatSync(a),t.nextTick(function(){e.player.progress.value=a.flatIndex-b.firstSlide+1})}function h(){console.log("** updateLockedPlayerRange");var e=b.getPosition();return e.end.flatIndex>e.start.flatIndex&&(s.playbackRange=e,!0)}function v(){return e.player.playing&&e.player.loop?(b.loopMode||e.player.visibleBeatsOnly||!m()||(b.createLoop(),b.reset()),void s.play(i.section,k,v)):(b.loopMode&&b.destroyLoop(),e.player.playing=!1,c.deactivate(),L.stop(),void(b.preRenderedSlides=T))}function S(a){var t=(i.section.timeSignature,[]),n=i.section.beatLabels();a.forEachBeat(function(e){var a=e.bar+"_"+e.beat;t.push({id:a,beat:e,type:i.track.type,beatLabel:n[e.beat]})}),e.slides=t}function w(){t.nextTick(function(){b.setSlides(e.slides,{slidesPerView:I.beatsPerView,slidesPerGroup:1}),e.player.playbackRangeChanged()})}function P(){var e=b.barSwiper.wrapper[0];Array.from(e.querySelectorAll(".chord")).forEach(function(e){e.remove()}),i.section.meta&&i.section.meta.chords&&i.section.meta.chords.forEach(function(e){var a=e.start[0],t=e.start[1],n=e.start[2]||1,r=b.getBeatElem(a,t),o='{0}<span class="type">{1}</span>'.format(e.root,e.type);e.bass&&(o+='<span class="slash">{0}</span>'.format(e.bass));var s=angular.element('<span class="chord">'+o+"</span>")[0],c=parseInt(100/r.childElementCount);1===t&&1===n?(s.style.left="14px",s.style.width="calc({0}% - 28px)".format(c)):(s.style.left=(n-1)*c+"%",s.style.width=c+"%"),angular.element(s).on("click",function(a){g.setChord(i.section,i.track.id,e)}),angular.element(s).on("dblclick",function(a){x(e)}),r.parentNode.appendChild(s)})}function x(a){function t(e){L.beatSync(e),g.beatSync(e)}function n(){s.playbackRange=l,e.player.playing=!1,L.stop()}var r=i.section.meta.chords.indexOf(a),o=i.section.meta.chords[r+1],c=o?angular.copy(o.start):[i.section.length+1,1,1];c[2]--,0===c[2]&&(c[1]--,c[2]=4),0===c[1]&&(c[0]--,c[1]=i.section.timeSignature.top);var l=s.playbackRange;s.playbackRange={start:{bar:a.start[0],beat:a.start[1]},end:{bar:c[0],beat:c[1]}},e.player.playing=!0,s.setBpm(i.section.bpm),L.start(),s.fetchResourcesWithProgress(i.section).then(s.play.bind(s,i.section,t,n),function(){e.player.playing=!1})}function C(a){g.clearDiagram(),c.clear(),c.reinitialize(),console.log("sectionLoaded"),console.log(a),i.section=a,e.player.playbackRange.start=1,e.player.playbackRange.max=a.length+1,e.player.playbackRange.end=e.player.playbackRange.max,e.player.progress.value=0;var n=i.track?i.track.id:"bass_0";i.trackSection=a.tracks[n],i.trackSection||(i.trackSection=R(l.project.tracksMap[n])),i.track=i.trackSection,i.track.id=n,S(i.trackSection),t.nextTick(function(){b.setSlides(e.slides,{slidesPerView:I.beatsPerView,slidesPerGroup:1}),e.player.playbackRangeChanged(),t.nextTick(function(){P()})})}function R(e){var a="drums"===e.type?d:u,t=new a(i.section,[]);return t.instrument=e.instrument,t.audio=e.audio,t.type=e.type,i.section.tracks[e.id]=t,t}f.initialize(".instrument-grid"),s.setPlaybackSpeed(1),e.swiperControl=b,e.slides=[],e.editor||(console.log("Initializing editor"),e.$root.editor={beatsPerView:8,slideOnBeat:1,animationDuration:250,fretboardVisible:!0,layoutLegend:function(e){return[4,8,12].indexOf(e)!==-1?e:null},animationLabel:function(e,a,t){return"scroll after {0} beats".format(e)}},!i.section&&l.section&&C(l.section));var T=2;b.preRenderedSlides=T;var I=e.editor;e.updateBeatsPerView=function(){I.beatsPerView=b.setBeatsPerView(I.beatsPerView)},e.player.visiblePlaybackModeChanged=function(a){if(a){var t=h();if(!t)return e.player.visibleBeatsOnly=!1,void n.show(n.simple().toastClass("error player").textContent("Cannot lock playback on current possition!").position("top center"));b.barSwiper.on("transitionEnd",h)}else b.barSwiper.off("transitionEnd",h),e.player.loop&&b.destroyLoop(),e.player.playbackRangeChanged(),e.player.playing&&e.player.loop&&m()&&b.createLoop()},e.player.playbackRangeChanged=function(){console.log("playbackRangeChanged");var a=i.section.timeSignature.top,t=e.player.playbackRange.start,n=e.player.playbackRange.end-1;s.playbackRange={start:{bar:t,beat:1},end:{bar:n,beat:i.section.timeSignature.top}};var r=(t-1)*a,o=n*a-1;b.setVisibleRange(r,o),e.player.progress.max=o-r+1;for(var c=[],l=a;l<e.player.progress.max;l+=a)c.push(l);e.player.progress.ticks=c,e.player.progress.legend=function(e){return 1+e/a}},L=new y(b),e.ui.bpmChanged=function(e){e&&s.setBpm(i.section.bpm)},e.player.setProgress=function(a,t){e.player.playing&&(e.player.playing=!1,s.stop(!0),e.player.progress.restartPlayback=!0),b.barSwiper.slideTo(t,0,!0)},e.player.progressReleased=function(t,n){e.player.progress.restartPlayback&&(e.player.progress.restartPlayback=!1,a(e.player.play,75))};var L;e.player.play=function(){e.player.graphEnabled&&c.clear(),g.clearDiagram();var a=b.getPosition().start;b.barSwiper.activeIndex=b.barSwiper.snapIndex,e.player.visibleBeatsOnly?h():(b.preRenderedSlides=I.slideOnBeat,e.player.loop&&m()&&b.createLoop(),b.updateSlidesVisibility()),e.player.playing=!0,s.setBpm(i.section.bpm),L.start(),b.lastRequestedIndex=b.barSwiper.snapIndex;var t={countdown:e.player.countdown,start:a};l.project.backingTrack&&Number.isFinite(i.section.backingTrackStart)&&(t.backingTrack={audio:l.project.backingTrack,start:i.section.backingTrackStart}),s.fetchResourcesWithProgress(i.section).then(s.play.bind(s,i.section,k,v,t),function(){e.player.playing=!1})},e.player.pause=function(){e.player.playing=!1,s.stop(!0)},e.player.goToStart=function(){var a=e.player.playing;e.player.playing&&e.player.pause(),e.player.progress.value=0,setTimeout(function(){b.reset(0),a&&e.player.play()},50)},e.playDrumSound=function(e){var a={drum:e,volume:.85};s.playDrumSample(i.track,a)},e.playPianoSound=function(e){var a={note:{name:e.label[0],octave:e.octave,length:.5},string:e.label[0]+e.octave,volume:.85};s.playPianoSample(i.track,a)},l.on("sectionLoaded",C),e.ui.selectTrack=function(a){console.log("selectTrack: "+a);var t=l.project.tracksMap[a];i.track!==t&&(i.track.type!==t.type&&(i.section.tracks[a]||R(t),i.trackSection=i.section.tracks[a],i.trackSection.track=t,b.switchInstrument(t.type)),i.track.id!==t.id&&(console.log("switch new track instrument"),i.section.tracks[a]||R(t),i.trackSection=i.section.tracks[a],i.trackSection.track=t,b.rebuildSlides()),i.track=t,i.track.id=a,e.ui.trackId!==a&&(e.ui.trackId=a))},i.section&&C(i.section),e.updateSlides=function(){S(i.trackSection),e.player.playbackRange.max=i.section.length+1,e.player.playbackRange.end=e.player.playbackRange.max,w()},i.metadataEditor=function(){var e=r.newPanelPosition().absolute().centerHorizontally().bottom("7%"),a=r.newPanelAnimation().openFrom({top:window.innerHeight/2,left:window.innerWidth/2-400}).closeTo({top:window.innerHeight/2,left:window.innerWidth/2-400}).withAnimation(r.animation.SCALE);r.open({templateUrl:"views/editor/section_chords.html",controller:"MetadataController",locals:{updateChordLabels:P},autoWrap:!1,hasBackdrop:!1,disableParentScroll:!1,clickOutsideToClose:!1,position:e,animation:a,panelClass:"metadata",onOpenComplete:function(e){var a=e[0].panelEl.parent();a.css("pointerEvents","none")}})},b.onTouchEnd=function(a){t.nextTick(function(){e.player.progress.value=a.snapIndex*I.beatsPerSlide})},e.$on("$destroy",function(){l.un("sectionLoaded",C)}),window.sw=b}e.$inject=["$scope","workspace","mdPanelRef","projectManager","updateChordLabels"],a.$inject=["$scope","$timeout","$mdUtil","$mdToast","$mdPanel","context","workspace","audioPlayer","audioVisualiser","projectManager","Drums","DrumTrackSection","TrackSection","HighlightTimeline","swiperControl","fretboardViewer","DragHandler"],angular.module("bd.app").controller("MetadataController",e).controller("EditModeController",a)}();
