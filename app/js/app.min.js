...
function BufferLoader(e,o){this.context=e,this.serverUrl=o,this.format="ogg",this.loadedResources={},this.loadingResources=[]}BufferLoader.prototype.loadResource=function(e,o,r){if(angular.isDefined(this.loadedResources[e]))return o&&o(this.loadedResources[e]),this.loadedResources[e];if(this.loadingResources.indexOf(e)===-1){var s=this,i=new XMLHttpRequest;i.open("GET",this.serverUrl+e+"."+this.format,!0),i.responseType="arraybuffer",i.onload=function(){s.context.decodeAudioData(i.response,function(r){var i=s.loadingResources.indexOf(e);return i!==-1&&s.loadingResources.splice(i,1),r?(s.loadedResources[e]=r,void(o&&o(r))):void alert("error decoding file data: "+e)},function(o){console.error("decodeAudioData error",o);var i=s.loadingResources.indexOf(e);i!==-1&&s.loadingResources.splice(i,1),r&&r(o)})},i.onerror=function(){alert("BufferLoader: XHR error");var o=s.loadingResources.indexOf(e);o!==-1&&s.loadingResources.splice(o,1)},i.send()}},BufferLoader.prototype.loadResources=function(e,o,r){e=e||[];for(var s=0,i=function(){s++,s===e.length&&o&&o()},n=0;n<e.length;++n)this.loadResource(e[n],i,r)};
...
!function(){"use strict";angular.module("ngMaterial",["ng","ngAnimate","ngAria","material.core","material.core.gestures","material.core.layout","material.core.theming.palette","material.core.theming","material.core.animate","material.components.backdrop","material.components.button","material.components.checkbox","material.components.dialog","material.components.icon","material.components.input","material.components.list","material.components.menu","material.components.menuBar","material.components.progressCircular","material.components.select","material.components.sticky","material.components.content","material.components.subheader","material.components.toast","material.components.panel","material.components.tooltip"])}();
...
!function(){"use strict";function e(){var e='<div class="help-drum-sheet"><div layout="column" class="drums-labels-container"><img ng-repeat="drum in workspace.trackSection.instrument track by drum.name" ng-src="{{ ::drum.image }}"></div><div layout="row"><div flex ng-repeat="slide in workspace.beatSlides" ng-include="\'views/editor/drum_beat2.html\'" class="beat-container beat instrument-slide"></div></div></div>';return{restrict:"A",scope:{config:"=bdHelpDrumSheet"},template:"",controller:["$scope","$element","$mdCompiler","Drums","DrumTrackSection","basicHandler",function(t,i,r,n,c,a){function o(e){return{id:e,initialized:!0,visible:!0,beat:t.workspace.trackSection.beat(1,e),type:"drums"}}t.initializeWorkspace=function(l){var s=(l.timeSignature||"4/4").split("/"),d={top:s[0],bottom:s[1]},u=n.Drums.slice(4);n.createIndex(u),t.workspace={selected:a.selected,section:{timeSignature:d,length:l.length||1}},t.workspace.trackSection=new c(t.workspace.section,[]),t.workspace.trackSection.instrument=u,t.workspace.beatSlides=[o(1),o(2)];var m='<div ng-controller="{0}">'.format(t.config.controller)+e+"</div>";r.compile({template:m}).then(function(e){var r=e.link(t);i.append(r)})},t.initializeWorkspace(t.config||{})}]}}angular.module("bd.help").directive("bdHelpDrumSheet",e)}();
...
!function(){"use strict";function t(t){return{scope:{config:"=bdFretDiagram"},controller:["$scope",function(e){function r(t){var e=t.split(":"),r=e[0],o=e[1],i=n.notes.map[o];n.strings[r].notes.indexOf(i);return{id:t,string:r,label:o,fret:n.strings[r].notes.indexOf(i),index:n.notes.list.indexOf(i)}}var o=e.config,n=t.track.instrument;console.log(o),e.instrument=n,e.rootNote=r(o.root),e.notes=o.notes.map(r),e.noteById={},e.notes.forEach(function(t){t.interval=t.index-e.rootNote.index,e.noteById[t.id]=t}),console.log(e.noteById);var i=[e.rootNote].concat(e.notes).map(function(t){return t.fret}),a=Math.min.apply(null,i),s=Math.max.apply(null,i);a=0,s=19,e.frets=[];for(var c=a;c<=s;c++)e.frets.push(c)}],templateUrl:"views/fret_diagram.html"}}function e(t,e,r){function o(){r._bassSoundScheduled=function(r,o){function i(t){return parseInt(1e3*(t-a))}if(n&&r===e.track.id){var a=t.currentTime;if("single"===o.type){var s="#"+o.string+"_"+o.note.name+o.note.octave,c=n.querySelector(s);setTimeout(function(t){t.classList.add("highlight")},i(o.startTime),c),setTimeout(function(t){t.classList.remove("highlight")},i(o.startTime+o.duration)-5,c)}else if("sequence"===o.type){var f=[];o.notes.forEach(function(t,e){var r;r=t.note.name?"#"+o.string+"_"+t.note.name+t.note.octave:".string.{0} .fret-{1} label".format(o.string,t.note.fret);var a=Array.from(n.querySelectorAll(r));setTimeout(function(t,e){e.forEach(function(t){t.classList.remove("highlight")}),t.forEach(function(t){t.classList.add("highlight")})},i(t.startTime),a,f),f=a});var l=o.notes[o.notes.length-1];setTimeout(function(){f.forEach(function(t){t.classList.remove("highlight")})},i(l.startTime+l.duration)-5)}else if("ghost"===o.type){var u=n.querySelector(".string.{0} .ghost-note label".format(o.string));setTimeout(function(){u.classList.add("highlight")},i(o.startTime)),setTimeout(function(){u.classList.remove("highlight")},i(o.startTime+o.duration))}}}}var n;return o.prototype.activate=function(t){n=t},o.prototype.clearDiagram=function(){if(n){var t=Array.from(n.querySelectorAll(".active"));t.forEach(function(t){t.classList.remove("active")});var e=n.querySelector(".root");e&&e.classList.remove("root")}},o.prototype.setChord=function(t,e,r){if(this.clearDiagram(),n&&r.root){var o="#{0}_{1}{2}".format(r.string,r.root,r.octave),i=n.querySelector(o);i&&i.classList.add("root");for(var a=r.start[0],s=r.start[1],c=r.start[2]||1,f=t.tracks[e],l=t.meta.chords.indexOf(r),u=t.meta.chords[l+1],d=u?u.start:[t.length+1,1,1],m=d[0],h=d[1],v=d[2],g=1e3*a+10*s+c,p=1e3*m+10*h+v,y=[],b=f.beat(a,s);b&&1e3*b.bar+10*b.beat<p;)Array.prototype.push.apply(y,f.beatSounds(b).filter(function(t){var e=1e3*b.bar+10*b.beat+t.start*b.subdivision+1;return e>=g&&e<p})),b=f.nextBeat(b);var T=new Set;y.forEach(function(t){if("ghost"!==t.note.type){var e="#"+t.string+"_"+t.note.name+t.note.octave;T.add(e)}if("slide"===t.note.type){var e="#"+t.string+"_"+t.note.slide.endNote.name+t.note.slide.endNote.octave;T.add(e)}});var S=Array.from(T).join(",");S&&Array.from(n.querySelectorAll(S)).forEach(function(t){t.classList.add("active")})}},o.prototype.beatSync=function(t){if(t.section.meta&&t.section.meta.chords){var r=t.section.meta.chords.find(function(e,r){return e.start[0]===t.bar&&e.start[1]===t.beat});if(r){var o=r.start[2]||1,n=t.startTime-t.eventTime+(o-1)*t.duration/4;setTimeout(function(){this.setChord(t.section,e.track.id,r)}.bind(this),parseInt(1e3*n)-10)}}},new o}t.$inject=["workspace"],e.$inject=["context","workspace","audioPlayer"],angular.module("bd.app").directive("bdFretDiagram",t).factory("fretboardViewer",e)}();
...
!function(){"use strict";function e(e){this.resource=e}function t(t,n,a,r,o,i,s,u,c){function l(e,t){function n(t){for(var n,a=c.noteValue(t),r=1e3,o=0;o<e.length;o++){var i=e[o],s=c.codeTovalue(i),u=a-s;if(!(Math.abs(u)<Math.abs(r)))break;r=u,n=i}return{code:n,shift:r}}var a={};return t.list.forEach(function(e){var t={name:e.label[0],octave:e.octave},r=c.noteValue(t),o=n(t);a[r]=o}),a}function d(e,t){var n=(e.end-e.start)*t;return e.note.staccato&&(n=.95*n-t/4*.2),n}function p(){i.call(this,["playbackStarted","playbackStopped"]),this.playing=!1,this.countdown=!1,this.setBpm(60),this.setPlaybackSpeed(1),this.bufferLoader=new BufferLoader(r,o),this.scheduledSounds=[],this.input={muted:!0,audio:r.createGain()},this.input.audio.gain.value=.001,this.bufferLoader.loadResource("sounds/drums/drumstick");var t=this;this.soundHandlers=[{accepts:function(e){return"hammer"===e.style||"pull"===e.style},getResources:function(e,t){for(var n=t;n.prev;)n=e.prevSound(n);return["sounds/bass/{0}/{1}{2}".format(n.style,t.string,t.note.fret)]},transitionPlayback:function(e,n,a,r,o){var i=e[e.length-1],s=t.createSoundAudio(n,a,r),u=d(a,o);s.duration=u,s.endTime=r+u,t.composer.join(i,s),s.meta={type:"single",string:a.string,note:a.note,startTime:r,duration:u},e.push(s)}},{accepts:function(e){return"slide"===e.note.type},getResources:function(e,t){for(var n=t;n.prev;)n=e.prevSound(n);for(var a=t.note.fret>t.note.slide.endNote.fret?-1:1,r=t.note.slide.endNote.fret+a,o=[],i=t.note.fret;i!==r;i+=a)o.push("sounds/bass/{0}/{1}{2}".format(n.style,t.string,i));return o},slideCurve:function(e,t,n,a){var r=d(e,t),o=Math.abs(e.note.fret-e.note.slide.endNote.fret),i=new Array(o+2);i[0]=Math.max(r*n,.02),i[i.length-1]=Math.max(r*a,.02);var s=r-i[0]-i[i.length-1];if(e.note.slide.easing)for(var u=e.note.slide.easing,c=new BezierEasing(u[0],u[1],u[2],u[3]),l=1;l<=o;l++){var p=c(l/o)-c((l-1)/o);i[l]=p*s}else{var f=s/o;i.fill(f,1,1+o)}return i},metaNotes:function(e,t,n){var a=[];a.push({note:e.note,startTime:t,duration:n[0]});for(var r=e.note.slide.endNote.fret>e.note.fret?1:-1,o=1;o<n.length-2;o++){var i=a[a.length-1];a.push({note:{fret:e.note.fret+o*r},startTime:i.startTime+i.duration,duration:n[o]})}return a.push({note:e.note.slide.endNote,startTime:a[a.length-1].startTime+a[a.length-1].duration,duration:n[n.length-1]}),a},prepareForPlayback:function(e,n,a,r){var o=n.note.slide.start||.2,i=n.note.slide.end||.8,s=this.slideCurve(n,r,o,1-i),u=t.composer.createSlide(e,null,n,s,a,r);return u[0].meta={type:"sequence",string:n.string,notes:this.metaNotes(n,a,s)},u},transitionPlayback:function(e,n,a,r,o){var i=e.pop(),s=a.note.slide.start||.05,u=a.note.slide.end||.85,c=this.slideCurve(a,o,s,1-u),l=t.composer.createSlide(n,i,a,c,r,o),d=i.meta?i:e[0],p=this.metaNotes(a,r,c);d.meta.notes?Array.prototype.push.apply(d.meta.notes,p):(p.splice(0,0,{note:d.meta.note,startTime:d.meta.startTime,duration:d.meta.duration}),d.meta={type:"sequence",string:a.string,notes:p}),Array.prototype.push.apply(e,l)}},{accepts:function(e){return"ring"===e.style},getResources:function(e,t){return[]},prepareForPlayback:function(){},transitionPlayback:function(e,n,a,r,o){var i=e[e.length-1],s=d(a,o);if(i.duration+=s,i.endTime+=s,"bend"===a.note.type&&t.composer.bend(i,a,s,r,o),i.meta)i.meta.duration+=s;else for(var u=e.length-1;u>=0;u--){var c=e[u].meta;if(c&&c.notes){console.log("found prev meta at: "+u),c.notes[c.notes.length-1].duration+=s;break}}}},{accepts:function(e){return"grace"===e.note.type},getResources:function(e,t){return["sounds/bass/{0}/{1}{2}".format(t.style,t.string,t.note.fret-2),"sounds/bass/{0}/{1}{2}".format(t.style,t.string,t.note.fret)]},prepareForPlayback:function(e,n,a,r){console.log("grace sound");var o=.08,i=t.createSoundAudio(e,n,a),s=t.createSoundAudio(e,n,a+o,1),u=d(n,r);return i.duration=o,i.endTime=a+i.duration,s.duration=u-i.duration,s.endTime=a+u,t.composer.join(i,s),s.meta={type:"sequence",string:n.string,notes:[{note:{fret:n.note.fret-2},startTime:a,duration:o},{note:n.note,startTime:a+o,duration:u-o}]},[i,s]}},{accepts:function(e){return"bend"===e.note.type},getResources:function(e,t){return["sounds/bass/{0}/{1}{2}".format(t.style,t.string,t.note.fret)]},prepareForPlayback:function(e,n,a,r){var o=t.createSoundAudio(e,n,a),i=d(n,r);return o.duration=i,o.endTime=a+i,t.composer.bend(o,n,i,a,r),o.meta={type:"single",string:n.string,note:n.note,startTime:a,duration:i},[o]}},{accepts:function(e){return"ghost"===e.note.type},getResources:function(e,t){return["sounds/bass/{0}/{1}X".format(t.style,t.string)]},prepareForPlayback:function(e,n,a,r){var o=t.createSoundAudio(e,n,a);return o.duration=.25,o.endTime=a+o.duration,o.meta={type:"ghost",string:n.string,startTime:a,duration:o.source.buffer.duration},[o]}},{accepts:function(e){return"harmonics"===e.note.type},getResources:function(e,t){return["sounds/bass/{0}/{1}{2}_H".format(t.style,t.string,t.note.fret)]},prepareForPlayback:function(e,n,a,r){var o=t.createSoundAudio(e,n,a),i=d(n,r);return o.duration=i,o.endTime=a+i,o.meta={type:"single",string:n.string,note:n.note,startTime:a,duration:i},[o]}},{accepts:function(e){return"regular"===e.note.type},getResources:function(e,t){return["sounds/bass/{0}/{1}{2}".format(t.style,t.string,t.note.fret)]},prepareForPlayback:function(e,n,a,r){var o=t.createSoundAudio(e,n,a),i=d(n,r);return o.duration=i,o.endTime=a+i,o.meta={type:"single",string:n.string,note:n.note,startTime:a,duration:i},[o]}}],this.composer=new s(r,this);var n={notes:new c("A0","C7"),playingSounds:{},createSoundAudio:function(n,a,o,i){var s=t.bufferLoader.loadResource(i);if(s){var u=r.createBufferSource(),c=r.createGain();return u.connect(c),c.connect(n.audio),u.buffer=s,{sound:a,source:u,gain:c.gain,output:c,startTime:o,endTime:o,duration:0,offset:0}}throw new e(i)},handlers:[{accepts:function(e){return angular.isDefined(e.note)},getResources:function(e,t){var a=e.instrument.preset,r=n.samples[a][c.noteValue(t.note)];return["sounds/piano/"+a+"/"+r.code.replace("♭","b")]},prepareForPlayback:function(e,t,a,r,o){var i=this.getResources(t,a),s=n.createSoundAudio(t,a,r,i[0]),u=(a.end-a.start)*o,l=n.samples[t.instrument.preset][c.noteValue(a.note)];if(0!==l.shift){var d=Math.pow(Math.pow(2,1/12),l.shift);s.source.playbackRate.value=d}return s.duration=u,s.endTime=r+u,[s]}}],getHandler:function(e){for(var t=0;t<this.handlers.length;t++){var n=this.handlers[t];if(n.accepts(e))return n}}},a=l("C1 E♭1 G♭1 A1 C2 E♭2 G♭2 A2 C3 E♭3 G♭3 A3 C4 E♭4 G♭4 A4 C5 E♭5 G♭5 A5 C6 E♭6 G♭6 A6 C7 E♭7 G♭7 A7".split(" "),n.notes),u=l("F1 B1 E2 A2 D3 G3 B3 D4 F4 B4 E5 A5 D6 G6 C7".split(" "),n.notes);n.samples={acoustic:a,electric:u},this.piano=n,n.strings=[new c("E3","E5"),new c("B2","B4"),new c("G2","G4"),new c("D2","D4"),new c("A1","A3"),new c("E1","E3")],n.note=function(e,t){var n=this.strings[e],a=n.list[t];return a.label[0]+a.octave},window.p=n}return p.prototype=Object.create(i.prototype),p.prototype._playDrumStick=function(e){var t=this.bufferLoader.loadResource("sounds/drums/drumstick"),n=r.createBufferSource();n.buffer=t,n.connect(r.destination),n.start(r.currentTime,0,.2)},p.prototype._playDrumSound=function(e,t,n){var a=this.bufferLoader.loadResource(e.instrument.drumMap[t.drum].filename);if(a){var o=r.createBufferSource();o.buffer=a;var i=r.createGain();i.gain.value=t.volume,o.connect(i),i.connect(e.audio),o.start(n),this.scheduledSounds.push({gain:i.gain,endTime:n+o.buffer.duration})}},p.prototype.createSoundAudio=function(t,n,a,o){var i=this._getSoundHandler(n).getResources(t,n),s=i?this.bufferLoader.loadResource(i[o||0]):null;if(s){var u=r.createBufferSource(),c=r.createGain();return u.connect(c),c.connect(t.audio),u.buffer=s,{sound:n,source:u,gain:c.gain,output:c,startTime:a,endTime:a,duration:0,offset:0}}throw new e(i[o||0])},p.prototype._getSoundHandler=function(e){for(var t=0;t<this.soundHandlers.length;t++){var n=this.soundHandlers[t];if(n.accepts(e))return n}},p.prototype._bassSoundScheduled=function(e,t){},p.prototype._playSound=function(e,t,n,a,r,o){var i,s=d(a,o);if(a.prev&&(i=this.piano.playingSounds[a.string]),!a.prev||!i){if(i=this.piano.getHandler(a).prepareForPlayback(e,t,a,r,o)[0],!i)return;i.gain.setValueAtTime(.8*i.sound.volume,r),a.next?i.source.start(i.startTime,i.offset):i.source.start(i.startTime,i.offset,s+.25),this.scheduledSounds.push(i),this.piano.playingSounds[a.string]=i}i.endTime=r+s,a.next||(i.gain.setValueAtTime(.8*i.sound.volume,i.endTime-.05),i.gain.linearRampToValueAtTime(1e-4,i.endTime+.2))},p.prototype._playBassSound=function(e,t,n,a,r){if(!n.prev){var o=this._getSoundHandler(n).prepareForPlayback(t,n,a,r),i=o[0];if(i.gain.setValueAtTime(i.sound.volume,a),n.next)for(var s=t.nextSound(n);s;){var u=o[o.length-1].endTime;this._getSoundHandler(s).transitionPlayback(o,t,s,u,r),i=o[o.length-1],s=s.next?t.nextSound(s):null}i=o[o.length-1];var c=i.slide?i.slide.volume:i.sound.volume;i.gain.setValueAtTime(c,i.endTime-.015),i.gain.linearRampToValueAtTime(1e-5,i.endTime);for(var l=0;l<o.length;l++){var d=o[l];d.source.start(d.startTime,d.offset,d.duration),this.scheduledSounds.push(d),d.meta&&this._bassSoundScheduled(e,d.meta)}return i}},p.prototype.playBeat=function(n,a,o,i){if(this.playing){var s=n===this.playbackRange.start.bar&&a===this.playbackRange.start.beat,u=s&&!i,c=this.section.timeSignature,l=r.currentTime,d=60/(this.bpm*this.playbackSpeed);if(!u){for(var p in this.section.tracks){var f=this.section.tracks[p],h=f.beat(n,a);f.beatSounds(h).forEach(function(t){var n=o+t.start*d;try{"bass"===f.type?this._playBassSound(p,f,t,n,d):"drums"===f.type?this._playDrumSound(f,t,n):this._playSound(p,f,h,t,n,d)}catch(t){if(!(t instanceof e))throw t;console.log("Failed to load resource: "+t.resource)}},this)}var g=(n-1)*this.section.timeSignature.top+a-1;this.beatPreparedCallback({section:this.section,bar:n,beat:a,eventTime:l,startTime:o,endTime:o+d,duration:d,timeSignature:this.section.timeSignature,flatIndex:g,playbackActive:!u,playbackStart:s})}if(this.scheduledSounds.length&&(this.scheduledSounds=this.scheduledSounds.filter(function(e){return l<=e.endTime})),u)t(function(){this.stop()}.bind(this),1e3*(o-l));else{var m,y,b=a===c.top,u=n===this.playbackRange.end.bar&&a===this.playbackRange.end.beat;u?(m=this.playbackRange.start.bar,y=this.playbackRange.start.beat):(m=b?n+1:n,y=b?1:a+1);var v=o+d;if(v<l+.075)return void this.stop();var S=1e3*(v-l-.2);S=Math.max(S,75),this.lastSyncTimerId=setTimeout(this.playBeat.bind(this),S,m,y,v)}}},p.prototype._play=function(e){var t=r.createGain();t.gain.value=1e-4,e.backingTrack&&(e.backingTrack.audio.addEventListener("playing",function(){console.log("backingTrack playing")}),e.backingTrack.audio.currentTime=e.backingTrack.start||0,e.backingTrack.audio.play(),this.backingTrack=e.backingTrack),this.piano.playingSounds={};var n=e.start||this.playbackRange.start,a=n.bar,o=n.beat;this.playBeat(a,o,r.currentTime,!0)},p.prototype.setBpm=function(e){this.bpm=e},p.prototype.setPlaybackSpeed=function(e){this.playbackSpeed=e},p.prototype.fetchSoundResources=function(e,t){if(t.style&&t.note){var n=this._getSoundHandler(t).getResources(e,t);this.bufferLoader.loadResources(n)}},p.prototype.fetchResources=function(e,t){function n(){s.resolve(),t&&t.apply(o,i)}function r(e){e.forEach(function(e){u.indexOf(e)===-1&&u.push(e)})}angular.isArray(e)||(e=[e]);var o=arguments[2],i=Array.prototype.slice.call(arguments,3),s=a.defer(),u=[];return e.forEach(function(e){for(var t in e.tracks){var n=e.tracks[t];"bass"===n.type&&n.forEachSound(function(e){e.note&&e.style&&r(this._getSoundHandler(e).getResources(n,e))},this),"piano"===n.type&&n.data.forEach(function(e){e.data.forEach(function(e){r(this.piano.getHandler(e).getResources(n,e))},this)},this)}},this),console.log(u),u.length?(this.bufferLoader.loadResources(u,n,s.reject),s.promise):(t&&t.apply(o,i),a.when())},p.prototype.play=function(e,t,n,a){function r(){i>0?(i--,o.playing&&(o._playDrumStick(),setTimeout(r,6e4/(o.bpm*o.playbackSpeed)))):o._play(a)}a=a||{},this.section=e,this.playing=!0,this.lastSyncTimerId=0;var o=this;this.beatPreparedCallback=angular.isFunction(t)?t:angular.noop,this.playbackStoppedCallback=angular.isFunction(n)?n:angular.noop;var i=a.countdown?3:0;r()},p.prototype.stop=function(e){if(this.playing=!1,this.lastSyncTimerId&&clearTimeout(this.lastSyncTimerId),e){var t=r.currentTime;this.scheduledSounds.forEach(function(e){try{t<e.startTime?e.source.stop():(e.gain.cancelScheduledValues(t),e.gain.setValueAtTime(e.gain.value,t),e.gain.linearRampToValueAtTime(1e-4,t+.05))}catch(e){console.log("Error")}}),this.backingTrack&&this.backingTrack.audio.pause()}this.playbackStoppedCallback()},p.prototype.playBassSample=function(e,t){function n(n){setTimeout(function(){s.playingBassSample=s._playBassSound(null,e,t,r.currentTime,60/(s.bpm*s.playbackSpeed)),s.playingBassSample.source.playing=!0,s.playingBassSample.source.addEventListener("ended",function(e){e.target.playing=!1})},50)}var a=this._getSoundHandler(t).getResources(e,t);if(t.next)for(var o=t;o.next;){o=e.nextSound(o);var i=this._getSoundHandler(o).getResources(e,o);i.forEach(function(e){a.indexOf(e)===-1&&a.push(e)})}console.log(a);var s=this;if(s.playingBassSample&&s.playingBassSample.source.playing){var u=r.currentTime;s.playingBassSample.gain.cancelScheduledValues(u),s.playingBassSample.gain.setValueAtTime(s.playingBassSample.gain.value,u),s.playingBassSample.gain.linearRampToValueAtTime(1e-4,u+.05)}this.bufferLoader.loadResources(a,n)},p.prototype.playPianoSample=function(e,t){t.start=0,t.end=.5;var n=this.piano.getHandler(t).getResources(e,t);this.bufferLoader.loadResources(n,this._playSound.bind(this,e.id,e,{subdivision:4},t,r.currentTime,1))},p.prototype.playDrumSample=function(e,t){this._playDrumSound(e,t,r.currentTime)},new p}t.$inject=["$timeout","$http","$q","context","soundsUrl","Observable","AudioComposer","projectManager","Notes"],angular.module("bd.app").factory("audioPlayer",t)}();
!function(){"use strict";function t(t){this.readOnly=!0,this.projectData=t}function e(){this.readOnly=!1,this.PROJECTS_KEY="bd.projects",this.projects=this.projectsList()}function o(t){return"bd.project.{0}".format(t)}function i(t){return"bd.playlists.{0}".format(t)}function r(t,e){return"bd.section.{0}.{1}".format(t,e)}function s(t){return t.reduce(function(t,e){return e.id>=t?e.id+1:t},1)}function c(t){return function(e){return e.id===t}}function a(t,o,i,r,a,n,p,l,u,h){function d(){this.store=new e,r.call(this,["projectLoaded","playlistLoaded","sectionLoaded","sectionDeleted","sectionCreated"])}function f(t){t.beatLabels=function(){var t=new Array(13);if(this.barSubdivision)for(var e=this.barSubdivision.split("+").map(Number),o=1,i=0;i<e.length;i++)for(var r=1,s=e[i];s--;)t[o++]=r++;else for(var i=1;i<=this.timeSignature.top;i++)t[i]=i;return t}.bind(t)}var j={},v={};return d.prototype=Object.create(r.prototype),d.prototype.addTrack=function(t){angular.isUndefined(j[t.type])&&(j[t.type]=0),t.id=t.type+"_"+j[t.type],"Standard"===t.kit?(t.kit="Drums",t.name=t.kit):"Bongo"===t.kit&&(t.kit="Percussions",t.name=t.kit),"piano"===t.type?(t.range=t.range||["C2","B5"],t.preset=t.preset||"acoustic",t.instrument=new l(t)):t.instrument="bass"===t.type?new n(t):p[t.kit],t.audio=a.createGain(),t.volume&&(t.audio.gain.value=t.volume.muted?1e-4:t.volume.value,t._volume=t.volume.value);var e=v[t.type];if(e||"drums"===t.type)t.audio.connect(a.destination);else{e=a.createDynamicsCompressor(),e.threshold.value=-35,e.knee.value=40,e.ratio.value=12,e.attack.value=0,v[t.type]=e;var o=a.createOscillator();o.frequency.value=22050,o.connect(e),e.connect(a.destination),o.start(),setTimeout(function(){o.stop()},50),t.audio.connect(e)}var i=this.project.tracks.length;this.project.tracks.forEach(function(e,o){e.type===t.type&&(i=o+1)}),this.project.tracks.splice(i,0,t),this.project.tracksMap[t.id]=t,j[t.type]+=1},d.prototype.removeTrack=function(t){var e=this.project.tracks.findIndex(c(t));this.project.tracks.splice(e,1),delete this.section[t],delete this.project.tracksMap[t]},d.prototype.addBackingTrack=function(t){this.project.backingTrack=new Audio([t])},d.prototype.createProject=function(t){return j={},v={},this.store.project=null,this.project={sections:[],tracks:[],tracksMap:{},playlists:[]},this.createPlaylist(),t.forEach(this.addTrack.bind(this)),this.dispatchEvent("projectLoaded",this.project),this.project},d.prototype.loadProject=function(t){j={},v={};var e=this.store.getProject(t);return this.project={name:e.name,sections:angular.copy(e.sections),tracks:[],tracksMap:{},playlists:[]},e.tracks.forEach(this.addTrack.bind(this)),e.playlists.length?(this.project.playlists=e.playlists,this.project.playlists.forEach(function(t,e){t.id=e+1})):this.createPlaylist(),this.dispatchEvent("projectLoaded",this.project),this.project},d.prototype.createSection=function(t){var e={timeSignature:{top:4,bottom:4},bpm:80,length:4};return t&&Object.keys(t).forEach(function(o){e[o]=t[o]}),e.id=s(this.project.sections),e.tracks={},this.project.sections.push(e),this.section=e,e},d.prototype.createPlaylist=function(){var t={id:s(this.project.playlists),name:"",items:[]};return this.project.playlists.push(t),t},d.prototype.importSection=function(t){console.log("importSection"),t.id=s(this.project.sections),f(t),this.project.sections.push(t)},d.prototype.deleteSection=function(){if(this.section){var t=this.section.id;this.store.project&&this.store.deleteSection(t);var e=this.project.sections.findIndex(c(t));this.project.sections.splice(e,1)}this.saveProjectConfig(),this.dispatchEvent("sectionDeleted")},d.prototype.serializeSection=function(t){var e={name:t.name,timeSignature:t.timeSignature,length:t.length,bpm:t.bpm,meta:t.meta,barSubdivision:t.barSubdivision,tracks:{}};return this.project.tracks.forEach(function(o){var i=t.tracks[o.id];if(i){var r=i.rawData().filter(function(t){return t.data.length>0||t.meta&&Object.keys(t.meta).length>0});e.tracks[o.id]=r}},this),JSON.stringify(e)},d.prototype.saveProjectConfig=function(){if(this.store.project){var t=["id","instrument","audio","_volume"],e=this.project.tracks.map(function(e){return Object.keys(e).reduce(function(o,i){t.indexOf(i)===-1&&(o[i]=e[i]);var r=e.audio.gain.value<=.001;return o.volume={muted:r,value:r?e._volume:e.audio.gain.value},o},{})}),o=this.project.sections.map(function(t){return{id:t.id,name:t.name}});this.store.saveProjectConfig(e,o)}},d.prototype.saveSection=function(){console.log("ProjectManager.saveSection"),this.store.project||this.store.createProject(this.project.name);var t=this.section.id,e=this.serializeSection(this.section);this.store.saveSection(t,this.section.name,e);var o=this.project.sections.find(c(t));o&&(o.name=this.section.name),this.saveProjectConfig()},d.prototype.saveAsNewSection=function(t){var e=this.section.tracks;delete this.section.tracks;var o=this.createSection(this.section);o.name=t||"New",o.tracks=e,this.section=o,this.saveSection()},d.prototype.loadSectionData=function(t){console.log("loadSectionData");for(var e in t.tracks){var o=t.tracks[e];if(!o.audio){var i,r=e.split("_")[0];i="drums"===r?u:h;var s=new i(t,o);s.type=r,s.audio=this.project.tracksMap[e].audio,s.instrument=this.project.tracksMap[e].instrument,t.tracks[e]=s}}return t},d.prototype._filterProjectTracks=function(t){Object.keys(t.tracks).forEach(function(e){this.project.tracksMap[e]||(console.log("!! obsolete section track: "+e),delete t.tracks[e])},this)},d.prototype.getSection=function(t){var e=this.project.sections.find(c(t));if(!e)return void console.log("invalid section id: "+t);if(e.tracks&&e.tracks[this.project.tracks[0].id]&&angular.isFunction(e.tracks[this.project.tracks[0].id].beat))return console.log("Already converted/loaded section"),this._filterProjectTracks(e),e;e.tracks||(e.tracks={}),console.log("--- load section from store ---");var o=this.store.getSection(e.id);return o&&(this._filterProjectTracks(o),e=this.loadSectionData(o)),f(e),e},d.prototype.loadSection=function(t){console.log("loadSection: "+t),this.section=this.getSection(t),this.dispatchEvent("sectionLoaded",this.section)},d.prototype.loadPlaylist=function(t){this.playlist=this.project.playlists.find(c(t)),this.dispatchEvent("playlistLoaded",this.playlist)},d.prototype.deletePlaylist=function(t){var e=this.project.playlists.findIndex(c(t));e!==-1&&this.project.playlists.splice(e,1)},d.prototype._playlistsData=function(){return this.project.playlists.map(function(t){return{name:t.name,items:t.items,backingTrack:t.backingTrack}})},d.prototype.savePlaylists=function(){this.store.savePlaylists(this._playlistsData())},new d}a.$inject=["$http","$timeout","$q","Observable","context","Bass","Drums","Piano","DrumTrackSection","TrackSection"],angular.module("bd.app").value("ReadOnlyStore",t).value("ProjectLocalStore",e).factory("projectManager",a),t.prototype.getProject=function(t){return{id:1,name:this.projectData.name,tracks:this.projectData.tracks,sections:this.projectData.index,playlists:this.projectData.playlists||[]}},t.prototype.getSection=function(t){var e=this.projectData.index.findIndex(c(t)),o=this.projectData.sections[e];return o.name=this.projectData.index[e].name,o.id=this.projectData.index[e].id,o},e.prototype._updateProjectsOrder=function(t){var e=this.projects.findIndex(c(t));if(e!==-1){var o=this.projects.splice(e,1)[0];this.projects.splice(0,0,o);var i=JSON.stringify(this.projects);localStorage.setItem(this.PROJECTS_KEY,i)}},e.prototype.projectsList=function(){var t=localStorage.getItem(this.PROJECTS_KEY);return t?JSON.parse(t):[]},e.prototype.getProject=function(t){var e=JSON.parse(localStorage.getItem(o(t))),r=JSON.parse(localStorage.getItem(i(t)))||[];return this.project={id:t,name:e.name,sections:e.sections,tracks:e.tracks,playlists:r},this._updateProjectsOrder(t),this.project},e.prototype.createProject=function(t){console.log("Initialize project: "+t);var e=this.projects.reduce(function(t,e){return e.id>=t?e.id+1:t},1),e=s(this.projects);this.project={name:t,id:e,sections:[],tracks:[]},this.projects.splice(0,0,{id:this.project.id,name:this.project.name});var o=JSON.stringify(this.projects);return localStorage.setItem(this.PROJECTS_KEY,o),this.project},e.prototype.saveProjectConfig=function(t,e){var i=this.project.id;console.log("ProjectLocalStore.saveProjectConfig: "+o(i)),this.project.tracks=t,this.project.sections=e.filter(function(t){return this.project.sections.some(function(e){return e.id===t.id})},this);var r=JSON.stringify(this.project,function(t,e){if("playlists"!==t)return e});console.log(r),localStorage.setItem(o(i),r)},e.prototype.deleteProject=function(t){if(this.project.id===t)return void console.log("!! deleting opened project !!");var e=JSON.parse(localStorage.getItem(o(t)));if(e){var s=e.sections.map(function(e){return r(t,e.id)});s.push(i(t)),s.push(o(t)),s.forEach(localStorage.removeItem,localStorage)}var a=this.projectsList(),n=a.findIndex(c(t));n!==-1&&(a.splice(n,1),localStorage.setItem(this.PROJECTS_KEY,JSON.stringify(a))),this.projects=a},e.prototype.saveSection=function(t,e,o){var i=r(this.project.id,t);console.log("ProjectLocalStore.saveSection: "+i);var s=this.project.sections.some(function(e){return e.id===t});s||this.project.sections.push({id:t,name:e}),localStorage.setItem(i,o)},e.prototype.getSection=function(t){if(this.project){var e=r(this.project.id,t),o=localStorage.getItem(e);return o?(o=JSON.parse(o),o.id=t,o):void 0}},e.prototype.deleteSection=function(t){var e=r(this.project.id,t);localStorage.removeItem(e)},e.prototype.savePlaylists=function(t){var e=i(this.project.id);console.log("ProjectLocalStore.savePlaylists: "+e),localStorage.setItem(e,JSON.stringify(t))},e.prototype._projectData=function(){var t=this.project.id,e=JSON.parse(localStorage.getItem(o(t))),s=JSON.parse(localStorage.getItem(i(t)))||[],c=e.sections.map(function(e){var o=r(t,e.id);return JSON.parse(localStorage.getItem(o))}),a={name:e.name,index:e.sections,tracks:e.tracks,playlists:s,sections:c};return a}}();
!function(){"use strict";function e(e,t,o,n,i,c,a,r,s,l,d,p){function m(e){c.show({template:'<md-toast>            <div class="md-toast-content">{0}</div>          </md-toast>'.format(e),position:"bottom right",hideDelay:2500})}function u(e){m("<span>Section <b>{0}</b> was saved</span>".format(e))}function f(e,t,o){e.close=o.hide,e.instruments=[{name:"Bass",type:"bass",strings:"EADG"},{name:"Piano",type:"piano",range:["C2","B5"]},{name:"Drums",kit:"Drums",type:"drums"},{name:"Percussions",kit:"Percussions",type:"drums",icon:"percussions"}],e.addTrack=function(e){t.addTrack(e),o.hide()}}function j(e,t,o){e.projects=o.store.projectsList(),o.store.project&&(e.openedProjectId=o.store.project.id),e.close=t.hide,e.deleteProject=function(t){o.store.deleteProject(t),e.projects=o.store.projectsList()},e.openProject=function(e){t.hide(e)},e.importProjectFile=function(t){var o=t.filename.replace(".json","");console.log("Importing project: "+o);var n=new l(JSON.parse(t.content)),i=n.getProject();i.playlists.forEach(function(e,t){e.id=t+1});var c=new d;c.createProject(o),i.id=c.project.id,i.name=o,c.project=i,c.saveProjectConfig(i.tracks,i.sections),i.sections.forEach(function(e){var t=n.getSection(e.id);c.saveSection(t.id,t.name,JSON.stringify(t))}),c.savePlaylists(i.playlists),e.projects.push({id:i.id,name:t.filename})}}f.$inject=["$scope","projectManager","$mdDialog"],j.$inject=["$scope","$mdDialog","projectManager"],console.log("ProjectController"),e.addTrackDialog=function(e){a.show({templateUrl:"views/editor/new_track.html",controller:f,autoWrap:!1,clickOutsideToClose:!0})},e.removeTrack=function(t){console.log("remove track: "+t);var o=r.project.tracksMap[t],n=r.project.tracks.find(function(e){return e.type===o.type&&e.id!==t});n?(e.ui.selectTrack(n.id),r.removeTrack(t)):a.show(a.alert().title("Warning").textContent("Can't remove this track, it's the last track of its instrument kind!").theme(" ").ok("Close"))},e.newProject=function(){r.store.readOnly&&(r.store=new d,i.hash("")),document.title="New Project",s.bassSection=null,s.drumSection=null,e.project=r.createProject([{type:"bass",name:"Bass",strings:"EADG",tuning:[0,0,0,0]},{type:"drums",kit:"Drums",name:"Drums"},{type:"drums",kit:"Percussions",name:"Percussions"}]);var t=r.createSection();s.selectedSectionId=t.id,s.section=t,r.loadSection(s.selectedSectionId)},e.loadProject=function(t){e.project=r.loadProject(t),document.title=e.project.name,s.selectedSectionId=e.project.sections[0].id,r.loadSection(s.selectedSectionId),s.section=r.section},e.openProject=function(){a.show({templateUrl:"views/open_project.html",controller:j,autoWrap:!1,clickOutsideToClose:!1}).then(function(t){t&&e.loadProject(t)})},e.newSection=function(){var e=r.createSection(r.section);e.name="New",s.selectedSectionId=e.id,r.loadSection(s.selectedSectionId)},e.saveSection=function(){if(s.section.name)if(r.project.name)r.saveSection(),u(s.section.name);else{var e=a.prompt().title("Saving Project").textContent("Please enter project name:").placeholder("Name").ariaLabel("Name").theme(" ").ok("Save").cancel("Cancel");a.show(e).then(function(e){e&&(document.title=e,r.project.name=e,r.saveSection(),u(s.section.name))})}},e.saveAsSection=function(){r.saveAsNewSection(),s.section=r.section,s.selectedSectionId=s.section.id},e.deleteSection=function(){r.deleteSection(s.selectedSectionId),r.project.sections.length>0?s.selectedSectionId=r.project.sections[0].id:s.selectedSectionId=r.createSection().id,r.loadSection(s.selectedSectionId)},e.newPlaylist=function(){var e=r.createPlaylist();r.loadPlaylist(e.id)},e.savePlaylists=function(){s.playlist.name&&(r.savePlaylists(),m("<span>Playlists was saved</span>"))},e.deletePlaylist=function(){var e=s.playlist.name;r.deletePlaylist(s.playlist.id),r.store.readOnly||r.savePlaylists(),m("<span>Playlist <b>{0}</b> was deleted</span>".format(e)),r.project.playlists.length&&r.loadPlaylist(r.project.playlists[0].id)},e.itemReorderHandler=function(e,t,o,n){var i=n.findIndex(function(e){return e.id===t}),c=n.splice(i,1)[0],a=n.findIndex(function(e){return e.id===o});n.splice(a,0,c)};var v=i.hash();if(v)o.get(p+v+".json").then(function(t){r.store=new l(t.data),e.project=r.loadProject(1),s.selectedSectionId=e.project.sections[0].id,r.loadSection(s.selectedSectionId)});else if(r.store.projects.length){var S=r.store.projects[0];try{e.loadProject(S.id)}catch(t){var g=a.alert().title("Warning").textContent("Failed to open latest project.").theme(" ").ok("Close");a.show(g),e.newProject()}}else e.newProject();e.exportProject=function(){var e=r.store._projectData();console.log(e);var t=new Blob([JSON.stringify(e)],{type:"application/json;charset=utf-8"});saveAs(t,r.project.name+".json")},s.importProject=function(){t(function(){var t=i.path();console.log("Importing project: "+t);var o=r.project.sections.map(function(e){return r.getSection(e.id)});e.newProject(),o.forEach(r.importSection,r),r.loadSection(o[0].id),s.selectedSectionId=r.section.id})},s._import=function(e,t,o,n,i,c,a){var r=t,l=o,d={};for(var p in e.tracks)d[p]=[];for(var m=n,u=i;c--;){for(var p in e.tracks){var f=e.tracks[p],j=angular.copy(f.beat(r,l));j.bar=m,j.beat=u,d[p].push(j)}l++,l>e.timeSignature.top&&(l=1,r++),u++,u>e.timeSignature.top&&(u=1,m++)}for(var p in s.section.tracks)if(a&&a.indexOf(p)===-1)console.log("skipping track "+p);else{var v=s.section.tracks[p];v.loadBeats&&(console.log("importing track beats: "+p),v.loadBeats(d[p]))}},s.importBeats=function(e,t,o,n,i,c,a){var l=r.project.sections.find(function(t){return t.name===e}).id,d=r.getSection(l);s._import(d,t,o,n,i,c,a)},s.importBars=function(e,t,o,n,i){var c=r.project.sections.find(function(t){return t.name===e}).id,a=r.getSection(c);s._import(a,t,1,o,1,n*a.timeSignature.top,i)},s.exportSection=function(){if(s.section.name){var e=new Blob([r.serializeSection(r.section)],{type:"application/json;charset=utf-8"});saveAs(e,r.section.name+".json")}},e.importSectionFromFile=function(e){var t=JSON.parse(e.content);for(var o in t.tracks)if(!r.project.tracksMap[o]){console.log("NEW TRACK"),console.log(o.split("_"));var n=o.split("_")[0];r.addTrack({name:n[0].toUpperCase()+n.substr(1),type:n})}var i=r.loadSectionData(t);r.importSection(i),r.loadSection(i.id)}}e.$inject=["$scope","$timeout","$http","$window","$location","$mdToast","$mdDialog","projectManager","workspace","ReadOnlyStore","ProjectLocalStore","dataUrl"],angular.module("bd.app").controller("ProjectController",e).config(["$locationProvider",function(e){e.html5Mode({enabled:!0,requireBase:!1,rewriteLinks:!0})}])}();
