...
!function(){"use strict";function e(e,n,t,a,s,o,r){function l(){var n,t=[];for(n=0;n<c.timeSignature.top;n++)for(d=0;4>d;d++){var a=new Array(e.bass.strings);e.bass.strings.forEach(function(e){a[e.index]={string:e,beat:n,subbeat:d,note:{style:"finger",length:1/8,volume:.75},width:1}}),t.push(a)}return t}function i(){var n="bass.presents",t=localStorage.getItem(n);t?(e.bass.presents=JSON.parse(t),console.log(e.bass.presents),e.bass.present=e.bass.presents[0],e.bassData=e.bass.present.data):(e.bass.present={name:""},e.bass.presents=[e.bass.present])}var p;setTimeout(function(){p=a.createAnalyser(),p.fftSize=1024,p.connect(a.destination),s.initialize(p),o.initialize(document.getElementById("canvas"),p)},200),e.player={playing:!1,bpm:60};var u=new r("B0","G4");e.bass={notes:u,noteStringOctaves:function(e,n){var t=[];return u.list.slice(n.noteIndex,n.noteIndex+24).filter(function(n){-1!==n.label.indexOf(e)&&t.push(n.octave)}),t},stringFret:function(e,n){var t=n.name+n.octave,a=u.list.indexOf(u.map[t]),s=a-e.noteIndex;return s>=0&&24>=s?s:-1},strings:[{label:"E",octave:1,index:0,noteIndex:u.list.indexOf(u.map.E1)},{label:"A",octave:1,index:1,noteIndex:u.list.indexOf(u.map.A1)},{label:"D",octave:2,index:2,noteIndex:u.list.indexOf(u.map.D2)},{label:"G",octave:2,index:3,noteIndex:u.list.indexOf(u.map.G2)}].reverse(),playingStyles:{finger:{name:"finger",label:"Finger",noteLabel:function(e){return e.note.name?"{0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},slap:{name:"slap",label:"Slap",noteLabel:function(e){return e.note.name?"<sup>(Slap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},pop:{name:"pop",label:"Pop",noteLabel:function(e){return e.note.name?"<sup>(Pop)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},tap:{name:"tap",label:"Tap",noteLabel:function(e){return e.note.name?"<sup>(Tap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},hammer:{name:"hammer-on",label:"Hammer on",noteLabel:function(e){return e.note.name?'<span class="hammer-top">)</span>                <span class="hammer-bottom">h</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}},pull:{name:"pull-of",label:"Pull of",noteLabel:function(e){return e.note.name?'<span class="pull-top">p</span>                <span class="pull-bottom">)</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}}}},e.bass.presents=[],e.bass.selectedPresent,console.log(e.bass);for(var b={top:4,bottom:4},m=[{name:""},{name:"i"},{name:"and"},{name:"a"}],c={timeSignature:b,subbeats:[],nextSubbeat:function(e){return this.subbeats[e._index+1]},prevSubbeat:function(e){return this.subbeats[e._index-1]}},f=1;12>=f;f++){var v=angular.copy(m);v[0].name="{0}".format(f),v.forEach(function(e,n){e._index=(f-1)*v.length+n,e.beat=f,e.index=n+1,e.bar=c,e.width=1,e.note={volume:.75}}),c.subbeats=c.subbeats.concat(v)}var d={note:{style:"finger",name:"A",octave:2,length:1/8,staccato:!1,string:1}},g=l();g[0][1].note={style:"finger",name:"C",octave:2,length:1/8,volume:.75},g[2][1].note={style:"finger",name:"D",octave:2,length:1/8,volume:.75},g[4][2].note={style:"finger",name:"E",octave:2,length:1/8,volume:.75},g[6][2].note={style:"finger",name:"F",octave:2,length:1/8,volume:.75},g[8][2].note={style:"finger",name:"G",octave:2,length:1/8,volume:.75},g[10][3].note={style:"finger",name:"A",octave:2,length:1/8,volume:.75},g[12][3].note={style:"finger",name:"B",octave:2,length:1/8,volume:.75},g[14][3].note={style:"finger",name:"C",octave:3,length:1/8,volume:.75},e.bassData=g,e.bar=c,e.$watch("player.bpm",function(n){s.playing&&(s.stop(),s.setBpm(e.player.bpm),s.play({timeSignature:b,notes:e.bassData},o.beatSync.bind(o)))}),e.play=function(){e.player.playing=!0,o.reset(),s.setBpm(e.player.bpm),s.play({timeSignature:b,notes:e.bassData},o.beatSync.bind(o))},e.stop=function(){e.player.playing=!1,s.stop()},e.newBar=function(){e.bass.present={name:"New",data:l()},e.bass.presents.push(e.bass.present),e.bassData=e.bass.present.data},e.saveBar=function(){var n="bass.presents";e.bass.present.data=e.bassData,console.log(e.bass.present);var t=e.bass.presents.map(function(e){return{name:e.name,data:e.data}});console.log(t),localStorage.setItem(n,JSON.stringify(t))},e.loadBassPresent=function(){if(console.log("loadBassPresent: "+e.bass.present.name),e.bass.present.data){var n,t;for(n=0;n<e.bass.present.data.length;n++)for(t=0;4>t;t++)e.bassData[n][t]=angular.copy(e.bass.present.data[n][t])}},i()}e.$inject=["$scope","$timeout","$mdDialog","context","audioPlayer","audioVisualiser","NotesModel"],angular.module("bd.app").controller("AppController",e).value("context",new AudioContext)}();
...
!function(){"use strict";function t(t,e){console.log("NOTE CONTROLLER");var n=[];t.bass.notes.scaleNotes.forEach(function(t){n.push.apply(n,t.label)}),t.notesLabels=n,t.dropNote={width:0},t.activeMenu={};var o,a;t.playingStyles=["finger","slap","pop","tap","hammer","pull"],t.clearNote=function(e){if(e.note={},e.width>1)for(var n=e.width-1,e=e;n--;)e=e.bar.nextSubbeat(e),e.width=1;e.width=1,t.updateNote(e)};var r,d,i={};t.onResizeStart=function(e,n){var o=e.note.dotted?1.5*e.note.length:e.note.length,a=n.width/o,d=[{length:1,dotted:!1},{length:1,dotted:!0},{length:.5,dotted:!1},{length:.5,dotted:!0},{length:.25,dotted:!1},{length:.25,dotted:!0},{length:1/8,dotted:!1},{length:1/8,dotted:!0},{length:1/16,dotted:!1}];i={},r=d.map(function(t){var e=t.dotted?1.5*t.length:t.length,n=e*a;return i[n]=t,n});var l=n.element.parent()[0];t.dropNote.visible=!0,t.dropNote.width=n.width,t.dropNote.left=l.offsetParent.offsetLeft,t.dropNote.top=l.offsetTop,t.$apply()},t.onResizeEnd=function(e,n){n.element.css("width",""),angular.extend(e.note,i[d]),t.dropNote.visible=!1,t.$apply()},t.onResize=function(e,n){var o,a=r[0];r.forEach(function(t){o=Math.abs(n.width-t),a>o&&(d=t,a=o)}),t.dropNote.width=d,t.$apply()},t.onDrop=function(t,e,n,o){"move"===t.dataTransfer.dropEffect&&(o[4*e.beat+e.subbeat][e.string.index].note={}),n.note=e.note},t.updateNote=function(t){},t.onDragEnter=function(n,o){var a=n.target||n.originalTarget;"BUTTON"===a.tagName&&(a=a.parentElement.parentElement),e(function(){t.dropNote.visible=!0,t.dropNote.left=a.offsetParent.offsetLeft,t.dropNote.top=a.offsetTop})},t.onDragLeave=function(e,n){t.dropNote.visible=!1},t.$on("ANGULAR_DRAG_START",function(e,n,r,d){o=d.data,o.note.length&&(t.dropNote.width=n.target.clientWidth,n.ctrlKey||(a=angular.element(n.target),setTimeout(function(){a.addClass("drag-element")},100)),t.$apply())}),t.$on("ANGULAR_DRAG_END",function(e,n,o,r){a&&(a.removeClass("drag-element"),a=null),t.dropNote.visible=!1}),t.dropValidation=function(e,n){if(e.note.name&&e.note.length)return!1;if("x"===n.note.name)return!0;var o=t.bass.stringFret(e.string,n.note);return-1!==o}}t.$inject=["$scope","$timeout"],angular.module("bd.app").controller("NoteController",t)}();
