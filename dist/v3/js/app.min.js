...
!function(){"use strict";function e(e,n,t,a,s,o,r){function l(){var n,t=[];for(n=0;n<f.timeSignature.top;n++)for(d=0;4>d;d++){var a=new Array(e.bass.strings);e.bass.strings.forEach(function(e){a[e.index]={string:e,beat:n,subbeat:d,note:{style:"finger",length:1/8,volume:.75},width:1}}),t.push(a)}return t}function i(){var n,t=e.bass.presents.map(function(e){return"bass.present."+e.name});for(n=0;n<localStorage.length;n++){var a=localStorage.key(n);if(a.startsWith("bass.present.")&&-1===t.indexOf(a)){console.log("delete: "+a),localStorage.removeItem(a);break}}}function p(){var n,t=[];for(n=0;n<localStorage.length;n++){var a=localStorage.key(n);if(a.startsWith("bass.present.")){var s=JSON.parse(localStorage.getItem(a));t.push(s)}}t?(e.bass.presents=t,e.loadBassPresent(t[0])):(e.bass.present={name:""},e.bass.presents=[e.bass.present])}var u;setTimeout(function(){u=a.createAnalyser(),u.fftSize=1024,u.connect(a.destination),s.initialize(u),o.initialize(document.getElementById("canvas"),u)},200),e.player={playing:!1,bpm:60};var b=new r("B0","G4");e.bass={notes:b,noteStringOctaves:function(e,n){var t=[];return b.list.slice(n.noteIndex,n.noteIndex+24).filter(function(n){-1!==n.label.indexOf(e)&&t.push(n.octave)}),t},stringFret:function(e,n){var t=n.name+n.octave,a=b.list.indexOf(b.map[t]),s=a-e.noteIndex;return s>=0&&24>=s?s:-1},strings:[{label:"E",octave:1,index:0,noteIndex:b.list.indexOf(b.map.E1)},{label:"A",octave:1,index:1,noteIndex:b.list.indexOf(b.map.A1)},{label:"D",octave:2,index:2,noteIndex:b.list.indexOf(b.map.D2)},{label:"G",octave:2,index:3,noteIndex:b.list.indexOf(b.map.G2)}].reverse(),playingStyles:{finger:{name:"finger",label:"Finger",noteLabel:function(e){return e.note.name?"{0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},slap:{name:"slap",label:"Slap",noteLabel:function(e){return e.note.name?"<sup>(Slap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},pop:{name:"pop",label:"Pop",noteLabel:function(e){return e.note.name?"<sup>(Pop)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},tap:{name:"tap",label:"Tap",noteLabel:function(e){return e.note.name?"<sup>(Tap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},hammer:{name:"hammer-on",label:"Hammer on",noteLabel:function(e){return e.note.name?'<span class="hammer-top">)</span>                <span class="hammer-bottom">h</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}},pull:{name:"pull-of",label:"Pull of",noteLabel:function(e){return e.note.name?'<span class="pull-top">p</span>                <span class="pull-bottom">)</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}}}},e.bass.presents=[],console.log(e.bass);for(var m={top:4,bottom:4},c=[{name:""},{name:"i"},{name:"and"},{name:"a"}],f={timeSignature:m,subbeats:[],nextSubbeat:function(e){return this.subbeats[e._index+1]},prevSubbeat:function(e){return this.subbeats[e._index-1]}},v=1;12>=v;v++){var g=angular.copy(c);g[0].name="{0}".format(v),g.forEach(function(e,n){e._index=(v-1)*g.length+n,e.beat=v,e.index=n+1,e.bar=f,e.width=1,e.note={volume:.75}}),f.subbeats=f.subbeats.concat(g)}var d={note:{style:"finger",name:"A",octave:2,length:1/8,staccato:!1,string:1}},y=l();y[0][1].note={style:"finger",name:"C",octave:2,length:1/8,volume:.75},y[2][1].note={style:"finger",name:"D",octave:2,length:1/8,volume:.75},y[4][2].note={style:"finger",name:"E",octave:2,length:1/8,volume:.75},y[6][2].note={style:"finger",name:"F",octave:2,length:1/8,volume:.75},y[8][2].note={style:"finger",name:"G",octave:2,length:1/8,volume:.75},y[10][3].note={style:"finger",name:"A",octave:2,length:1/8,volume:.75},y[12][3].note={style:"finger",name:"B",octave:2,length:1/8,volume:.75},y[14][3].note={style:"finger",name:"C",octave:3,length:1/8,volume:.75},e.bassData=y,e.bar=f,e.$watch("player.bpm",function(n){s.playing&&(s.stop(),s.setBpm(e.player.bpm),s.play({timeSignature:m,notes:e.bassData},o.beatSync.bind(o)))}),e.play=function(){e.player.playing=!0,o.reset(),s.setBpm(e.player.bpm),s.play({timeSignature:m,notes:e.bassData},o.beatSync.bind(o))},e.stop=function(){e.player.playing=!1,s.stop()},e.newBar=function(){e.bass.present={name:"New",data:l()},e.bass.presents.push(e.bass.present),e.bassData=e.bass.present.data},e.deleteBar=function(n){var t=e.bass.presents.indexOf(n);e.bass.presents.splice(t,1),i(),e.bass.presents?e.loadBassPresent(e.bass.presents[0]):(e.bass.present={name:""},e.bass.presents=[e.bass.present])},e.saveBar=function(){i();var n="bass.present."+e.bass.present.name;e.bass.present.data=e.bassData,console.log(e.bass.present);var t=e.bass.present,a={name:t.name,data:t.data};console.log(a),localStorage.setItem(n,JSON.stringify(a))},e.loadBassPresent=function(n){n&&n!==e.bass.present&&(console.log("Load: "+n.name),e.bassData=n.data,e.bass.present=n)},p()}e.$inject=["$scope","$timeout","$mdDialog","context","audioPlayer","audioVisualiser","NotesModel"],angular.module("bd.app").controller("AppController",e).value("context",new AudioContext)}();
...
!function(){"use strict";function e(e,t,n){console.log("NOTE CONTROLLER");var o=[];e.bass.notes.scaleNotes.forEach(function(e){o.push.apply(o,e.label)}),e.notesLabels=o,e.dropNote={width:0},e.menu={element:null,open:angular.noop,note:e.bassData[0][0].note},t(function(){e.menu.element=angular.element(document.getElementById("subbeat-menu"))},100);var a,l;e.playingStyles=["finger","slap","pop","tap","hammer","pull"],e.clearNote=function(t){if(t.note={},t.width>1)for(var n=t.width-1,t=t;n--;)t=t.bar.nextSubbeat(t),t.width=1;t.width=1,e.updateNote(t)},e.updateNoteLength=function(e){};var r,d,i={};e.onResizeStart=function(t,n){var o=t.note.dotted?1.5*t.note.length:t.note.length,a=n.width/o,l=[{length:1,dotted:!1},{length:1,dotted:!0},{length:.5,dotted:!1},{length:.5,dotted:!0},{length:.25,dotted:!1},{length:.25,dotted:!0},{length:1/8,dotted:!1},{length:1/8,dotted:!0},{length:1/16,dotted:!1}];i={},r=l.map(function(e){var t=e.dotted?1.5*e.length:e.length,n=t*a;return i[n]=e,n});var d=n.element.parent()[0];e.dropNote.visible=!0,e.dropNote.width=n.width,e.dropNote.left=d.offsetParent.offsetLeft,e.dropNote.top=d.offsetTop,e.$apply()},e.onResizeEnd=function(t,n){n.element.css("width",""),angular.extend(t.note,i[d]),e.dropNote.visible=!1,e.$apply()},e.onResize=function(t,n){var o,a=r[0];r.forEach(function(e){o=Math.abs(n.width-e),a>o&&(d=e,a=o)}),e.dropNote.width=d,e.$apply()},e.onDrop=function(e,t,n,o){"move"===e.dataTransfer.dropEffect&&(o[4*t.beat+t.subbeat][t.string.index].note={}),n.note=t.note},e.updateNote=function(e){"x"===e.note.name&&(e.note.length=1/16)},e.onDragEnter=function(n,o){var a=n.target||n.originalTarget;"BUTTON"===a.tagName&&(a=a.parentElement),t(function(){e.dropNote.visible=!0,e.dropNote.left=a.offsetParent.offsetLeft,e.dropNote.top=a.offsetTop})},e.onDragLeave=function(t,n){e.dropNote.visible=!1},e.$on("ANGULAR_DRAG_START",function(t,n,o,r){a=r.data,a.note.length&&(e.dropNote.width=n.target.clientWidth,n.ctrlKey||(l=angular.element(n.target),setTimeout(function(){l.addClass("drag-element")},100)),e.$apply())}),e.$on("ANGULAR_DRAG_END",function(t,n,o,a){l&&(l.removeClass("drag-element"),l=null),e.dropNote.visible=!1}),e.dropValidation=function(t,n){if(t.note.name&&t.note.length)return!1;if("x"===n.note.name)return!0;var o=e.bass.stringFret(t.string,n.note);return-1!==o},e.setSubbeatMenu=function(t){console.log("setSubbeatMenu"),e.menu.subbeat=t,e.menu.note=t.note},e.openSubbeatMenu=function(t,o){n.hide().then(function(){e.menu.subbeat=o,e.menu.note=o.note,e.menu.open(t);var n=t.target.getBoundingClientRect();e.menu.element.css("left",n.left+"px"),e.menu.element.css("top",32+n.top+"px")})}}e.$inject=["$scope","$timeout","$mdMenu"],angular.module("bd.app").controller("NoteController",e)}();
...
!function(){"use strict";function t(t,n){function a(){this.playing=!1,this.playback=this.playback.bind(this),this.setBpm(60)}var i,o={finger:{getResources:function(t){return"x"===t.name?["sounds/finger/X{1}".format(e[t.name],"1")]:["sounds/finger/{0}{1}".format(e[t.name],t.octave||"")]},play:function(t,e){console.log("playing ... "+t.name)}},hammer:{getResources:function(t){return["sounds/tap-{0}{1}".format(e[t.name],t.octave||"")]},play:function(t,e){console.log("playing ... "+t.name)}},slap:{getResources:function(t){return["sounds/slap-{0}{1}".format(e[t.name],t.octave||"")]},play:function(t,e){console.log("slapping ... "+t.name)}},pull:{getResources:function(t){return["sounds/pull-{0}{1}".format(e[t.name],t.octave||"")]}}};return a.prototype.initialize=function(t){this.destination=t,this.playingNotes=[]},a.prototype.playback=function(e){if(this.playing){var n=t.currentTime-this.startTime;if(n>this.subbeatIndex*this.subbeatTime){var a=this.subbeatIndex%16;a%4===0&&(this.beatCallback(this.bpm,this.beatIndex%4+1),this.beatIndex++);var s=this.bar.notes[a];s.filter(function(e){if(e.note.style&&e.note.name){var n=e.note,a=t.createBufferSource(),s=t.createGain();s.gain.value=0,a.connect(s),s.connect(this.destination),a.buffer=i.getAudioData(o[n.style].getResources(n)[0]);var r=n.length?this.subbeatTime*n.length*16:this.subbeatTime;n.dotted&&(r*=1.5),n.staccato&&(r=.8*r),r=r;var u=t.currentTime;a.start(u,0,r+50);var l={note:n,source:a,gain:s,startTime:u,endTime:u+r,fadeIn:0,fadeOut:"x"===n.name?0:30};this.playingNotes.push(l)}},this);this.subbeatIndex++}if(this.playingNotes.length){var r=t.currentTime;this.playingNotes=this.playingNotes.filter(function(t){return r>t.endTime?(t.gain.gain.value=0,!1):!0}),this.playingNotes.forEach(function(t){var e=1e3*(r-t.startTime);if(e<t.fadeIn)t.gain.gain.value=e/t.fadeIn*t.note.volume;else{var n=1e3*(t.endTime-r);n<t.fadeOut?t.gain.gain.value=n/t.fadeOut*t.note.volume:t.gain.gain.value=t.note.volume}})}requestAnimationFrame(this.playback)}},a.prototype._play=function(e){this.playing=!0,this.startTime=t.currentTime,this.subbeatIndex=0,this.beatIndex=0,this.bar=e,this.playback()},a.prototype.setBpm=function(t){this.bpm=t;var e=60/t;this.subbeatTime=e/4},a.prototype.play=function(e,a){function s(t){r._play(e)}var r=this;this.beatCallback=angular.isFunction(a)?a:angular.noop;var u,l,c=[],f={};for(u=0;16>u;u++)for(l=0;4>l;l++){var p=e.notes[u][l].note;if(p.name&&p.style){var h,g=o[p.style].getResources(p);g.forEach(function(t){h=n+t+".ogg",-1===c.indexOf(h)&&(f[t]=c.length,c.push(h))})}}i=new BufferLoader(t,c,s),i.getAudioData=function(t){return i.bufferList[f[t]]},i.load()},a.prototype.stop=function(t){this.playing=!1,this.playingNotes.forEach(function(t){t.gain.gain.value=0})},new a}t.$inject=["context","soundsUrl"],angular.module("bd.app").factory("audioPlayer",t);var e={C:"C","C♯":"Db","D♭":"Db",D:"D","D♯":"Eb","E♭":"Eb",E:"E",F:"F","F♯":"Gb","G♭":"Gb",G:"G","G♯":"Ab",A:"A","A♯":"Bb","B♭":"Bb",B:"B"}}();
