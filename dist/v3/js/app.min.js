...
!function(){"use strict";function e(e,n,t,a,o,l,s){var i;setTimeout(function(){i=a.createAnalyser(),i.fftSize=1024,i.connect(a.destination),o.initialize(i),l.initialize(document.getElementById("canvas"),i)},200),e.player={playing:!1,bpm:60};var r=new s("B0","G4");e.bass={notes:r,noteStringOctaves:function(e,n){var t=[];return r.list.slice(n.noteIndex,n.noteIndex+24).filter(function(n){-1!==n.label.indexOf(e)&&t.push(n.octave)}),t},stringFret:function(e,n){var t=n.name+n.octave,a=r.list.indexOf(r.map[t]),o=a-e.noteIndex;return o>=0&&24>=o?o:-1},strings:[{label:"E",octave:1,index:0,noteIndex:r.list.indexOf(r.map.E1)},{label:"A",octave:1,index:1,noteIndex:r.list.indexOf(r.map.A1)},{label:"D",octave:2,index:2,noteIndex:r.list.indexOf(r.map.D2)},{label:"G",octave:2,index:3,noteIndex:r.list.indexOf(r.map.G2)}].reverse(),playingStyles:{finger:{name:"finger",label:"Finger",noteLabel:function(e){return e.note.name?"{0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},slap:{name:"slap",label:"Slap",noteLabel:function(e){return e.note.name?"<sup>(Slap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},pop:{name:"pop",label:"Pop",noteLabel:function(e){return e.note.name?"<sup>(Pop)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},tap:{name:"tap",label:"Tap",noteLabel:function(e){return e.note.name?"<sup>(Tap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},hammer:{name:"hammer-on",label:"Hammer on",noteLabel:function(e){return e.note.name?'<span class="hammer-top">)</span>                <span class="hammer-bottom">h</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}},pull:{name:"pull-of",label:"Pull of",noteLabel:function(e){return e.note.name?'<span class="pull-top">p</span>                <span class="pull-bottom">)</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}}}},console.log(e.bass);for(var u={top:4,bottom:4},m=[{name:""},{name:"i"},{name:"and"},{name:"a"}],p={timeSignature:u,subbeats:[],nextSubbeat:function(e){return this.subbeats[e._index+1]},prevSubbeat:function(e){return this.subbeats[e._index-1]}},b=1;12>=b;b++){var c=angular.copy(m);c[0].name="{0}".format(b),c.forEach(function(e,n){e._index=(b-1)*c.length+n,e.beat=b,e.index=n+1,e.bar=p,e.width=1,e.note={volume:.75}}),p.subbeats=p.subbeats.concat(c)}var f,v={note:{style:"finger",name:"A",octave:2,length:1/8,staccato:!1,string:1}},g=[];for(f=0;f<p.timeSignature.top;f++)for(v=0;4>v;v++){var d=new Array(e.bass.strings);e.bass.strings.forEach(function(e){d[e.index]={string:e,beat:f,subbeat:v,note:{style:"finger",length:1/8,volume:.75},width:1}}),g.push(d)}g[0][1].note={style:"finger",name:"C",octave:2,length:1/8,volume:.75},g[2][1].note={style:"finger",name:"D",octave:2,length:1/8,volume:.75},g[4][2].note={style:"finger",name:"E",octave:2,length:1/8,volume:.75},g[6][2].note={style:"finger",name:"F",octave:2,length:1/8,volume:.75},g[8][2].note={style:"finger",name:"G",octave:2,length:1/8,volume:.75},g[10][3].note={style:"finger",name:"A",octave:2,length:1/8,volume:.75},g[12][3].note={style:"finger",name:"B",octave:2,length:1/8,volume:.75},g[14][3].note={style:"finger",name:"C",octave:3,length:1/8,volume:.75},e.bassData=g,e.bar=p,e.$watch("player.bpm",function(n){o.playing&&(o.stop(),o.setBpm(e.player.bpm),o.play({timeSignature:u,notes:e.bassData},l.beatSync.bind(l)))}),e.play=function(){e.player.playing=!0,l.reset(),o.setBpm(e.player.bpm),o.play({timeSignature:u,notes:e.bassData},l.beatSync.bind(l))},e.stop=function(){e.player.playing=!1,o.stop()}}e.$inject=["$scope","$timeout","$mdDialog","context","audioPlayer","audioVisualiser","NotesModel"],angular.module("bd.app").controller("AppController",e).value("context",new AudioContext)}();
...
!function(){"use strict";function t(t,e){console.log("NOTE CONTROLLER");var o=[];t.bass.notes.scaleNotes.forEach(function(t){o.push.apply(o,t.label)}),t.notesLabels=o,t.dropNote={width:0},t.activeMenu={};var n,a;t.playingStyles=["finger","slap","pop","tap","hammer","pull"],t.clearNote=function(e){if(e.note={},e.width>1)for(var o=e.width-1,e=e;o--;)e=e.bar.nextSubbeat(e),e.width=1;e.width=1,t.updateNote(e)};var r,d,i={};t.onResizeStart=function(e,o){var n=e.note.dotted?1.5*e.note.length:e.note.length,a=o.width/n,d=[{length:1,dotted:!1},{length:1,dotted:!0},{length:.5,dotted:!1},{length:.5,dotted:!0},{length:.25,dotted:!1},{length:.25,dotted:!0},{length:1/8,dotted:!1},{length:1/8,dotted:!0},{length:1/16,dotted:!1}];i={},r=d.map(function(t){var e=t.dotted?1.5*t.length:t.length,o=e*a;return i[o]=t,o});var l=o.element.parent()[0];t.dropNote.visible=!0,t.dropNote.width=o.width,t.dropNote.left=l.offsetParent.offsetLeft,t.dropNote.top=l.offsetTop,t.$apply()},t.onResizeEnd=function(e,o){o.element.css("width",""),angular.extend(e.note,i[d]),t.dropNote.visible=!1,t.$apply()},t.onResize=function(e,o){var n,a=r[0];r.forEach(function(t){n=Math.abs(o.width-t),a>n&&(d=t,a=n)}),t.dropNote.width=d,t.$apply()},t.onDrop=function(t,e,o,n){"move"===t.dataTransfer.dropEffect&&(n[4*e.beat+e.subbeat][e.string.index].note={}),o.note=e.note},t.updateNote=function(t){},t.onDragEnter=function(o,n){var a=o.target||o.originalTarget;"BUTTON"===a.tagName&&(a=a.parentElement.parentElement),e(function(){t.dropNote.visible=!0,t.dropNote.left=a.offsetParent.offsetLeft,t.dropNote.top=a.offsetTop})},t.onDragLeave=function(e,o){t.dropNote.visible=!1},t.$on("ANGULAR_DRAG_START",function(e,o,r,d){n=d.data,n.note.length&&(t.dropNote.width=o.target.clientWidth,o.ctrlKey||(a=angular.element(o.target),setTimeout(function(){a.addClass("drag-element")},100)),t.$apply())}),t.$on("ANGULAR_DRAG_END",function(e,o,n,r){a&&(a.removeClass("drag-element"),a=null),t.dropNote.visible=!1}),t.dropValidation=function(e,o){if(e.note.name&&e.note.length)return!1;var n=t.bass.stringFret(e.string,o.note);return-1!==n}}t.$inject=["$scope","$timeout"],angular.module("bd.app").controller("NoteController",t)}();
