...
!function(){"use strict";function e(e,n,t,a,o,i,s){function l(){i.draw(),e.playing&&requestAnimationFrame(l)}var r;setTimeout(function(){r=a.createAnalyser(),r.fftSize=1024,r.connect(a.destination),o.initialize(r),i.initialize(document.getElementById("canvas"),r)},200);var u=new s("B0","G4");e.bass={notes:u,noteStringOctaves:function(e,n){var t=[];return u.list.slice(n.noteIndex,n.noteIndex+24).filter(function(n){-1!==n.label.indexOf(e)&&t.push(n.octave)}),t},stringFret:function(e,n){var t=n.name+n.octave,a=u.list.indexOf(u.map[t]),o=a-e.noteIndex;return o>=0&&24>=o?o:-1},strings:[{label:"E",octave:1,index:0,noteIndex:u.list.indexOf(u.map.E1)},{label:"A",octave:1,index:1,noteIndex:u.list.indexOf(u.map.A1)},{label:"D",octave:2,index:2,noteIndex:u.list.indexOf(u.map.D2)},{label:"G",octave:2,index:3,noteIndex:u.list.indexOf(u.map.G2)}].reverse(),playingStyles:{finger:{name:"finger",label:"Finger",noteLabel:function(e){return e.note.name?"{0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},slap:{name:"slap",label:"Slap",noteLabel:function(e){return e.note.name?"<sup>(Slap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},pop:{name:"pop",label:"Pop",noteLabel:function(e){return e.note.name?"<sup>(Pop)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},tap:{name:"tap",label:"Tap",noteLabel:function(e){return e.note.name?"<sup>(Tap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},hammer:{name:"hammer-on",label:"Hammer on",noteLabel:function(e){return e.note.name?'<span class="hammer-top">)</span>                <span class="hammer-bottom">h</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}},pull:{name:"pull-of",label:"Pull of",noteLabel:function(e){return e.note.name?'<span class="pull-top">p</span>                <span class="pull-bottom">)</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}}}},console.log(e.bass);for(var m={top:4,bottom:4},c=[{name:""},{name:"i"},{name:"and"},{name:"a"}],p={timeSignature:m,subbeats:[],nextSubbeat:function(e){return this.subbeats[e._index+1]},prevSubbeat:function(e){return this.subbeats[e._index-1]}},b=1;12>=b;b++){var d=angular.copy(c);d[0].name="{0}".format(b),d.forEach(function(e,n){e._index=(b-1)*d.length+n,e.beat=b,e.index=n+1,e.bar=p,e.width=1,e.note={volume:.75}}),p.subbeats=p.subbeats.concat(d)}var f,v={note:{style:"finger",name:"A",octave:2,length:1/8,staccato:!1,string:1}},g=[];for(f=0;f<p.timeSignature.top;f++)for(v=0;4>v;v++){var x=new Array(e.bass.strings);e.bass.strings.forEach(function(e){x[e.index]={string:e,beat:f,subbeat:v,note:{volume:.75},width:1}}),g.push(x)}g[1][0].note={name:"C",octave:2,length:1/8,volume:.75},e.bassData=g,e.bar=p,e.play=function(){var n=document.getElementById("time-marker"),t=angular.element(n);Velocity(n,{left:t.parent()[0].offsetWidth},{duration:4e3,easing:"linear",begin:function(){t.css("left","0px")}}),e.playing=!0,i.reset(),o.play(p,120),setTimeout(l,120)},e.stop=function(){e.playing=!1,o.stop()}}e.$inject=["$scope","$timeout","$mdDialog","context","audioPlayer","audioVisualiser","NotesModel"],angular.module("bd.app").controller("AppController",e).value("context",new AudioContext),window.dragstart_handler=function(e){console.log("dragStart"),e.dataTransfer.setData("text/plain",e.target.id)}}();
!function(){"use strict";function t(){function t(){}return t.prototype.initialize=function(t,i){this.x=0,this.y=0,this.width=canvas.offsetWidth,this.height=canvas.offsetHeight,canvas.setAttribute("width",this.width),canvas.setAttribute("height",this.height),this.ctx=canvas.getContext("2d"),this.ctx.fillStyle="rgb(240, 240, 240)",this.ctx.lineWidth=1,this.ctx.strokeStyle="rgb(180, 0, 0)",this.dataArray=new Uint8Array(i.frequencyBinCount),this.analyser=i},t.prototype.reset=function(){this.ctx.clearRect(0,0,this.width,this.height),this.x=0,this.ctx.moveTo(0,this.y)},t.prototype.draw=function(){var t=this.ctx;this.analyser.getByteTimeDomainData(this.dataArray),t.beginPath(),t.moveTo(this.x,this.y);for(var i=0;i<this.analyser.frequencyBinCount;i+=40){var s=this.dataArray[i]/128;this.y=s*this.height/2,this.x>this.width&&this.reset(),0===i||t.lineTo(this.x,this.y),this.x+=.75}t.stroke()},new t}angular.module("bd.app").factory("audioVisualiser",t)}();
...
!function(){"use strict";function e(e){function n(){this.playing=!1}var a,i={finger:{getResources:function(e){return"x"===e.name?["sounds/finger/ogg/X{1}".format(t[e.name],"1")]:["sounds/finger/ogg/{0}{1}".format(t[e.name],e.octave||"")]},play:function(e,t){console.log("playing ... "+e.name)}},hammer:{getResources:function(e){return["sounds/tap-{0}{1}".format(t[e.name],e.octave||"")]},play:function(e,t){console.log("playing ... "+e.name)}},slap:{getResources:function(e){return["sounds/slap-{0}{1}".format(t[e.name],e.octave||"")]},play:function(e,t){console.log("slapping ... "+e.name)}},pull:{getResources:function(e){return["sounds/pull-{0}{1}".format(t[e.name],e.octave||"")]}}};return n.prototype.initialize=function(e){this.destination=e,this.playingNotes=[]},n.prototype.playback=function(t){if(this.playing){var n=e.currentTime-this.startTime;if(n>this.subbeatIndex*this.subbeatTime){var o=(this.subbeatIndex%16+1,this.bar.subbeats[this.subbeatIndex].note);if(o.style&&o.name){var s=e.createBufferSource(),r=e.createGain();r.gain.value=0,s.connect(r),r.connect(this.destination),s.buffer=a.getAudioData(i[o.style].getResources(o)[0]);var u=o.length?this.subbeatTime*o.length*16:this.subbeatTime;o.dotted&&(u*=1.5),o.staccato&&(u=.8*u),u=1.1*u;var l=e.currentTime;s.start(l,0,u);var c={note:o,source:s,gain:r,startTime:l,endTime:l+u,fadeIn:"x"===o.name?0:60,fadeOut:"x"===o.name?0:60};this.playingNotes.push(c)}this.subbeatIndex++}if(this.playingNotes.length){var f=e.currentTime;this.playingNotes=this.playingNotes.filter(function(e){return f>e.endTime?!1:!0}),this.playingNotes.forEach(function(e){var t=1e3*(f-e.startTime);if(t<e.fadeIn)e.gain.gain.value=t/e.fadeIn*e.note.volume;else{var n=1e3*(e.endTime-f);n<e.fadeOut?e.gain.gain.value=n/e.fadeOut*e.note.volume:e.gain.gain.value=e.note.volume}})}requestAnimationFrame(this.playback.bind(this))}},n.prototype._play=function(t,n){this.playing=!0,this.startTime=e.currentTime;var a=60/n;return this.subbeatTime=a/4,this.subbeatIndex=0,this.bar=t,void this.playback()},n.prototype.play=function(t,n){function o(e){s._play(t,n)}var s=this;console.log(t);var r=[],u={};t.subbeats.forEach(function(e){if(e.note.style){console.log("get resources: "+e.note.style);var t,n=i[e.note.style].getResources(e.note);n.forEach(function(e){t=e+".ogg",-1===r.indexOf(t)&&(u[e]=r.length,r.push(t))})}}),console.log(r),console.log(u),a=new BufferLoader(e,r,o),a.getAudioData=function(e){return a.bufferList[u[e]]},a.load()},n.prototype.stop=function(e){this.playing=!1},new n}e.$inject=["context"],angular.module("bd.app").factory("audioPlayer",e);var t={C:"C","C♯":"Db","D♭":"Db",D:"D","D♯":"Eb","E♭":"Eb",E:"E",F:"F","F♯":"Gb","G♭":"Gb",G:"G","G♯":"Ab",A:"A","A♯":"Bb","B♭":"Bb",B:"B"}}();
