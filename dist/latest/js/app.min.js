...
function BufferLoader(e,o,r){this.context=e,this.remoteServerUrl=o,this.localSoundsUrl=r,this.serverUrl=r||o,this.format="ogg",this.loadedResources={},this.loadingResources=[]}BufferLoader.prototype.loadResource=function(e,o,r){if(angular.isDefined(this.loadedResources[e]))return o&&o(this.loadedResources[e]),this.loadedResources[e];if(this.loadingResources.indexOf(e)===-1){var s=this,i=new XMLHttpRequest;i.open("GET",this.serverUrl+e+"."+this.format,!0),i.responseType="arraybuffer",i.onload=function(){s.context.decodeAudioData(i.response,function(r){var i=s.loadingResources.indexOf(e);return i!==-1&&s.loadingResources.splice(i,1),r?(s.loadedResources[e]=r,void(o&&o(r))):void alert("error decoding file data: "+e)},function(o){console.error("decodeAudioData error",o);var i=s.loadingResources.indexOf(e);i!==-1&&s.loadingResources.splice(i,1),r&&r(o)})},i.onerror=function(i){console.log(i),this.serverUrl!==this.remoteServerUrl&&(this.serverUrl=this.remoteServerUrl,this.loadResource(e,o,r));var t=s.loadingResources.indexOf(e);t!==-1&&s.loadingResources.splice(t,1)}.bind(this),i.send()}},BufferLoader.prototype.loadResources=function(e,o,r){e=e||[];var s=0;console.log("loadResources "+e.length);for(var i=function(){s++,s===e.length&&o&&o()},t=0;t<e.length;++t)this.loadResource(e[t],i,r)};
...
!function(){"use strict";function e(){return{scope:!1,link:function(e,a,t,n){window.SimpleScrollbar&&SimpleScrollbar.width>0?SimpleScrollbar.initEl(a[0],t.glScrollbar):a.css("overflow","auto")}}}function a(e,a,t,n,o,l,i,r,s,u,c,p,g,d){e.Note=d,e.settings=i,e.language="en",e.setLanguage=function(a){e.language=a,t.use(a),localStorage.setItem("preferences.lang",a)};var m=localStorage.getItem("preferences.lang");m&&e.setLanguage(m),e.ui={selectTrack:angular.noop,playlist:{}},e.player={mode:o.hash()?1:0,playing:!1,play:angular.noop,input:s.input,countdown:!1,loop:!0,speed:100,playbackRange:{start:1,end:1,max:1},playbackRangeChanged:angular.noop,progress:{max:0,value:0},setProgress:angular.noop,graphEnabled:!1,visibleBeatsOnly:!1,playlist:[]},e.playlistLabel=function(a){var t=e.player.playlist[a-1];return t},s.fetchResourcesWithProgress=function(t){var n=a.defer();return e.player.loading=!0,this.fetchResources(t).then(function(){n.resolve()},n.reject).finally(function(){e.player.loading=!1}),n.promise},s.input._volume=.75,e.bass={playingStyles:[{name:"finger",label:"FINGER"},{name:"slap",label:"SLAP"},{name:"pop",label:"POP"},{name:"pick",label:"PICK"},{name:"tap",label:"TAP"},{name:"hammer",label:"HAMMER_ON"},{name:"pull",label:"PULL_OFF"},{name:"ring",label:"LET_RING"}],settings:{label:"name-and-fret",colors:!0}},e.projectManager=c,e.workspace=r,e.barLabels={3:["trip","let"],4:["e","and","a"]},Object.defineProperty(d,"map",{value:"static",writable:!0}),d.map={};for(var b in d){var v=d[b];d.map[v.value]=v.symbol}e.Note=d,e.toggleVolumeMute=function(e){e.muted?e.audio.gain.value=e._volume||e.audio.gain.value:(e._volume=e.audio.gain.value,e.audio.gain.value=1e-4),e.muted=!e.muted},e.toggleInputMute=function(a){if(e.toggleVolumeMute(a),a.muted)console.log("mute microphone");else if(!a.source){var t=function(e){a.stream=e,a.source=l.createMediaStreamSource(e),a.source.connect(a.audio),u.activate(a.audio),a.audio.connect(l.destination)},n=function(){alert("Stream generation failed.")};navigator.getUserMedia=navigator.getUserMedia||navigator.webkitGetUserMedia,navigator.getUserMedia({audio:!0},t,n)}},e.slidesSizeChanged=function(){u.updateSize()},e.showHelp=function(){n.show({templateUrl:"views/help/help.html",autoWrap:!1,clickOutsideToClose:!0,propagateContainerEvents:!0})},e.initSliders=function(){e.$broadcast("rzSliderForceRender")},p.Drums.icon="drums",p.Percussions.icon="percussions",document.addEventListener("visibilitychange",function(a){e.player.playing&&"hidden"===document.visibilityState&&(e.player.playing=!1,s.stop(),e.$apply())}),window.workspace=r,window.pm=c,window.av=u,window.oncontextmenu=function(){return!1}}a.$inject=["$scope","$q","$translate","$mdDialog","$location","context","settings","workspace","audioPlayer","audioVisualiser","projectManager","Drums","dataUrl","Note"],angular.module("bd.app").controller("AppController",a).value("context",new AudioContext).value("workspace",{}).value("settings",{fretboard:{size:19}}).constant("Note",{Whole:{label:"WHOLE",symbol:"whole-note",value:1},Half:{label:"HALF",symbol:"half-note",value:2},Quarter:{label:"QUARTER",symbol:"quarter-note",value:4},Eighth:{label:"EIGHTH",symbol:"eighth-note",value:8},Sixteenth:{label:"SIXTEENTH",symbol:"sixteenth-note",value:16}}).run(["$mdDialog",function(e){if(!window.chrome){var a=e.alert().title("Warning").textContent("It is highly recommended to use Blink/Webkit based browser (Chrome, Chromium, Opera). Application may not work properly in other browsers.").theme(" ").ok("Close");e.show(a)}}]).directive("prettyScrollbar",e)}();
!function(){"use strict";function e(e,t){this.context=e,this.player=t,this.bufferLoader=t.bufferLoader}function t(e,t,a){for(var o,r=e[t],n=e[t],i=t+a,s=t,u=t,l=t;l<i;l+=3)o=e[l],o>r&&(r=o,s=l),o<n&&(n=o,u=l);for(var d=s;d&&!(e[d]<0);)d--;return{positiveValue:r,positiveIndex:s,negativeValue:n,negativeIndex:u,absoluteValue:Math.max(r,Math.abs(n)),crossIndex:d}}function a(e,t){var a=i[e];return a/Math.pow(Math.pow(2,1/12),t)}function o(e){return a(e.string,e.note.fret)}function r(e){for(var t=1;t<m.length;t++)m[t]=u[t]*e;return m}function n(e){for(var t=0;t<p.length-1;t++)p[t]=l[t]*e;return p}angular.module("bd.app").value("AudioComposer",e);var i={B:.0324,E:.024272,A:.018182,D:.01362,G:.0102041};e.prototype.join=function(e,a){var i=e.source.buffer.getChannelData(0),s=a.source.buffer.getChannelData(0),u=o(e.sound),l=parseInt(1.5*u*44100),d=parseInt(44100*e.duration),c=t(i,d-parseInt(44100*u),l).crossIndex,m=(c-d)/44100,p=e.endTime+m;e.gain.setValueCurveAtTime(n(e.sound.volume),p,u-.001),e.gain.setValueAtTime(1e-5,p+u),e.duration+=m+u,e.endTime+=m+u,u=o(a.sound),l=parseInt(1.5*u*44100);var f=parseInt(11025),v=t(s,f,l).crossIndex;a.offset=v/44100,a.startTime=p,a.duration=a.endTime-p,a.gain.setValueCurveAtTime(r(a.sound.volume),p,u-1e-4),a.gain.setValueAtTime(a.sound.volume,p+u)};for(var s=30,u=[1e-5],l=[1],d=1;d<s;d++){var c=d/s;l[d]=Math.cos(.5*c*Math.PI),u[d]=Math.cos(.5*(1-c)*Math.PI)}u.push(1),l.push(1e-5);for(var m=new Float32Array(u),p=new Float32Array(l),f={},v={},d=-12;d<13;d++)f[d]=Math.pow(Math.pow(2,1/12),d),v[d]=(1+f[d])/2;e.prototype.createSlide=function(e,o,r,n,i,s){var u=(performance.now(),[]),l=Math.abs(r.note.fret-r.note.slide.endNote.fret),d=r.note.fret>r.note.slide.endNote.fret?-1:1,c=o||this.player.createSoundAudio(e,r,i,0),m=c.source.buffer.getChannelData(0),p=a(r.string,r.note.fret),T=parseInt(1.5*p*44100),h=parseInt(44100*(c.duration+n[0])),g=t(m,h,T),I=g.crossIndex-h;h=g.crossIndex,c.slide={crossPointIndex:h,crossPointDuration:n[0]+I/44100,nextStepDurationCorrection:-I/44100,crossPointTime:c.startTime+h/44100,volume:o?o.slide?o.slide.volume:o.sound.volume:r.volume},c.slide.amplitude=g.absoluteValue*c.slide.volume,c.gain.setValueAtTime(c.slide.volume,i),c.duration+=c.slide.crossPointDuration,c.endTime+=c.slide.crossPointDuration,c.duration2=c.duration;for(var P,b=0;b<l;b+=P){p=a(r.string,r.note.fret+(b+1)*d);var A=(c.slide.nextStepDurationCorrection+n[b+1])/p;P=A<2.5&&b+1<l?2:1,T=parseInt(1.5*p*44100);var V=this.player.createSoundAudio(e,r,0,b+P);m=V.source.buffer.getChannelData(0);var x=parseInt(19845);g=t(m,x,T),x=g.crossIndex;var M=c.slide.nextStepDurationCorrection+n[b+1];2===P&&(M+=n[b+2]);var D=x+parseInt(M*v[-P*d]*44100),R=f[-d*P];g=t(m,D,T),I=g.crossIndex-D,D=g.crossIndex;var y=c.slide.amplitude/g.absoluteValue;V.slide={crossPointIndex:D,crossPointDuration:M+I/44100,nextStepDurationCorrection:-I/44100,crossPointTime:c.slide.crossPointTime+M+I/44100,amplitude:g.absoluteValue*y,volume:y,startRate:R},c.duration+=V.slide.crossPointDuration,c.endTime+=V.slide.crossPointDuration,c.slide.endRate=f[P*d],c.source.playbackRate.setValueAtTime(1,c.slide.crossPointTime),c.source.playbackRate.linearRampToValueAtTime(c.slide.endRate,V.slide.crossPointTime),c.gain.setValueAtTime(c.slide.volume,c.slide.crossPointTime),c.gain.linearRampToValueAtTime(1e-5,V.slide.crossPointTime),u.push(c),V.startTime=c.slide.crossPointTime,V.source.playbackRate.setValueAtTime(V.slide.startRate,V.startTime),V.source.playbackRate.linearRampToValueAtTime(1,V.slide.crossPointTime),V.gain.setValueAtTime(1e-5,V.startTime),V.gain.linearRampToValueAtTime(V.slide.volume,V.slide.crossPointTime-1e-4),V.offset=x/44100,V.duration=V.slide.crossPointDuration,V.endTime=V.slide.crossPointTime,c=V}for(var w=0,b=0;b<n.length;b++)w+=n[b];return c.duration+=n[n.length-1],c.endTime+=n[n.length-1],u.push(c),u},e.prototype.bend=function(e,t,a,o,r){function n(t,r,n,s){e.source.playbackRate.setValueAtTime(t,o+r*a),e.source.playbackRate.linearRampToValueAtTime(n,o+s*a);var u=(t+n)/2,l=(s-r)*a,d=(u-1)*l;i+=d}for(var i=0,s=t.note.bend,u=1;u<s.length;u++){var l=s[u-1],d=s[u];if(d!==l)n(Math.pow(Math.pow(2,1/12),l),(u-1)/(s.length-1),Math.pow(Math.pow(2,1/12),d),u/(s.length-1));else{var c=(Math.pow(Math.pow(2,1/12),d)-1)*(1/(s.length-1))*a;i+=c}}e.duration+=i}}();
!function(){"use strict";function t(t){return{scope:{config:"=bdFretDiagram"},controller:["$scope",function(e){function r(t){var e=t.split(":"),r=e[0],o=e[1],i=n.notes.map[o];n.strings[r].notes.indexOf(i);return{id:t,string:r,label:o,fret:n.strings[r].notes.indexOf(i),index:n.notes.list.indexOf(i)}}var o=e.config,n=t.track.instrument;console.log(o),e.instrument=n,e.rootNote=r(o.root),e.notes=o.notes.map(r),e.noteById={},e.notes.forEach(function(t){t.interval=t.index-e.rootNote.index,e.noteById[t.id]=t}),console.log(e.noteById);var i=[e.rootNote].concat(e.notes).map(function(t){return t.fret}),a=Math.min.apply(null,i),s=Math.max.apply(null,i);a=0,s=19,e.frets=[];for(var c=a;c<=s;c++)e.frets.push(c)}],templateUrl:"views/fret_diagram.html"}}function e(t,e,r){function o(){r._bassSoundScheduled=function(r,o){function c(t){return parseInt(1e3*(t-f))}var l=o.meta;if(n&&r===e.track.id){var f=t.currentTime;if("single"===l.type){var u="#"+l.string+"_"+l.note.name+l.note.octave,d=n.querySelector(u);setTimeout(function(e){if(a[l.string]&&a[l.string].elem===e&&a[l.string].end){var r=t.currentTime-a[l.string].end;r<.012&&(e.style.opacity=.75,setTimeout(function(){e.style.opacity=1},20))}a[l.string]={start:l.startTime,elem:e},e.classList.add("highlight"),i=l.note.fret},c(l.startTime),d),o.source.onended=function(){l.startTime===a[l.string].start&&(a[l.string].end=t.currentTime),l.startTime===a[l.string].start||d!==a[l.string].elem?d.classList.remove("highlight"):(d.style.opacity=.75,setTimeout(function(){d.style.opacity=1},30))}}else if("sequence"===l.type){console.log("HIGHLIGHT sequence");var m=[];l.notes.forEach(function(t,e){var r;r=t.note.name?"#"+l.string+"_"+t.note.name+t.note.octave:".string.{0} .fret-{1} label".format(l.string,t.note.fret);var o=Array.from(n.querySelectorAll(r));setTimeout(function(t,e){e.forEach(function(t){t.classList.remove("highlight")}),t.forEach(function(t){t.classList.add("highlight")})},c(t.startTime),o,m),m=o});var g=l.notes[l.notes.length-1];setTimeout(function(){m.forEach(function(t){t.classList.remove("highlight")})},c(g.startTime+g.duration)-5)}else if("ghost"===l.type){var h=angular.isDefined(o.sound.note.fret)?o.sound.note.fret:i,v=[h,h+1,h+2].map(function(t){return".string.{0} .fret-{1} label".format(l.string,t)}).join(","),y=Array.from(n.querySelectorAll(v));setTimeout(function(){console.log("GHOST START: "+l.startTime),y.forEach(function(t){t.classList.add("highlight"),t.classList.add("x")}),s[l.string]={start:l.startTime,fret:h}},c(l.startTime)),o.source.onended=function(){console.log("GHOST END: "+s[l.string].start),console.log(h+" vs "+s[l.string].fret),l.startTime===s[l.string].start||h!==s[l.string].fret?y.forEach(function(t){t.classList.remove("highlight"),t.classList.remove("x")}):(console.log("ghost blink"),y.forEach(function(t){t.style.opacity=.75}),setTimeout(function(){y.forEach(function(t){t.style.opacity=1})},30))}}}}}var n,i=5,a={},s={};return o.prototype.activate=function(t){n=t},o.prototype.clearActiveChord=function(){if(n){var t=Array.from(n.querySelectorAll(".active"));t.forEach(function(t){t.classList.remove("active")});var e=n.querySelector(".root");e&&e.classList.remove("root")}},o.prototype.clearDiagram=function(){if(console.log("clearDiagram"),n){this.clearActiveChord();var t=Array.from(n.querySelectorAll(".highlight"));t.forEach(function(t){t.classList.remove("highlight")})}},o.prototype.setChord=function(t,e,r){if(this.clearActiveChord(),n&&r.root){var o="#{0}_{1}{2}".format(r.string,r.root,r.octave),i=n.querySelector(o);i&&i.classList.add("root");for(var a=r.start[0],s=r.start[1],c=r.start[2]||1,l=t.tracks[e],f=t.meta.chords.indexOf(r),u=t.meta.chords[f+1],d=u?u.start:[t.length+1,1,1],m=d[0],g=d[1],h=d[2],v=1e3*a+10*s+c,y=1e3*m+10*g+h,p=[],T=l.beat(a,s);T&&1e3*T.bar+10*T.beat<y;)Array.prototype.push.apply(p,l.beatSounds(T).filter(function(t){var e=1e3*T.bar+10*T.beat+t.start*T.subdivision+1;return e>=v&&e<y})),T=l.nextBeat(T);var b=new Set;p.forEach(function(t){if("ghost"!==t.note.type){var e="#"+t.string+"_"+t.note.name+t.note.octave;b.add(e)}if("slide"===t.note.type){var e="#"+t.string+"_"+t.note.slide.endNote.name+t.note.slide.endNote.octave;b.add(e)}});var A=Array.from(b).join(",");A&&Array.from(n.querySelectorAll(A)).forEach(function(t){t.classList.add("active")})}},o.prototype.beatSync=function(t){if(t.section.meta&&t.section.meta.chords){var r=t.section.meta.chords.find(function(e,r){return e.start[0]===t.bar&&e.start[1]===t.beat});if(r){var o=r.start[2]||1,n=t.startTime-t.eventTime+(o-1)*t.duration/4;setTimeout(function(){this.setChord(t.section,e.track.id,r)}.bind(this),parseInt(1e3*n)-10)}}},new o}t.$inject=["workspace"],e.$inject=["context","workspace","audioPlayer"],angular.module("bd.app").directive("bdFretDiagram",t).factory("fretboardViewer",e)}();
...
!function(){"use strict";function e(e){this.resource=e}function t(t,n,a,r,o,i,s,u){function c(e,t){function n(t){for(var n,a=u.noteValue(t),r=1e3,o=0;o<e.length;o++){var i=e[o],s=u.codeTovalue(i),c=a-s;if(!(Math.abs(c)<Math.abs(r)))break;r=c,n=i}return{code:n,shift:r}}var a={};return t.list.forEach(function(e){var t={name:e.label[0],octave:e.octave},r=u.noteValue(t),o=n(t);a[r]=o}),a}function l(e,t){var n=(e.end-e.start)*t;return e.note.staccato&&(n=.95*n-t/4*.2),n}function d(){i.call(this,["playbackStarted","playbackStopped"]),this.playing=!1,this.countdown=!1,this.setBpm(60),this.setPlaybackSpeed(1),this.bufferLoader=new BufferLoader(a,o,r),this.scheduledSounds=[],this.input={muted:!0,audio:a.createGain()},this.input.audio.gain.value=.001,this.bufferLoader.loadResource("sounds/drums/drumstick");var t=this;this.soundHandlers=[{accepts:function(e){return"hammer"===e.style||"pull"===e.style},getResources:function(e,t){for(var n=t;n.prev;)n=e.prevSound(n);return["sounds/bass/{0}/{1}{2}".format(n.style,t.string,t.note.fret)]},transitionPlayback:function(e,n,a,r,o){var i=e[e.length-1],s=t.createSoundAudio(n,a,r),u=l(a,o);s.duration=u,s.endTime=r+u,t.composer.join(i,s),s.meta={type:"single",string:a.string,note:a.note,startTime:r,duration:u},e.push(s)}},{accepts:function(e){return"slide"===e.note.type},getResources:function(e,t){for(var n=t;n.prev;)n=e.prevSound(n);for(var a=t.note.fret>t.note.slide.endNote.fret?-1:1,r=t.note.slide.endNote.fret+a,o=[],i=t.note.fret;i!==r;i+=a)o.push("sounds/bass/{0}/{1}{2}".format(n.style,t.string,i));return o},slideCurve:function(e,t,n,a){var r=l(e,t),o=Math.abs(e.note.fret-e.note.slide.endNote.fret),i=new Array(o+2);i[0]=Math.max(r*n,.02),i[i.length-1]=Math.max(r*a,.02);var s=r-i[0]-i[i.length-1];if(e.note.slide.easing)for(var u=e.note.slide.easing,c=new BezierEasing(u[0],u[1],u[2],u[3]),d=1;d<=o;d++){var p=c(d/o)-c((d-1)/o);i[d]=p*s}else{var f=s/o;i.fill(f,1,1+o)}return i},metaNotes:function(e,t,n){var a=[];a.push({note:e.note,startTime:t,duration:n[0]});for(var r=e.note.slide.endNote.fret>e.note.fret?1:-1,o=1;o<n.length-2;o++){var i=a[a.length-1];a.push({note:{fret:e.note.fret+o*r},startTime:i.startTime+i.duration,duration:n[o]})}return a.push({note:e.note.slide.endNote,startTime:a[a.length-1].startTime+a[a.length-1].duration,duration:n[n.length-1]}),a},prepareForPlayback:function(e,n,a,r){var o=n.note.slide.start||.2,i=n.note.slide.end||.8,s=this.slideCurve(n,r,o,1-i),u=t.composer.createSlide(e,null,n,s,a,r);return u[0].meta={type:"sequence",string:n.string,notes:this.metaNotes(n,a,s)},u},transitionPlayback:function(e,n,a,r,o){var i=e.pop(),s=a.note.slide.start||.05,u=a.note.slide.end||.85,c=this.slideCurve(a,o,s,1-u),l=t.composer.createSlide(n,i,a,c,r,o),d=i.meta?i:e[0],p=this.metaNotes(a,r,c);d.meta.notes?Array.prototype.push.apply(d.meta.notes,p):(p.splice(0,0,{note:d.meta.note,startTime:d.meta.startTime,duration:d.meta.duration}),d.meta={type:"sequence",string:a.string,notes:p}),Array.prototype.push.apply(e,l)}},{accepts:function(e){return"ring"===e.style},getResources:function(e,t){return[]},prepareForPlayback:function(){},transitionPlayback:function(e,n,a,r,o){var i=e[e.length-1],s=l(a,o);if(i.duration+=s,i.endTime+=s,"bend"===a.note.type&&t.composer.bend(i,a,s,r,o),i.meta)i.meta.duration+=s;else for(var u=e.length-1;u>=0;u--){var c=e[u].meta;if(c&&c.notes){console.log("found prev meta at: "+u),c.notes[c.notes.length-1].duration+=s;break}}}},{accepts:function(e){return"grace"===e.note.type},getResources:function(e,t){return["sounds/bass/{0}/{1}{2}".format(t.style,t.string,t.note.fret-2),"sounds/bass/{0}/{1}{2}".format(t.style,t.string,t.note.fret)]},prepareForPlayback:function(e,n,a,r){console.log("grace sound");var o=.08,i=t.createSoundAudio(e,n,a),s=t.createSoundAudio(e,n,a+o,1),u=l(n,r);return i.duration=o,i.endTime=a+i.duration,s.duration=u-i.duration,s.endTime=a+u,t.composer.join(i,s),s.meta={type:"sequence",string:n.string,notes:[{note:{fret:n.note.fret-2},startTime:a,duration:o},{note:n.note,startTime:a+o,duration:u-o}]},[i,s]}},{accepts:function(e){return"bend"===e.note.type},getResources:function(e,t){return["sounds/bass/{0}/{1}{2}".format(t.style,t.string,t.note.fret)]},prepareForPlayback:function(e,n,a,r){var o=t.createSoundAudio(e,n,a),i=l(n,r);return o.duration=i,o.endTime=a+i,t.composer.bend(o,n,i,a,r),o.meta={type:"single",string:n.string,note:n.note,startTime:a,duration:i},[o]}},{accepts:function(e){return"ghost"===e.note.type},getResources:function(e,t){return["sounds/bass/{0}/{1}X".format(t.style,t.string)]},prepareForPlayback:function(e,n,a,r){var o=t.createSoundAudio(e,n,a);return o.duration=.25,o.endTime=a+o.duration,o.meta={type:"ghost",string:n.string,startTime:a,duration:o.source.buffer.duration},[o]}},{accepts:function(e){return"harmonics"===e.note.type},getResources:function(e,t){return["sounds/bass/{0}/{1}{2}_H".format(t.style,t.string,t.note.fret)]},prepareForPlayback:function(e,n,a,r){var o=t.createSoundAudio(e,n,a),i=l(n,r);return o.duration=i,o.endTime=a+i,o.meta={type:"single",string:n.string,note:n.note,startTime:a,duration:i},[o]}},{accepts:function(e){return"regular"===e.note.type},getResources:function(e,t){return["sounds/bass/{0}/{1}{2}".format(t.style,t.string,t.note.fret)]},prepareForPlayback:function(e,n,a,r){var o=t.createSoundAudio(e,n,a),i=l(n,r);return o.duration=i,o.endTime=a+i,o.meta={type:"single",string:n.string,note:n.note,startTime:a,duration:i},[o]}}],this.composer=new s(a,this);var n={notes:new u("A0","C7"),playingSounds:{},createSoundAudio:function(n,r,o,i){var s=t.bufferLoader.loadResource(i);if(s){var u=a.createBufferSource(),c=a.createGain();return u.connect(c),c.connect(n.audio),u.buffer=s,{sound:r,source:u,gain:c.gain,output:c,startTime:o,endTime:o,duration:0,offset:0}}throw new e(i)},handlers:[{accepts:function(e){return angular.isDefined(e.note)},getResources:function(e,t){var a=e.instrument.preset,r=n.samples[a][u.noteValue(t.note)];return["sounds/piano/"+a+"/"+r.code.replace("♭","b")]},prepareForPlayback:function(e,t,a,r,o){var i=this.getResources(t,a),s=n.createSoundAudio(t,a,r,i[0]),c=(a.end-a.start)*o,l=n.samples[t.instrument.preset][u.noteValue(a.note)];if(0!==l.shift){var d=Math.pow(Math.pow(2,1/12),l.shift);s.source.playbackRate.value=d}return s.duration=c,s.endTime=r+c,[s]}}],getHandler:function(e){for(var t=0;t<this.handlers.length;t++){var n=this.handlers[t];if(n.accepts(e))return n}}},d=c("C1 E♭1 G♭1 A1 C2 E♭2 G♭2 A2 C3 E♭3 G♭3 A3 C4 E♭4 G♭4 A4 C5 E♭5 G♭5 A5 C6 E♭6 G♭6 A6 C7 E♭7 G♭7 A7".split(" "),n.notes),p=c("F1 B1 E2 A2 D3 G3 B3 D4 F4 B4 E5 A5 D6 G6 C7".split(" "),n.notes);n.samples={acoustic:d,electric:p},this.piano=n,n.strings=[new u("E3","E5"),new u("B2","B4"),new u("G2","G4"),new u("D2","D4"),new u("A1","A3"),new u("E1","E3")],n.note=function(e,t){var n=this.strings[e],a=n.list[t];return a.label[0]+a.octave},window.p=n}return d.prototype=Object.create(i.prototype),d.prototype._playDrumStick=function(e){var t=this.bufferLoader.loadResource("sounds/drums/drumstick"),n=a.createBufferSource();n.buffer=t,n.connect(a.destination),n.start(a.currentTime,0,.2)},d.prototype._playDrumSound=function(e,t,n){var r=this.bufferLoader.loadResource(e.instrument.drumMap[t.drum].filename);if(r){var o=a.createBufferSource();o.buffer=r;var i=a.createGain();i.gain.value=t.volume,o.connect(i),i.connect(e.audio),o.start(n),this.scheduledSounds.push({gain:i.gain,endTime:n+o.buffer.duration})}},d.prototype.createSoundAudio=function(t,n,r,o){var i=this._getSoundHandler(n).getResources(t,n),s=i?this.bufferLoader.loadResource(i[o||0]):null;if(s){var u=a.createBufferSource(),c=a.createGain();return u.connect(c),c.connect(t.audio),u.buffer=s,{sound:n,source:u,gain:c.gain,output:c,startTime:r,endTime:r,duration:0,offset:0}}throw new e(i[o||0])},d.prototype._getSoundHandler=function(e){for(var t=0;t<this.soundHandlers.length;t++){var n=this.soundHandlers[t];if(n.accepts(e))return n}},d.prototype._bassSoundScheduled=function(e,t){},d.prototype._playSound=function(e,t,n,a,r,o){var i,s=l(a,o);if(a.prev&&(i=this.piano.playingSounds[a.string]),!a.prev||!i){if(i=this.piano.getHandler(a).prepareForPlayback(e,t,a,r,o)[0],!i)return;i.gain.setValueAtTime(.8*i.sound.volume,r),a.next?i.source.start(i.startTime,i.offset):i.source.start(i.startTime,i.offset,s+.25),this.scheduledSounds.push(i),this.piano.playingSounds[a.string]=i}i.endTime=r+s,a.next||(i.gain.setValueAtTime(.8*i.sound.volume,i.endTime-.05),i.gain.linearRampToValueAtTime(1e-4,i.endTime+.2))},d.prototype._playBassSound=function(e,t,n,a,r){if(!n.prev){var o=this._getSoundHandler(n).prepareForPlayback(t,n,a,r),i=o[0];if(i.gain.setValueAtTime(i.sound.volume,a),n.next)for(var s=t.nextSound(n);s;){var u=o[o.length-1].endTime;this._getSoundHandler(s).transitionPlayback(o,t,s,u,r),i=o[o.length-1],s=s.next?t.nextSound(s):null}i=o[o.length-1];var c=i.slide?i.slide.volume:i.sound.volume;i.gain.setValueAtTime(c,i.endTime-.015),i.gain.linearRampToValueAtTime(1e-5,i.endTime);for(var l=0;l<o.length;l++){var d=o[l];d.source.start(d.startTime,d.offset,d.duration),this.scheduledSounds.push(d),d.meta&&this._bassSoundScheduled(e,d)}return i}},d.prototype.playBeat=function(n,r,o,i){if(this.playing){var s=n===this.playbackRange.start.bar&&r===this.playbackRange.start.beat,u=s&&!i,c=this.section.timeSignature,l=a.currentTime,d=60/(this.bpm*this.playbackSpeed);if(!u){for(var p in this.section.tracks){var f=this.section.tracks[p],h=f.beat(n,r);f.beatSounds(h).forEach(function(t){var n=o+t.start*d;try{"bass"===f.type?this._playBassSound(p,f,t,n,d):"drums"===f.type?this._playDrumSound(f,t,n):this._playSound(p,f,h,t,n,d)}catch(t){if(!(t instanceof e))throw t;console.log("Failed to load resource: "+t.resource)}},this)}var m=(n-1)*this.section.timeSignature.top+r-1;this.beatPreparedCallback({section:this.section,bar:n,beat:r,eventTime:l,startTime:o,endTime:o+d,duration:d,timeSignature:this.section.timeSignature,flatIndex:m,playbackActive:!u,playbackStart:s})}if(this.scheduledSounds.length&&(this.scheduledSounds=this.scheduledSounds.filter(function(e){return l<=e.endTime})),u)t(function(){this.stop()}.bind(this),1e3*(o-l));else{var g,y,b=r===c.top,u=n===this.playbackRange.end.bar&&r===this.playbackRange.end.beat;u?(g=this.playbackRange.start.bar,y=this.playbackRange.start.beat):(g=b?n+1:n,y=b?1:r+1);var v=o+d;if(v<l+.075)return void this.stop();var S=1e3*(v-l-.2);S=Math.max(S,75),this.lastSyncTimerId=setTimeout(this.playBeat.bind(this),S,g,y,v)}}},d.prototype._play=function(e){var t=a.createGain();t.gain.value=1e-4,e.backingTrack&&(e.backingTrack.audio.addEventListener("playing",function(){console.log("backingTrack playing")}),e.backingTrack.audio.currentTime=e.backingTrack.start||0,e.backingTrack.audio.play(),this.backingTrack=e.backingTrack),this.piano.playingSounds={};var n=e.start||this.playbackRange.start,r=n.bar,o=n.beat;this.playBeat(r,o,a.currentTime,!0)},d.prototype.setBpm=function(e){this.bpm=e},d.prototype.setPlaybackSpeed=function(e){this.playbackSpeed=e},d.prototype.fetchSoundResources=function(e,t){if(t.style&&t.note){var n=this._getSoundHandler(t).getResources(e,t);this.bufferLoader.loadResources(n)}},d.prototype.fetchResources=function(e,t){function a(){s.resolve(),t&&t.apply(o,i)}function r(e){e.forEach(function(e){u.indexOf(e)===-1&&u.push(e)})}angular.isArray(e)||(e=[e]);var o=arguments[2],i=Array.prototype.slice.call(arguments,3),s=n.defer(),u=[];return e.forEach(function(e){for(var t in e.tracks){var n=e.tracks[t];"drums"===n.type&&n.forEachSound(function(e){r([n.instrument.drumMap[e.drum].filename])}),"bass"===n.type&&n.forEachSound(function(e){e.note&&e.style&&r(this._getSoundHandler(e).getResources(n,e))},this),"piano"===n.type&&n.data.forEach(function(e){e.data.forEach(function(e){r(this.piano.getHandler(e).getResources(n,e))},this)},this)}},this),console.log(u),u.length?(this.bufferLoader.loadResources(u,a,s.reject),s.promise):(t&&t.apply(o,i),n.when())},d.prototype.play=function(e,t,n,a){function r(){i>0?(i--,o.playing&&(o._playDrumStick(),setTimeout(r,6e4/(o.bpm*o.playbackSpeed)))):o._play(a)}a=a||{},this.section=e,this.playing=!0,this.lastSyncTimerId=0;var o=this;this.beatPreparedCallback=angular.isFunction(t)?t:angular.noop,this.playbackStoppedCallback=angular.isFunction(n)?n:angular.noop;var i=a.countdown?3:0;r()},d.prototype.stop=function(e){if(this.playing=!1,this.lastSyncTimerId&&clearTimeout(this.lastSyncTimerId),e){var t=a.currentTime;this.scheduledSounds.forEach(function(e){try{t<e.startTime?e.source.stop():(e.gain.cancelScheduledValues(t),e.gain.setValueAtTime(e.gain.value,t),e.gain.linearRampToValueAtTime(1e-4,t+.05))}catch(e){console.log("Error")}}),this.backingTrack&&this.backingTrack.audio.pause()}this.playbackStoppedCallback()},d.prototype.playBassSample=function(e,t){function n(n){setTimeout(function(){s.playingBassSample=s._playBassSound(null,e,t,a.currentTime,60/(s.bpm*s.playbackSpeed)),s.playingBassSample.source.playing=!0,s.playingBassSample.source.addEventListener("ended",function(e){e.target.playing=!1})},50)}var r=this._getSoundHandler(t).getResources(e,t);if(t.next)for(var o=t;o.next;){o=e.nextSound(o);var i=this._getSoundHandler(o).getResources(e,o);i.forEach(function(e){r.indexOf(e)===-1&&r.push(e)})}console.log(r);var s=this;if(s.playingBassSample&&s.playingBassSample.source.playing){var u=a.currentTime;s.playingBassSample.gain.cancelScheduledValues(u),s.playingBassSample.gain.setValueAtTime(s.playingBassSample.gain.value,u),s.playingBassSample.gain.linearRampToValueAtTime(1e-4,u+.05)}this.bufferLoader.loadResources(r,n)},d.prototype.playPianoSample=function(e,t){t.start=0,t.end=.5;var n=this.piano.getHandler(t).getResources(e,t);this.bufferLoader.loadResources(n,this._playSound.bind(this,e.id,e,{subdivision:4},t,a.currentTime,1))},d.prototype.playDrumSample=function(e,t){this.bufferLoader.loadResource(e.instrument.drumMap[t.drum].filename,this._playDrumSound.bind(this,e,t,a.currentTime))},new d}t.$inject=["$timeout","$q","context","localSoundsUrl","soundsUrl","Observable","AudioComposer","Notes"],angular.module("bd.app").factory("audioPlayer",t)}();
!function(){"use strict";function t(t){this.readOnly=!0,this.projectData=t}function e(){this.readOnly=!1,this.PROJECTS_KEY="bd.projects",this.projects=this.projectsList()}function o(t){return"bd.project.{0}".format(t)}function i(t){return"bd.playlists.{0}".format(t)}function r(t,e){return"bd.section.{0}.{1}".format(t,e)}function s(t){return t.reduce(function(t,e){return e.id>=t?e.id+1:t},1)}function c(t){return function(e){return e.id===t}}function a(t,o,i,r,a,n,p,l,u,h){function d(){this.store=new e,r.call(this,["projectLoaded","playlistLoaded","sectionLoaded","sectionDeleted","sectionCreated"])}function f(t){t.beatLabels=function(){var t=new Array(13);if(this.barSubdivision)for(var e=this.barSubdivision.split("+").map(Number),o=1,i=0;i<e.length;i++)for(var r=1,s=e[i];s--;)t[o++]=r++;else for(var i=1;i<=this.timeSignature.top;i++)t[i]=i;return t}.bind(t)}var j={},v={};return d.prototype=Object.create(r.prototype),d.prototype.addTrack=function(t){angular.isUndefined(j[t.type])&&(j[t.type]=0),t.id=t.type+"_"+j[t.type],"Standard"===t.kit?(t.kit="Drums",t.name=t.kit):"Bongo"===t.kit&&(t.kit="Percussions",t.name=t.kit),"piano"===t.type?(t.range=t.range||["C2","B5"],t.preset=t.preset||"acoustic",t.instrument=new l(t)):t.instrument="bass"===t.type?new n(t):p[t.kit],t.audio=a.createGain(),t.volume&&(t.audio.gain.value=t.volume.muted?1e-4:t.volume.value,t._volume=t.volume.value);var e=v[t.type];if(e||"drums"===t.type)t.audio.connect(a.destination);else{e=a.createDynamicsCompressor(),e.threshold.value=-35,e.knee.value=40,e.ratio.value=12,e.attack.value=0,v[t.type]=e;var o=a.createOscillator();o.frequency.value=22050,o.connect(e),e.connect(a.destination),o.start(),setTimeout(function(){o.stop()},50),t.audio.connect(e)}var i=this.project.tracks.length;this.project.tracks.forEach(function(e,o){e.type===t.type&&(i=o+1)}),this.project.tracks.splice(i,0,t),this.project.tracksMap[t.id]=t,j[t.type]+=1},d.prototype.removeTrack=function(t){var e=this.project.tracks.findIndex(c(t));this.project.tracks.splice(e,1),delete this.section[t],delete this.project.tracksMap[t]},d.prototype.addBackingTrack=function(t){this.project.backingTrack=new Audio([t])},d.prototype.createProject=function(t){return j={},v={},this.store.project=null,this.project={sections:[],tracks:[],tracksMap:{},playlists:[]},this.createPlaylist(),t.forEach(this.addTrack.bind(this)),this.dispatchEvent("projectLoaded",this.project),this.project},d.prototype.loadProject=function(t){j={},v={};var e=this.store.getProject(t);return this.project={name:e.name,sections:angular.copy(e.sections),tracks:[],tracksMap:{},playlists:[]},e.tracks.forEach(this.addTrack.bind(this)),e.playlists.length?(this.project.playlists=e.playlists,this.project.playlists.forEach(function(t,e){t.id=e+1})):this.createPlaylist(),this.dispatchEvent("projectLoaded",this.project),this.project},d.prototype.createSection=function(t){var e={timeSignature:{top:4,bottom:4},bpm:80,length:4};return t&&Object.keys(t).forEach(function(o){e[o]=t[o]}),e.id=s(this.project.sections),e.tracks={},this.project.sections.push(e),this.section=e,e},d.prototype.createPlaylist=function(){var t={id:s(this.project.playlists),name:"",items:[]};return this.project.playlists.push(t),t},d.prototype.importSection=function(t){console.log("importSection"),t.id=s(this.project.sections),f(t),this.project.sections.push(t)},d.prototype.deleteSection=function(){if(this.section){var t=this.section.id;this.store.project&&this.store.deleteSection(t);var e=this.project.sections.findIndex(c(t));this.project.sections.splice(e,1)}this.saveProjectConfig(),this.dispatchEvent("sectionDeleted")},d.prototype.serializeSection=function(t){var e={name:t.name,timeSignature:t.timeSignature,length:t.length,bpm:t.bpm,meta:t.meta,barSubdivision:t.barSubdivision,tracks:{}};return this.project.tracks.forEach(function(o){var i=t.tracks[o.id];if(i){var r=i.rawData().filter(function(t){return t.data.length>0||t.meta&&Object.keys(t.meta).length>0});e.tracks[o.id]=r}},this),JSON.stringify(e)},d.prototype.saveProjectConfig=function(){if(this.store.project){var t=["id","instrument","audio","_volume"],e=this.project.tracks.map(function(e){return Object.keys(e).reduce(function(o,i){t.indexOf(i)===-1&&(o[i]=e[i]);var r=e.audio.gain.value<=.001;return o.volume={muted:r,value:r?e._volume:e.audio.gain.value},o},{})}),o=this.project.sections.map(function(t){return{id:t.id,name:t.name}});this.store.saveProjectConfig(e,o)}},d.prototype.saveSection=function(){console.log("ProjectManager.saveSection"),this.store.project||this.store.createProject(this.project.name);var t=this.section.id,e=this.serializeSection(this.section);this.store.saveSection(t,this.section.name,e);var o=this.project.sections.find(c(t));o&&(o.name=this.section.name),this.saveProjectConfig()},d.prototype.saveAsNewSection=function(t){var e=this.section.tracks;delete this.section.tracks;var o=this.createSection(this.section);o.name=t||"New",o.tracks=e,this.section=o,this.saveSection()},d.prototype.loadSectionData=function(t){console.log("loadSectionData");for(var e in t.tracks){var o=t.tracks[e];if(!o.audio){var i,r=e.split("_")[0];i="drums"===r?u:h;var s=new i(t,o);s.type=r,s.audio=this.project.tracksMap[e].audio,s.instrument=this.project.tracksMap[e].instrument,t.tracks[e]=s}}return t},d.prototype._filterProjectTracks=function(t){Object.keys(t.tracks).forEach(function(e){this.project.tracksMap[e]||(console.log("!! obsolete section track: "+e),delete t.tracks[e])},this)},d.prototype.getSection=function(t){var e=this.project.sections.find(c(t));if(!e)return void console.log("invalid section id: "+t);if(e.tracks&&e.tracks[this.project.tracks[0].id]&&angular.isFunction(e.tracks[this.project.tracks[0].id].beat))return console.log("Already converted/loaded section"),this._filterProjectTracks(e),e;e.tracks||(e.tracks={}),console.log("--- load section from store ---");var o=this.store.getSection(e.id);return o&&(this._filterProjectTracks(o),e=this.loadSectionData(o)),f(e),e},d.prototype.loadSection=function(t){console.log("loadSection: "+t),this.section=this.getSection(t),this.dispatchEvent("sectionLoaded",this.section)},d.prototype.loadPlaylist=function(t){this.playlist=this.project.playlists.find(c(t)),this.dispatchEvent("playlistLoaded",this.playlist)},d.prototype.deletePlaylist=function(t){var e=this.project.playlists.findIndex(c(t));e!==-1&&this.project.playlists.splice(e,1)},d.prototype._playlistsData=function(){return this.project.playlists.map(function(t){return{name:t.name,items:t.items,backingTrack:t.backingTrack}})},d.prototype.savePlaylists=function(){this.store.savePlaylists(this._playlistsData())},new d}a.$inject=["$http","$timeout","$q","Observable","context","Bass","Drums","Piano","DrumTrackSection","TrackSection"],angular.module("bd.app").value("ReadOnlyStore",t).value("ProjectLocalStore",e).factory("projectManager",a),t.prototype.getProject=function(t){return{id:1,name:this.projectData.name,tracks:this.projectData.tracks,sections:this.projectData.index,playlists:this.projectData.playlists||[]}},t.prototype.getSection=function(t){var e=this.projectData.index.findIndex(c(t)),o=this.projectData.sections[e];return o.name=this.projectData.index[e].name,o.id=this.projectData.index[e].id,o},e.prototype._updateProjectsOrder=function(t){var e=this.projects.findIndex(c(t));if(e!==-1){var o=this.projects.splice(e,1)[0];this.projects.splice(0,0,o);var i=JSON.stringify(this.projects);localStorage.setItem(this.PROJECTS_KEY,i)}},e.prototype.projectsList=function(){var t=localStorage.getItem(this.PROJECTS_KEY);return t?JSON.parse(t):[]},e.prototype.getProject=function(t){var e=JSON.parse(localStorage.getItem(o(t))),r=JSON.parse(localStorage.getItem(i(t)))||[];return this.project={id:t,upload_id:e.upload_id||"",name:e.name,sections:e.sections,tracks:e.tracks,playlists:r},this._updateProjectsOrder(t),this.project},e.prototype.createProject=function(t){console.log("Initialize project: "+t);var e=this.projects.reduce(function(t,e){return e.id>=t?e.id+1:t},1),e=s(this.projects);this.project={name:t,id:e,sections:[],tracks:[]},this.projects.splice(0,0,{id:this.project.id,name:this.project.name});var o=JSON.stringify(this.projects);return localStorage.setItem(this.PROJECTS_KEY,o),this.project},e.prototype.saveProjectConfig=function(t,e){var i=this.project.id;console.log("ProjectLocalStore.saveProjectConfig: "+o(i)),this.project.tracks=t,this.project.sections=e.filter(function(t){return this.project.sections.some(function(e){return e.id===t.id})},this);var r=JSON.stringify(this.project,function(t,e){if("playlists"!==t)return e});console.log(r),localStorage.setItem(o(i),r)},e.prototype.deleteProject=function(t){if(this.project.id===t)return void console.log("!! deleting opened project !!");var e=JSON.parse(localStorage.getItem(o(t)));if(e){var s=e.sections.map(function(e){return r(t,e.id)});s.push(i(t)),s.push(o(t)),s.forEach(localStorage.removeItem,localStorage)}var a=this.projectsList(),n=a.findIndex(c(t));n!==-1&&(a.splice(n,1),localStorage.setItem(this.PROJECTS_KEY,JSON.stringify(a))),this.projects=a},e.prototype.saveSection=function(t,e,o){var i=r(this.project.id,t);console.log("ProjectLocalStore.saveSection: "+i);var s=this.project.sections.some(function(e){return e.id===t});s||this.project.sections.push({id:t,name:e}),localStorage.setItem(i,o)},e.prototype.getSection=function(t){if(this.project){var e=r(this.project.id,t),o=localStorage.getItem(e);return o?(o=JSON.parse(o),o.id=t,o):void 0}},e.prototype.deleteSection=function(t){var e=r(this.project.id,t);localStorage.removeItem(e)},e.prototype.savePlaylists=function(t){var e=i(this.project.id);console.log("ProjectLocalStore.savePlaylists: "+e),localStorage.setItem(e,JSON.stringify(t))},e.prototype._projectData=function(){var t=this.project.id,e=JSON.parse(localStorage.getItem(o(t))),s=JSON.parse(localStorage.getItem(i(t)))||[],c=e.sections.map(function(e){var o=r(t,e.id);return JSON.parse(localStorage.getItem(o))}),a={name:e.name,index:e.sections,tracks:e.tracks,playlists:s,sections:c};return a}}();
!function(){"use strict";function e(e,t,o,n,i,c,r,a,s,l,d,p,m){function u(e){r.show({template:'<md-toast>            <div class="md-toast-content">{0}</div>          </md-toast>'.format(e),position:"bottom right",hideDelay:2500})}function f(e){u("<span>Section <b>{0}</b> was saved</span>".format(e))}function j(e,t,o){e.close=o.hide,e.instruments=[{name:"Bass",type:"bass",strings:"EADG"},{name:"Piano",type:"piano",range:["C2","B5"]},{name:"Drums",kit:"Drums",type:"drums"},{name:"Percussions",kit:"Percussions",type:"drums",icon:"percussions"}],e.addTrack=function(e){t.addTrack(e),o.hide()}}function v(e,t,o){e.projects=o.store.projectsList(),o.store.project&&(e.openedProjectId=o.store.project.id),e.close=t.hide,e.deleteProject=function(t){o.store.deleteProject(t),e.projects=o.store.projectsList()},e.openProject=function(e){t.hide(e)},e.importProjectFile=function(t){var o=t.filename.replace(".json","");console.log("Importing project: "+o);var n=new d(JSON.parse(t.content)),i=n.getProject();i.playlists.forEach(function(e,t){e.id=t+1});var c=new p;c.createProject(o),i.id=c.project.id,i.name=o,c.project=i,c.saveProjectConfig(i.tracks,i.sections),i.sections.forEach(function(e){var t=n.getSection(e.id);c.saveSection(t.id,t.name,JSON.stringify(t))}),c.savePlaylists(i.playlists),e.projects.push({id:i.id,name:t.filename})}}j.$inject=["$scope","projectManager","$mdDialog"],v.$inject=["$scope","$mdDialog","projectManager"],e.addTrackDialog=function(e){a.show({templateUrl:"views/editor/new_track.html",controller:j,autoWrap:!1,clickOutsideToClose:!0})},e.removeTrack=function(t){console.log("remove track: "+t);var o=s.project.tracksMap[t],n=s.project.tracks.find(function(e){return e.type===o.type&&e.id!==t});n?(e.ui.selectTrack(n.id),s.removeTrack(t)):a.show(a.alert().title("Warning").textContent("Can't remove this track, it's the last track of its instrument kind!").theme(" ").ok("Close"))},e.newProject=function(){s.store.readOnly&&(s.store=new p,c.hash("")),document.title="New Project",e.project=s.createProject([{type:"bass",name:"Bass",strings:"EADG",tuning:[0,0,0,0]},{type:"drums",kit:"Drums",name:"Drums"},{type:"drums",kit:"Percussions",name:"Percussions"}]);var t=s.createSection();l.selectedSectionId=t.id,l.section=t,s.loadSection(l.selectedSectionId)},e.loadProject=function(t){e.project=s.loadProject(t),document.title=e.project.name,l.selectedSectionId=e.project.sections[0].id,s.loadSection(l.selectedSectionId),l.section=s.section},e.openProject=function(){a.show({templateUrl:"views/open_project.html",controller:v,autoWrap:!1,clickOutsideToClose:!1}).then(function(t){t&&e.loadProject(t)})},e.newSection=function(){var e=s.createSection(s.section);e.name="New",l.selectedSectionId=e.id,s.loadSection(l.selectedSectionId)},e.saveSection=function(){if(l.section.name)if(s.project.name)s.saveSection(),f(l.section.name);else{var e=a.prompt().title("Saving Project").textContent("Please enter project name:").placeholder("Name").ariaLabel("Name").theme(" ").ok("Save").cancel("Cancel");a.show(e).then(function(e){e&&(document.title=e,s.project.name=e,s.saveSection(),f(l.section.name))})}},e.saveAsSection=function(){s.saveAsNewSection(),l.section=s.section,l.selectedSectionId=l.section.id},e.deleteSection=function(){s.deleteSection(l.selectedSectionId),s.project.sections.length>0?l.selectedSectionId=s.project.sections[0].id:l.selectedSectionId=s.createSection().id,s.loadSection(l.selectedSectionId)},e.newPlaylist=function(){var e=s.createPlaylist();s.loadPlaylist(e.id)},e.savePlaylists=function(){l.playlist.name&&(s.savePlaylists(),u("<span>Playlists was saved</span>"))},e.deletePlaylist=function(){var e=l.playlist.name;s.deletePlaylist(l.playlist.id),s.store.readOnly||s.savePlaylists(),u("<span>Playlist <b>{0}</b> was deleted</span>".format(e)),s.project.playlists.length&&s.loadPlaylist(s.project.playlists[0].id)},e.itemReorderHandler=function(e,t,o,n){var i=n.findIndex(function(e){return e.id===t}),c=n.splice(i,1)[0],r=n.findIndex(function(e){return e.id===o});n.splice(r,0,c)};var S=c.hash();if(S)n({url:m+S+".json",method:"GET"}).then(function(t){s.store=new d(t.data),e.project=s.loadProject(1),l.selectedSectionId=e.project.sections[0].id,s.loadSection(l.selectedSectionId)});else if(s.store.projects.length){var P=s.store.projects[0];try{e.loadProject(P.id)}catch(t){var g=a.alert().title("Warning").textContent("Failed to open latest project.").theme(" ").ok("Close");a.show(g),e.newProject()}}else e.newProject();e.exportProject=function(){var e=s.store._projectData(),t=(JSON.stringify(e),new Blob([JSON.stringify(e)],{type:"application/json;charset=utf-8"}));saveAs(t,s.project.name+".json")},e.uploadProject=function(){var t=o("UploadController",{$scope:e.$new(!0)}).constructor;a.show({templateUrl:"views/upload_form.html",controller:t,autoWrap:!1})},l.importProject=function(){t(function(){var t=c.path();console.log("Importing project: "+t);var o=s.project.sections.map(function(e){return s.getSection(e.id)});e.newProject(),o.forEach(s.importSection,s),s.loadSection(o[0].id),l.selectedSectionId=s.section.id})},l._import=function(e,t,o,n,i,c,r){var a=t,s=o,d={};for(var p in e.tracks)d[p]=[];for(var m=n,u=i;c--;){for(var p in e.tracks){var f=e.tracks[p],j=angular.copy(f.beat(a,s));j.bar=m,j.beat=u,d[p].push(j)}s++,s>e.timeSignature.top&&(s=1,a++),u++,u>e.timeSignature.top&&(u=1,m++)}for(var p in l.section.tracks)if(r&&r.indexOf(p)===-1)console.log("skipping track "+p);else{var v=l.section.tracks[p];v.loadBeats&&(console.log("importing track beats: "+p),v.loadBeats(d[p]))}},l.importBeats=function(e,t,o,n,i,c,r){var a=s.project.sections.find(function(t){return t.name===e}).id,d=s.getSection(a);l._import(d,t,o,n,i,c,r)},l.importBars=function(e,t,o,n,i){var c=s.project.sections.find(function(t){return t.name===e}).id,r=s.getSection(c);l._import(r,t,1,o,1,n*r.timeSignature.top,i)},l.exportSection=function(){if(l.section.name){var e=new Blob([s.serializeSection(s.section)],{type:"application/json;charset=utf-8"});saveAs(e,s.section.name+".json")}},e.importSectionFromFile=function(e){var t=JSON.parse(e.content);for(var o in t.tracks)if(!s.project.tracksMap[o]){console.log("NEW TRACK"),console.log(o.split("_"));var n=o.split("_")[0];s.addTrack({name:n[0].toUpperCase()+n.substr(1),type:n})}var i=s.loadSectionData(t);s.importSection(i),s.loadSection(i.id)}}e.$inject=["$scope","$timeout","$controller","$http","$window","$location","$mdToast","$mdDialog","projectManager","workspace","ReadOnlyStore","ProjectLocalStore","dataUrl"],angular.module("bd.app").controller("ProjectController",e).config(["$locationProvider",function(e){e.html5Mode({enabled:!0,requireBase:!1,rewriteLinks:!0})}])}();
...
!function(){"use strict";function e(e,o,t,n,a){console.log("-- UploadController --"),n.store&&(e.close=t.hide),e.showLogin=!1,e.form="upload",e.user={username:"",password:""},e.transformChip=function(e){console.log("transformChip")};var r=["Funk","Rock","Pop","Jazz","Soul","RnB","Disco","Blues","Punk","Ska","House","Reggae","Hip hop","Trance","Gospel","Country","Folk","Indie","Alternative","Metal","Techno","Rock and Roll"];e.difficulties=[{numeric:0,title:"Very Easy"},{numeric:1,title:"Easy"},{numeric:2,title:"Easy/Medium"},{numeric:2.5,title:"Medium"},{numeric:3,title:"Medium/Hard"},{numeric:4,title:"Hard"},{numeric:5,title:"Very Hard"}],e.querySearch=function(e){var o=e.toLowerCase();return r.filter(function(e){return e.toLowerCase().indexOf(o)!==-1})};var i=n.store._projectData();console.log(i);var l=new Set,c=new Set;i.sections.forEach(function(e){for(var o in e.tracks)if(n.project.tracksMap[o]){var t=o.split("_")[0];if(c.add(t),"bass"===t){var a=e.tracks[o];a.forEach(function(e){var o=e.data;o.forEach(function(e){l.add(e.sound?e.sound.style:e.style)})})}}});var s=[],u=["finger","slap","tap","pick"];l.forEach(function(e){u.indexOf(e)!==-1&&s.push(e.charAt(0).toUpperCase()+e.slice(1))}),e.project={title:n.project.name,category:"Cover",playing_styles:s,genres:[],tracks:Array.from(c),tags:[],data:LZString.compressToBase64(JSON.stringify(i)),level:3};var d=n.store.project.upload_id;e.newUpload=!Boolean(d),d&&(e.fetching=!0,o.get(a+"project/",{params:{id:d}}).then(function(o){delete o.data.playing_styles,console.log(o.data);for(var t in o.data)e.project[t]=o.data[t]},function(e){}).finally(function(){e.fetching=!1})),e.login=function(){e.loginFailed=!1,o.post(a+"login/",e.user,{withCredentials:!0}).then(e.upload,function(o){e.loginFailed=!0})},e.upload=function(){o.post(a+"project/",e.project,{withCredentials:!0}).then(function(o){console.log(o.data),n.store.project.upload_id=o.data,n.saveProjectConfig(),e.close()},function(o){401===o.status?(e.showLogin=!0,e.form="login"):403===o.status})}}e.$inject=["$scope","$http","$mdDialog","projectManager","catalogUrl"],angular.module("bd.app").controller("UploadController",e)}();
...
!function(){"use strict";function e(e,n,a,t,o,l){var c,r,i,s,u={playingStyles:[{name:"finger",label:"Finger"},{name:"slap",label:"Slap"},{name:"pop",label:"Pop"},{name:"pick",label:"Pick"},{name:"tap",label:"Tap"},{name:"hammer",label:"Hammer-On"},{name:"pull",label:"Pull-Off"},{name:"ring",label:"Let ring"}]};e.instructions=[function(){c={start:.5,string:"G",volume:.75,style:"finger",note:{type:"regular",name:"A",octave:2,code:"A2",fret:2,length:16}},e.workspace.trackSection.addSound(e.workspace.trackSection.beat(1,1),c)},function(){r=n[0].querySelector(".sound-container"),i=o.open({target:r},c,u,{clickOutsideToClose:!1,escapeToClose:!1,attachTo:n.parent(),panelClass:"non-interactive bass-form"})},function(){s=angular.element(document.querySelector(".bass-sound-form")).scope(),c.note.dotted=!0,s.soundLengthChanged(c)},function(){c.note.staccato=!0},function(){i&&(i.close(),i=null),t.clearSelection(),e.workspace.trackSection.clearBeat(e.workspace.trackSection.beat(1,1))}]}e.$inject=["$scope","$element","$timeout","basicHandler","bassSoundForm","$mdCompiler"],angular.module("bd.help").controller("SoundPropertiesSlideshow",e)}();
!function(){"use strict";function t(t,e){this.scaleNotes=[{label:["C"]},{label:["C♯","D♭"]},{label:["D"]},{label:["D♯","E♭"]},{label:["E"]},{label:["F"]},{label:["F♯","G♭"]},{label:["G"]},{label:["G♯","A♭"]},{label:["A"]},{label:["A♯","B♭"]},{label:["B"]}],this._noteIndexMap={C:0,"C♯":1,"D♭":1,D:2,"D♯":3,"E♭":3,E:4,F:5,"F♯":6,"G♭":6,G:7,"G♯":8,"A♭":8,A:9,"A♯":10,"B♭":10,B:11};var n=this._noteIndexMap[e.substr(0,e.length-1)],a=parseInt(e.charAt(e.length-1)),s=this._noteIndexMap[t.substr(0,t.length-1)],i=parseInt(t.charAt(t.length-1)),o=[];this.map={};for(var l={};;){s>=12&&(s=0,i++);var r=angular.copy(this.scaleNotes[s]);if(r.octave=i,o.push(r),r.label.forEach(function(t){this.map["{0}{1}".format(t,i)]=r,l.hasOwnProperty(t)?l[t].push(i):l[t]=[i]},this),i===a&&s===n)break;s++}this.notesOctaves=l,this.list=o}function e(t){this.notes=i,this.setLayout(t.strings)}function n(e){this.preset=e.preset,this.range=e.range,this.notes=new t(this.range[0],this.range[1])}angular.module("bd.app").value("Bass",e).value("Notes",t).value("Piano",n);var a="C C♯ D D♯ E F F♯ G G♯ A A♯ B".split(" "),s="C D♭ D E♭ E F G♭ G A♭ A B♭ B".split(" ");t.sharpNotes=a,t.flatNotes=s,t.toSharp=function(t){var e=s.indexOf(t);return e!==-1?a[e]:t},t.toFlat=function(t){var e=a.indexOf(t);return e!==-1?s[e]:t},t.codeTovalue=function(e){var n=e.substring(0,e.length-1),a=parseInt(e.charAt(e.length-1)),s=n.endsWith("♯")?t.sharpNotes:t.flatNotes,i=s.indexOf(n);return i+12*a},t.noteValue=function(e){var n=e.name.endsWith("♯")?t.sharpNotes:t.flatNotes,a=n.indexOf(e.name);return a+12*e.octave};var i=new t("B0","C5"),o=[{label:"B",octave:0,index:0,noteIndex:i.list.indexOf(i.map.B0)},{label:"E",octave:1,index:1,noteIndex:i.list.indexOf(i.map.E1)},{label:"A",octave:1,index:2,noteIndex:i.list.indexOf(i.map.A1)},{label:"D",octave:2,index:3,noteIndex:i.list.indexOf(i.map.D2)},{label:"G",octave:2,index:4,noteIndex:i.list.indexOf(i.map.G2)},{label:"C",octave:3,index:5,noteIndex:i.list.indexOf(i.map.C3)}];o.forEach(function(t){t.toJSON=function(){return this.label}}),e.prototype.setLayout=function(t){console.log("setLayout"),this.layout=t;var e="BEADGC".indexOf(this.layout[0]);this.strings=o.slice(e,e+this.layout.length),this.strings.forEach(function(t){t.notes||(t.notes=i.list.slice(t.noteIndex,t.noteIndex+25)),this.strings[t.label]=t},this)},e.prototype.stringFret=function(t,e){var n=e.name+e.octave,a=i.list.indexOf(i.map[n]),s=a-this.strings[t].noteIndex;return s>=0&&s<=24?s:-1},e.prototype.stringByName=function(t){return this.strings.find(function(e){return e.label===t})},n.prototype.stringIndex=function(t){if(t){var e=t.name+t.octave;return this.notes.list.indexOf(this.notes.map[e])}},n.prototype.setRange=function(e,n){this.range[0]=e,this.range[1]=n,this.notes=new t(this.range[0],this.range[1])}}();
...
!function(){"use strict";function e(e,t,n){e.contextMenu={show:angular.noop,element:null,beat:null},e.contextMenu.open=function(n,o){console.log("openBeatMenu"),e.contextMenu.element||(e.contextMenu.element=document.querySelector(".beat-menu")),e.contextMenu.beat=e.slides[o].beat,console.log(e.contextMenu);var c=n.target.getBoundingClientRect();e.contextMenu.element.style.position="fixed",e.contextMenu.element.style.left=c.left+"px",e.contextMenu.element.style.top=c.top+"px",e.contextMenu.element.style.width=c.width+"px",e.contextMenu.element.style.height=c.height+"px";var a=e.contextMenu.element.getElementsByTagName("offset")[0];a.style.left=n.clientX-c.left+"px",a.style.top=n.clientY-c.top+"px",t(function(){e.contextMenu.element.children[0].click()})},n.clipboard=[],e.copyBar=function(){var t=e.contextMenu.beat.bar;console.log("Copy bar: "+t),n.clipboard.splice(0,n.clipboard.length);for(var o=1;o<=n.section.timeSignature.top;o++){var c=n.trackSection.beat(t,o);n.clipboard.push(n.trackSection.rawBeatData(c))}n.clipboard=angular.copy(n.clipboard),n.clipboard.type=n.trackSection.type},e.pasteBar=function(){if(n.clipboard.type===n.trackSection.type){var t=e.contextMenu.beat.bar;n.clipboard.forEach(function(e){e.bar=t;var o=n.trackSection.beat(t,e.beat);n.trackSection.clearBeat(o)}),n.trackSection.loadBeats(n.clipboard)}},e.clearBar=function(){for(var t=e.contextMenu.beat.bar,o=1;o<=n.section.timeSignature.top;o++){var c=n.trackSection.beat(t,o);n.trackSection.clearBeat(c)}}}e.$inject=["$scope","$timeout","workspace"],angular.module("bd.app").controller("BarController",e)}();
!function(){"use strict";function e(e,n,t,o,i){e.selectSound=n.selectSound.bind(n),e.keyPressed=n.keyPressed.bind(n),e.dragHandler=t,e.resizeHandler=o,e.bassForm=i}function n(e,n,t,o,i,s,r,a,d){e.Note=t,e.keyPressed=function(e){a.keyPressed(e),46===e.keyCode&&d.close()},e.soundStyleChanged=a.soundStyleChanged.bind(a),e.nextNote=function(n){var t=-1;n.code&&(t=this.inlineStringNotes.findIndex(function(e){return e.code===n.code}));var o=this.inlineStringNotes[t+1];o&&(n.code=o.code,e.soundPitchChanged(n))},e.prevNote=function(e){var n=(e.code||this.inlineStringNotes[0].code,this.inlineStringNotes.findIndex(function(n){return e.code===n.code}));if(n>0){var t=this.inlineStringNotes[n-1];e.code=t.code,this.soundPitchChanged(e)}},e.soundPitchChanged=function(e){var n=this.inlineStringNotes.find(function(n){return e.code===n.code});angular.extend(e,n);for(var t=this.sound.next;t&&(t=t.ref,"hammer"!==t.style&&"pull"!==t.style);){var o=t.prev.ref,i="slide"===o.note.type?o.note.slide.endNote:o.note;t.note.name=i.name,t.note.octave=i.octave,t.note.code=i.code,t.note.fret=i.fret,t=t.next}},e.soundLengthChanged=function(e){e.end=e.start+workspace.track.soundDuration(e)},e.updateSlide=function(){var e=this.sound.note.fret+this.sound.note.slide;e<0?this.sound.note.slide+=-e:e>24&&(this.sound.note.slide-=e-24),this.slideEndNote=this.stringNotes[this.sound.note.fret+this.sound.note.slide]},e.playSound=function(){for(var e=this.sound;e.prev;)e=workspace.track.prevSound(e);r.playBassSample(workspace.trackSection,e)},e.updateLineEditor=function(){n(function(){var e=d.panelEl[0].querySelector(".line-editor svg"),n=d.panelEl[0].querySelectorAll(".line-editor .rzslider"),t=n[0],o=n[n.length-1],i=t.offsetLeft,s=o.offsetLeft-i;e.style.left=i+8,e.style.width=s})},o.note&&"bend"===o.note.type&&e.updateLineEditor();var l=[],c=[];i.notes.forEach(function(e,n){var t=e.label.map(function(t){return{code:t+e.octave,name:t,octave:e.octave,fret:n}});Array.prototype.push.apply(c,t),l.push(t)}),e.fretsStringNotes=l,e.inlineStringNotes=c,e.sound=o,e.bass=s}function t(e,n,t,o){var i,s,r=function(e){i.close();var n=document.elementFromPoint(e.clientX,e.clientY);if(n.className.indexOf("md-panel-outer-wrapper")!==-1){var t=n;t.style.pointerEvents="none",n=document.elementFromPoint(e.clientX,e.clientY),t.style.pointerEvents="auto"}var o=angular.element(n).scope();return o.sound&&o.sound.note&&a.open({target:n},o.sound,o.bass),!1},a={openNew:function(n,i,s){var r=t.createSound(n,i);e.nextTick(function(){this.open({target:o.getSoundElem(r)},r,s)}.bind(this))},open:function(e,o,a,d){s&&window.oncontextmenu===r||(s=window.oncontextmenu),t.selectSound(e,o);var l=n.newPanelPosition().relativeTo(e.target).addPanelPosition(n.xPosition.ALIGN_START,n.yPosition.BELOW).addPanelPosition(n.xPosition.ALIGN_END,n.yPosition.BELOW).addPanelPosition(n.xPosition.ALIGN_START,n.yPosition.ABOVE).addPanelPosition(n.xPosition.ALIGN_END,n.yPosition.ABOVE).withOffsetY("4px"),c=n.newPanelAnimation().withAnimation(n.animation.FADE),u={clickOutsideToClose:!0,escapeToClose:!0,zIndex:250};return d&&(u=angular.extend(u,d)),o.note&&(o.note.code=o.note.name+o.note.octave),i=n.create(angular.extend(u,{templateUrl:"views/editor/bass_sound_form.html",targetEvent:e,position:l,animation:c,controller:"BassFormController",locals:{sound:o,string:workspace.track.instrument.strings[o.string],bass:a},onRemoving:function(){delete o.note.code,window.oncontextmenu=s},onOpenComplete:function(){window.oncontextmenu=r}})),i.open(),i}};return a}e.$inject=["$scope","basicHandler","bassDragHandler","bassResizeHandler","bassSoundForm"],n.$inject=["$scope","$timeout","Note","sound","string","bass","audioPlayer","basicHandler","mdPanelRef"],t.$inject=["$mdUtil","$mdPanel","basicHandler","swiperControl"],angular.module("bd.app").controller("BassBeatController",e).controller("BassFormController",n).factory("bassSoundForm",t).run(["workspace","basicHandler",function(e,n){e.selected=n.selected}])}();
!function(){"use strict";function e(e,t){function o(t,n){for(var r=t.target;!r.classList.contains("drums-beat");)r=r.parentElement;var o=r.getBoundingClientRect(),a=t.clientX-o.left,l=t.clientY-o.top,u=1+parseInt(a*n.subdivision/o.width),d=parseInt(l/48),i=e.track.instrument[d].name;return{subbeat:u,start:(u-1)/n.subdivision,drum:i,drumIndex:d,containerElem:r}}var a;document.body.appendChild(n.elem),document.body.appendChild(r.elem);var l=angular.element(document.body).scope();l.$on("ANGULAR_DRAG_START",function(e,t,o,l){"drum"===o&&(a=l.data,n.elem.lastChild.style.transform="scale({0}, {0})".format(a.volume),t.dataTransfer.setDragImage(n.elem,10,12),t.ctrlKey||setTimeout(function(){t.target.classList.add("drag-move-element")},80),r.elem.style.opacity=1)}),l.$on("ANGULAR_DRAG_END",function(e,t,n,o){"drum"===n&&(t.target&&t.target.classList.remove("drag-move-element"),r.elem.style.opacity=0)});var u=[0,.85,.4];return{click:function(t,n){var r=o(t,n),a=e.trackSection.sound(n,{start:r.start,drum:r.drum});if(a){var l=u.indexOf(a.volume),d=(l+1)%u.length;a.volume=u[d],a.volume<.05&&(console.log("REMOVE sound"),e.trackSection.deleteSound(a))}else console.log("ADD sound"),a={start:r.start,drum:r.drum,volume:.85},e.trackSection.addSound(n,a)},volumeScroll:function(t,n,r){var o=angular.element(t.target).scope().sound;o&&(o.volume+=r,o.volume<.05?e.trackSection.deleteSound(o):o.volume>1&&(o.volume=1))},onDragOver:function(e,t){var n=o(e,t),a=n.containerElem.getBoundingClientRect(),l=a.width/t.subdivision,u=l/2-17;r.setPxStyles({left:a.left+(n.subbeat-1)*l+u,top:a.top+48*n.drumIndex+7})},onDragEnter:function(e,t){},onDragLeave:function(e,t){},onDrop:function(n,r){var l=o(n,r),u=e.trackSection.sound(r,{start:l.start,drum:l.drum});if(u){if(u===a)return;u.volume=a.volume}else u={volume:a.volume,start:l.start,drum:l.drum},e.trackSection.addSound(r,u);"move"===n.dataTransfer.dropEffect&&t.nextTick(e.trackSection.deleteSound.bind(e.trackSection,a))}}}function t(e,t){e.editor=t}e.$inject=["workspace","$mdUtil"],t.$inject=["$scope","drumHandler"],angular.module("bd.app").factory("drumHandler",e).controller("DrumController",t);var n={elem:angular.element('<div class="drum drag-box"><div class="volume-meter"></div></div>')[0]},r={elem:angular.element('<div class="drum drop-box"></div>')[0],setPxStyles:function(e){for(var t in e)this.elem.style[t]=e[t]+"px"}}}();
...
!function(){"use strict";function e(e,t,a,n,r){function o(){e.section.meta.chords.sort(function(e,t){var a=1e3*e.start[0]+10*e.start[1]+e.start[2],n=1e3*t.start[0]+10*t.start[1]+t.start[2];return a-n})}function i(){e.section.meta.chords.length&&e.selectChord(e.section.meta.chords[0])}function s(t){t.meta||(t.meta={chords:[]}),e.section=t,e.form={chord:null,root:""},i()}e.track=t.track,e.close=function(){o(),a.close(),n.un("sectionLoaded",s)},e.selectChord=function(t){t.string||(t.string="E"),e.form.chord=t,e.form.root=t.root},e.updatePosition=function(){r(),o()},e.updateChord=function(){var t=e.form.chord;if(e.form.root){var a=e.form.root.replace("#","♯").replace("b","♭");t.root=a;var n=parseInt(a[a.length-1]);if(Number.isInteger(n))t.root=a.substring(0,a.length-1),t.octave=n;else if(!Number.isInteger(t.octave)){var o=e.track.instrument.strings[e.form.chord.string],i=o.notes.find(function(e){return e.label[0]===a||e.label[1]===a});i&&(t.octave=i.octave)}e.form.root=t.root}r()},e.newChord=function(){var t={start:[1,1,1]};e.section.meta.chords.push(t),e.selectChord(t)},e.keyPressed=function(t){if(46===t.keyCode){var a=e.section.meta.chords.indexOf(e.form.chord);a!==-1&&(e.form.chord=null,e.section.meta.chords.splice(a,1),i(),r())}},s(t.section),n.on("sectionLoaded",s)}function t(e,t,a,n,r,o,i,s,l,c,p,d,u,y,g,f,b){function m(){var e=g.lastSlide-g.firstSlide+1;if(e>I.beatsPerView)return!0}function k(t){if(!e.player.visibleBeatsOnly){var n=t.flatIndex-g.firstSlide,r=t.startTime-t.eventTime;t.flatIndex<g.barSwiper.snapIndex&&(n=g.lastSlide+n+1);var o=n-g.barSwiper.snapIndex;o>=I.slideOnBeat&&setTimeout(function(){e.player.playing&&g.slideTo(g.barSwiper.snapIndex+o,I.animationDuration,!0)},parseInt(1e3*r))}if(!l.enabled&&e.player.graphEnabled){var s=e.player.input.muted?i.track.audio:e.player.input.audio;console.log("activating track visualization"),l.activate(s)}l.enabled&&!e.player.graphEnabled&&l.deactivate(),l.enabled&&l.beatSync(t),L.beatSync(t),f.beatSync(t),a.nextTick(function(){e.player.progress.value=t.flatIndex-g.firstSlide+1})}function h(){console.log("** updateLockedPlayerRange");var e=g.getPosition();return e.end.flatIndex>e.start.flatIndex&&(s.playbackRange=e,!0)}function v(){return e.player.playing&&e.player.loop?(g.loopMode||e.player.visibleBeatsOnly||!m()||(g.createLoop(),g.reset()),void s.play(i.section,k,v)):(g.loopMode&&g.destroyLoop(),e.player.playing=!1,l.deactivate(),L.stop(),setTimeout(f.clearDiagram.bind(f),1e3),void(g.preRenderedSlides=T))}function S(t){var a=(i.section.timeSignature,[]),n=i.section.beatLabels();t.forEachBeat(function(e){var t=e.bar+"_"+e.beat;a.push({id:t,beat:e,type:i.track.type,beatLabel:n[e.beat]})}),e.slides=a}function w(){a.nextTick(function(){g.setSlides(e.slides,{slidesPerView:I.beatsPerView,slidesPerGroup:1}),e.player.playbackRangeChanged()})}function P(){var e=g.barSwiper.wrapper[0];Array.from(e.querySelectorAll(".chord")).forEach(function(e){e.remove()}),i.section.meta&&i.section.meta.chords&&i.section.meta.chords.forEach(function(e){var t=e.start[0],a=e.start[1],n=e.start[2]||1,r=g.getBeatElem(t,a),o=angular.element('<span class="chord">{0}<span class="type">{1}</span></span>'.format(e.root,e.type))[0],s=parseInt(100/r.childElementCount);1===a&&1===n?(o.style.left="14px",o.style.width="calc({0}% - 28px)".format(s)):(o.style.left=(n-1)*s+"%",o.style.width=s+"%"),angular.element(o).on("click",function(t){f.setChord(i.section,i.track.id,e)}),angular.element(o).on("dblclick",function(t){x(e)}),r.parentNode.appendChild(o)})}function x(t){function a(e){L.beatSync(e),f.beatSync(e)}function n(){s.playbackRange=c,e.player.playing=!1,L.stop()}var r=i.section.meta.chords.indexOf(t),o=i.section.meta.chords[r+1],l=o?angular.copy(o.start):[i.section.length+1,1,1];l[2]--,0===l[2]&&(l[1]--,l[2]=4),0===l[1]&&(l[0]--,l[1]=i.section.timeSignature.top);var c=s.playbackRange;s.playbackRange={start:{bar:t.start[0],beat:t.start[1]},end:{bar:l[0],beat:l[1]}},e.player.playing=!0,s.setBpm(i.section.bpm),L.start(),s.fetchResourcesWithProgress(i.section).then(s.play.bind(s,i.section,a,n),function(){e.player.playing=!1})}function C(t){f.clearDiagram(),l.clear(),l.reinitialize(),console.log("sectionLoaded"),console.log(t),i.section=t,e.player.playbackRange.start=1,e.player.playbackRange.max=t.length+1,e.player.playbackRange.end=e.player.playbackRange.max,e.player.progress.value=0;var n=i.track&&t.tracks[i.track.id]?i.track.id:"bass_0";i.trackSection=t.tracks[n],i.trackSection||(i.trackSection=R(c.project.tracksMap[n])),i.track=i.trackSection,i.track.id=n,S(i.trackSection),a.nextTick(function(){g.setSlides(e.slides,{slidesPerView:I.beatsPerView,slidesPerGroup:1}),e.player.playbackRangeChanged(),a.nextTick(function(){P()})})}function R(e){var t="drums"===e.type?d:u,a=new t(i.section,[]);return a.instrument=e.instrument,a.audio=e.audio,a.type=e.type,i.section.tracks[e.id]=a,a}b.initialize(".instrument-grid"),s.setPlaybackSpeed(1),e.swiperControl=g,e.slides=[],e.editor||(console.log("Initializing editor"),e.$root.editor={beatsPerView:8,slideOnBeat:1,animationDuration:250,fretboardVisible:!0,layoutLegend:function(e){return[4,8,12].indexOf(e)!==-1?e:null},animationLabel:function(e,t,a){return"scroll after {0} beats".format(e)}},!i.section&&c.section&&C(c.section));var T=2;g.preRenderedSlides=T;var I=e.editor;e.updateBeatsPerView=function(){I.beatsPerView=g.setBeatsPerView(I.beatsPerView)},e.player.visiblePlaybackModeChanged=function(t){if(t){var a=h();if(!a)return e.player.visibleBeatsOnly=!1,void n.show(n.simple().toastClass("error player").textContent("Cannot lock playback on current possition!").position("top center"));g.barSwiper.on("transitionEnd",h)}else g.barSwiper.off("transitionEnd",h),e.player.loop&&g.destroyLoop(),e.player.playbackRangeChanged(),e.player.playing&&e.player.loop&&m()&&g.createLoop()},e.player.playbackRangeChanged=function(){console.log("playbackRangeChanged");var t=i.section.timeSignature.top,a=e.player.playbackRange.start,n=e.player.playbackRange.end-1;s.playbackRange={start:{bar:a,beat:1},end:{bar:n,beat:i.section.timeSignature.top}};var r=(a-1)*t,o=n*t-1;g.setVisibleRange(r,o),e.player.progress.max=o-r+1;for(var l=[],c=t;c<e.player.progress.max;c+=t)l.push(c);e.player.progress.ticks=l,e.player.progress.legend=function(e){return 1+e/t}},L=new y(g),e.ui.bpmChanged=function(e){e&&s.setBpm(i.section.bpm)},e.player.setProgress=function(t,a){e.player.playing&&(e.player.playing=!1,s.stop(!0),e.player.progress.restartPlayback=!0),g.barSwiper.slideTo(a,0,!0)},e.player.progressReleased=function(a,n){e.player.progress.restartPlayback&&(e.player.progress.restartPlayback=!1,t(e.player.play,75))};var L;e.player.play=function(){e.player.graphEnabled&&l.clear();var t=g.getPosition().start;g.barSwiper.activeIndex=g.barSwiper.snapIndex,e.player.visibleBeatsOnly?h():(g.preRenderedSlides=I.slideOnBeat,e.player.loop&&m()&&g.createLoop(),g.updateSlidesVisibility()),e.player.playing=!0,s.setBpm(i.section.bpm),L.start(),g.lastRequestedIndex=g.barSwiper.snapIndex;var a={countdown:e.player.countdown,start:t};c.project.backingTrack&&(a.backingTrack={audio:c.project.backingTrack,start:i.section.backingTrackStart}),s.fetchResourcesWithProgress(i.section).then(s.play.bind(s,i.section,k,v,a),function(){e.player.playing=!1})},e.player.pause=function(){e.player.playing=!1,s.stop(!0)},e.player.goToStart=function(){var t=e.player.playing;e.player.playing&&e.player.pause(),e.player.progress.value=0,setTimeout(function(){g.reset(0),t&&e.player.play()},50)},e.playDrumSound=function(e){var t={drum:e,volume:.85};s.playDrumSample(i.track,t)},e.playPianoSound=function(e){var t={note:{name:e.label[0],octave:e.octave,length:.5},string:e.label[0]+e.octave,volume:.85};s.playPianoSample(i.track,t)},c.on("sectionLoaded",C),e.ui.selectTrack=function(e){console.log("selectTrack: "+e);var t=c.project.tracksMap[e];i.track!==t&&(i.track.type!==t.type&&(i.section.tracks[e]||R(t),i.trackSection=i.section.tracks[e],i.trackSection.track=t,g.switchInstrument(t.type)),console.log(i.track.id),console.log(t.id),i.track.id!==t.id&&(console.log("switch new track instrument"),i.section.tracks[e]||R(t),i.trackSection=i.section.tracks[e],i.trackSection.track=t,g.rebuildSlides()),i.track=t,i.track.id=e)},i.section&&C(i.section),e.updateSlides=function(){S(i.trackSection),e.player.playbackRange.max=i.section.length+1,e.player.playbackRange.end=e.player.playbackRange.max,w()},i.metadataEditor=function(){var e=r.newPanelPosition().absolute().centerHorizontally().bottom("7%"),t=r.newPanelAnimation().openFrom({top:window.innerHeight/2,left:window.innerWidth/2-400}).closeTo({top:window.innerHeight/2,left:window.innerWidth/2-400}).withAnimation(r.animation.SCALE);r.open({templateUrl:"views/editor/section_metadata.html",controller:"MetadataController",locals:{updateChordLabels:P},autoWrap:!1,hasBackdrop:!1,disableParentScroll:!1,clickOutsideToClose:!1,position:e,animation:t,panelClass:"metadata",onOpenComplete:function(e){var t=e[0].panelEl.parent();t.css("pointerEvents","none")}})},g.onTouchEnd=function(t){a.nextTick(function(){e.player.progress.value=t.snapIndex*I.beatsPerSlide})},e.$on("$destroy",function(){c.un("sectionLoaded",C)}),window.sw=g}e.$inject=["$scope","workspace","mdPanelRef","projectManager","updateChordLabels"],t.$inject=["$scope","$timeout","$mdUtil","$mdToast","$mdPanel","context","workspace","audioPlayer","audioVisualiser","projectManager","Drums","DrumTrackSection","TrackSection","HighlightTimeline","swiperControl","fretboardViewer","DragHandler"],angular.module("bd.app").controller("MetadataController",e).controller("EditModeController",t)}();
