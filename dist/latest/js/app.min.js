...
function BufferLoader(e,r,o){this.context=e,this.remoteServerUrl=r,this.localSoundsUrl=o,this.serverUrl=o||r,this.format="ogg",this.loadedResources={},this.loadingResources=[]}BufferLoader.prototype.loadResource=function(e,r,o){if(angular.isDefined(this.loadedResources[e]))return r&&r(this.loadedResources[e]),this.loadedResources[e];if(this.loadingResources.indexOf(e)===-1){var s=this,i=new XMLHttpRequest;i.open("GET",this.serverUrl+e+"."+this.format,!0),i.responseType="arraybuffer",i.onload=function(){s.context.decodeAudioData(i.response,function(o){var i=s.loadingResources.indexOf(e);return i!==-1&&s.loadingResources.splice(i,1),o?(s.loadedResources[e]=o,void(r&&r(o))):void alert("error decoding file data: "+e)},function(r){console.error("decodeAudioData error",r);var i=s.loadingResources.indexOf(e);i!==-1&&s.loadingResources.splice(i,1),o&&o(r)})},i.onerror=function(i){this.serverUrl!==this.remoteServerUrl&&(this.serverUrl=this.remoteServerUrl,this.loadResource(e,r,o));var t=s.loadingResources.indexOf(e);t!==-1&&s.loadingResources.splice(t,1)}.bind(this),i.send()}},BufferLoader.prototype.loadResources=function(e,r,o){e=e||[];for(var s=0,i=function(){s++,s===e.length&&r&&r()},t=0;t<e.length;++t)this.loadResource(e[t],i,o)};
