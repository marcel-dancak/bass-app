...
!function(){"use strict";angular.module("templates",[]),angular.module("bd.app",["templates","ngMaterial","ngSanitize","ang-drag-drop","angularResizable"])}();
function BufferLoader(e,o){this.context=e,this.serverUrl=o,this.loadedResources={},this.loadingResources=[]}BufferLoader.prototype.loadResource=function(e,o){if(angular.isDefined(this.loadedResources[e]))return o&&o(this.loadedResources[e]),this.loadedResources[e];if(-1===this.loadingResources.indexOf(e)){var r=this,s=new XMLHttpRequest;s.open("GET",this.serverUrl+e+".ogg",!0),s.responseType="arraybuffer",s.onload=function(){r.context.decodeAudioData(s.response,function(s){var n=r.loadingResources.indexOf(e);return-1!==n&&r.loadingResources.splice(n,1),s?(r.loadedResources[e]=s,void(o&&o(s))):void alert("error decoding file data: "+e)},function(o){console.error("decodeAudioData error",o);var s=r.loadingResources.indexOf(e);-1!==s&&r.loadingResources.splice(s,1)})},s.onerror=function(){alert("BufferLoader: XHR error");var o=r.loadingResources.indexOf(e);-1!==o&&r.loadingResources.splice(o,1)},s.send()}},BufferLoader.prototype.loadResources=function(e,o){for(var r=0,s=function(){r++,r===e.length&&o&&o()},n=0;n<e.length;++n)this.loadResource(e[n],s)};
!function(){"use strict";function e(e,n,a,t,s,o,r){function l(){var n,a=[];for(n=0;n<f.timeSignature.top;n++)for(v=0;4>v;v++){var t=new Array(e.bass.strings);e.bass.strings.forEach(function(e){t[e.index]={string:e,beat:n,subbeat:v,note:{style:"finger",length:1/8,volume:.75},width:1}}),a.push(t)}return a}function i(){var n,a=e.bass.presents.map(function(e){return"bass.present."+e.name});for(n=0;n<localStorage.length;n++){var t=localStorage.key(n);if(t.startsWith("bass.present.")&&-1===a.indexOf(t)){console.log("delete: "+t),localStorage.removeItem(t);break}}}function p(){var n,a=[];for(n=0;n<localStorage.length;n++){var t=localStorage.key(n);if(t.startsWith("bass.present.")){var s=JSON.parse(localStorage.getItem(t));a.push(s)}}a?(e.bass.presents=a,e.loadBassPresent(a[0])):(e.bass.present={name:""},e.bass.presents=[e.bass.present])}var b;setTimeout(function(){b=t.createAnalyser(),b.fftSize=1024,b.connect(t.destination),s.initialize(b),o.initialize(document.getElementById("canvas"),b)},200),e.player={playing:!1,bpm:60};var u=new r("B0","G4");e.bass={notes:u,noteStringOctaves:function(e,n){var a=[];return u.list.slice(n.noteIndex,n.noteIndex+24).filter(function(n){-1!==n.label.indexOf(e)&&a.push(n.octave)}),a},stringFret:function(e,n){var a=n.name+n.octave,t=u.list.indexOf(u.map[a]),s=t-e.noteIndex;return s>=0&&24>=s?s:-1},strings:[{label:"E",octave:1,index:0,noteIndex:u.list.indexOf(u.map.E1)},{label:"A",octave:1,index:1,noteIndex:u.list.indexOf(u.map.A1)},{label:"D",octave:2,index:2,noteIndex:u.list.indexOf(u.map.D2)},{label:"G",octave:2,index:3,noteIndex:u.list.indexOf(u.map.G2)}].reverse(),playingStyles:{finger:{name:"finger",label:"Finger",noteLabel:function(e){return e.note.name?"{0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},slap:{name:"slap",label:"Slap",noteLabel:function(e){return e.note.name?"<sup>(Slap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},pop:{name:"pop",label:"Pop",noteLabel:function(e){return e.note.name?"<sup>(Pop)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},tap:{name:"tap",label:"Tap",noteLabel:function(e){return e.note.name?"<sup>(Tap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},hammer:{name:"hammer-on",label:"Hammer on",noteLabel:function(e){return e.note.name?'<span class="hammer-top">)</span>                <span class="hammer-bottom">h</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}},pull:{name:"pull-of",label:"Pull of",noteLabel:function(e){return e.note.name?'<span class="pull-top">p</span>                <span class="pull-bottom">)</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}}}},e.bass.presents=[],console.log(e.bass);for(var c={top:4,bottom:4},m=[{name:""},{name:"i"},{name:"and"},{name:"a"}],f={timeSignature:c,subbeats:[],nextSubbeat:function(e){return this.subbeats[e._index+1]},prevSubbeat:function(e){return this.subbeats[e._index-1]}},d=1;12>=d;d++){var g=angular.copy(m);g[0].name="{0}".format(d),g.forEach(function(e,n){e._index=(d-1)*g.length+n,e.beat=d,e.index=n+1,e.bar=f,e.width=1,e.note={volume:.75}}),f.subbeats=f.subbeats.concat(g)}var v={note:{style:"finger",name:"A",octave:2,length:1/8,staccato:!1,string:1}},y=l();angular.extend(y[0][1],{style:"finger",fret:3,note:{name:"C",octave:2,code:"C2"},noteLength:{length:1/8},volume:.75}),angular.extend(y[2][1],{style:"finger",fret:5,note:{name:"D",octave:2,code:"D2"},noteLength:{length:1/8},volume:.75}),e.bassData=y,e.bar=f,e.$watch("player.bpm",function(n){s.playing&&(s.stop(),s.setBpm(e.player.bpm),s.play({timeSignature:c,notes:e.bassData},o.beatSync.bind(o)))}),e.play=function(){e.player.playing=!0,o.reset(),s.setBpm(e.player.bpm),s.play({timeSignature:c,notes:e.bassData},o.beatSync.bind(o))},e.stop=function(){e.player.playing=!1,s.stop()},e.playBassNote=function(e){s.playSound({style:"finger",note:{name:e.label[0],octave:e.octave,code:e.label[0]+e.octave},noteLength:{length:.25},volume:.75})},e.newBar=function(){e.bass.present={name:"New",data:l()},e.bass.presents.push(e.bass.present),e.bassData=e.bass.present.data},e.deleteBar=function(n){var a=e.bass.presents.indexOf(n);e.bass.presents.splice(a,1),i(),e.bass.presents?e.loadBassPresent(e.bass.presents[0]):(e.bass.present={name:""},e.bass.presents=[e.bass.present])},e.saveBar=function(){i();var n="bass.present."+e.bass.present.name;e.bass.present.data=e.bassData,console.log(e.bass.present);var a=e.bass.present,t={name:a.name,data:a.data};console.log(t),localStorage.setItem(n,JSON.stringify(t))},e.loadBassPresent=function(n){n&&n!==e.bass.present&&(console.log("Load: "+n.name),e.bassData=n.data,e.bass.present=n)},p()}e.$inject=["$scope","$timeout","$mdDialog","context","audioPlayer","audioVisualiser","NotesModel"],angular.module("bd.app").controller("AppController",e).value("context",new AudioContext)}();
!function(){"use strict";function t(){function t(){}function i(){var t=this.visualiser.analyser.context.currentTime;t<this.beat.endTime&&(this.visualiser.draw(),requestAnimationFrame(i.bind({visualiser:this.visualiser,beat:this.beat})))}return t.prototype.initialize=function(t,i){this.x=0,this.y=0,this.width=canvas.offsetWidth,this.height=canvas.offsetHeight,canvas.setAttribute("width",this.width),canvas.setAttribute("height",this.height),this.ctx=canvas.getContext("2d"),this.ctx.fillStyle="rgb(240, 240, 240)",this.ctx.lineWidth=1,this.ctx.strokeStyle="rgb(180, 0, 0)",this.dataArray=new Uint8Array(i.frequencyBinCount),this.analyser=i},t.prototype.reset=function(){this.ctx.clearRect(0,0,this.width,this.height),this.x=0,this.ctx.moveTo(0,this.y)},t.prototype.beatSync=function(t,e){1===e&&this.reset();var s=60/t,a=this.analyser.context.currentTime,e={index:e,bpm:t,startTime:a,endTime:a+s};this.beat=e,requestAnimationFrame(i.bind({visualiser:this,beat:e}))},t.prototype.draw=function(){var t=this.ctx;this.analyser.getByteTimeDomainData(this.dataArray),t.beginPath(),t.moveTo(this.x,this.y);for(var i=this.analyser.context.currentTime,e=(i-this.beat.startTime)/(this.beat.endTime-this.beat.startTime),s=Math.round(this.width/4),a=Math.round(s*(this.beat.index-1)),h=Math.round(a+e*s),n=h-this.x,r=0;n>r;r+=1){var o=parseInt((r+1)*this.analyser.frequencyBinCount/n),c=this.dataArray[o-1]/128;this.y=c*this.height/2,0===r||t.lineTo(this.x+1,this.y),this.x+=1}t.stroke()},new t}angular.module("bd.app").factory("audioVisualiser",t)}();
!function(){"use strict";function e(e,t,n,o,a){console.log("NOTE CONTROLLER"),console.log(e),console.log(t[0]),e.selected={subbeat:null},e.bass.strings.forEach(function(t){t.notes=e.bass.notes.list.slice(t.noteIndex,t.noteIndex+25);var n=[];t.notes.forEach(function(e,t){e.label.forEach(function(o){n.push({fret:t,label:o,octave:e.octave})})}),t.stringNoteLabel=n});var l=[];e.bass.notes.scaleNotes.forEach(function(e){l.push.apply(l,e.label)}),e.notesLabels=l,e.dropNote={width:0},e.menu={element:null,open:angular.noop,subbeat:null,maxWidth:window.innerWidth,searchText:"",nextNote:function(){if(e.menu.subbeat.fret=e.menu.subbeat.fret||0,e.menu.subbeat.fret<24){var t=e.menu.subbeat.string.notes[e.menu.subbeat.fret];if(2===t.label.length&&e.menu.subbeat.note.code===t.label[0]+t.octave)e.menu.subbeat.note={code:t.label[1]+t.octave,name:t.label[1],octave:t.octave};else{e.menu.subbeat.fret++;var n=e.menu.subbeat.string.notes[e.menu.subbeat.fret];e.menu.subbeat.note={code:n.label[0]+n.octave,name:n.label[0],octave:n.octave}}}},prevNote:function(){if(e.menu.subbeat.fret=e.menu.subbeat.fret||0,e.menu.subbeat.fret>0){var t=e.menu.subbeat.string.notes[e.menu.subbeat.fret];if(2===t.label.length&&e.menu.subbeat.note.code===t.label[1]+t.octave)e.menu.subbeat.note={code:t.label[0]+t.octave,name:t.label[0],octave:t.octave};else{e.menu.subbeat.fret--;var n=e.menu.subbeat.string.notes[e.menu.subbeat.fret];e.menu.subbeat.note={code:n.label[n.label.length-1]+n.octave,name:n.label[n.label.length-1],octave:n.octave}}}}},n(function(){e.menu.element=angular.element(document.getElementById("subbeat-menu"))},300);var r,s;e.playingStyles=["finger","slap","pop","tap","hammer","pull"],e.clearNote=function(t){if(t.note={},t.width>1)for(var n=t.width-1,t=t;n--;)t=t.bar.nextSubbeat(t),t.width=1;t.width=1,e.updateNote(t),e.selected.subbeat=null},e.updateNoteLength=function(e){};var u,i,b={};e.onResizeStart=function(t,n){var o=t.noteLength.dotted?1.5*t.noteLength.length:t.noteLength.length,a=(n.width+2)/o,l=[{length:1,dotted:!1},{length:1,dotted:!0},{length:.5,dotted:!1},{length:.5,dotted:!0},{length:.25,dotted:!1},{length:.25,dotted:!0},{length:1/8,dotted:!1},{length:1/8,dotted:!0},{length:1/16,dotted:!1}];b={},u=l.map(function(e){var t=e.dotted?1.5*e.length:e.length,n=t*a-2;return b[n]=e,n});var r=n.element.parent()[0];e.dropNote.visible=!0,e.dropNote.width=n.width,e.dropNote.left=r.offsetParent.offsetLeft,e.dropNote.top=r.offsetTop,e.$apply()},e.onResizeEnd=function(t,n){n.element.css("width",""),angular.extend(t.noteLength,b[i]),e.dropNote.visible=!1,e.$apply()},e.onResize=function(t,n){var o,a=u[0];u.forEach(function(e){o=Math.abs(n.width-e),a>o&&(i=e,a=o)}),e.dropNote.width=i,e.$apply()},e.onDrop=function(t,n,o,l){angular.isDefined(n.beat)&&"move"===t.dataTransfer.dropEffect&&(console.log("MOVE"),e.clearNote(l[4*n.beat+n.subbeat][n.string.index])),delete n.beat,delete n.subbeat,delete n.string,console.log(n),angular.extend(o,n),console.log("find fret of "+o.note.name+" od string "+o.string.index),o.fret=e.bass.stringFret(o.string,o.note),console.log(o.string),a.fetchSoundResources(o),e.selected.subbeat=o,e.dropNote.visible=!1},e.updateNote=function(t){"x"===t.note.name&&(t.noteLength.length=1/16),t.$form||(t.$form={});var n=e.bass.noteStringOctaves(t.note.name,t.string);t.$form.minOctave=n[0],t.$form.maxOctave=n[n.length-1],console.log(t.$form.minOctave)},e.onDragEnter=function(t,o){var a=t.target||t.originalTarget;"BUTTON"===a.tagName&&(a=a.parentElement),n(function(){e.dropNote.visible=!0,e.dropNote.left=a.offsetParent.offsetLeft,e.dropNote.top=a.offsetTop})},e.onDragLeave=function(t,n){e.dropNote.visible=!1},e.$root.$on("ANGULAR_DRAG_START",function(t,n,o,a){if(console.log("ANGULAR_DRAG_START"),r=a.data,"fretboard"===r.source){r.note.label.length>1&&n.clientX>n.target.offsetLeft+n.target.clientWidth/2?r.note.name=r.note.label[1]:r.note.name=r.note.label[0],r.note.code=r.note.name+r.note.octave,delete r.source;var l=angular.toJson(a);n.dataTransfer.setData("text",l),e.dropNote.width=n.target.clientWidth*(25/16)}else e.dropNote.width=n.target.clientWidth;r.noteLength&&(n.ctrlKey||(s=angular.element(n.target),setTimeout(function(){s.addClass("drag-element")},100)),e.$apply())}),e.$on("ANGULAR_DRAG_END",function(t,n,o,a){s&&(s.removeClass("drag-element"),s=null),e.dropNote.visible=!1}),e.dropValidation=function(t,n){if(t.note.name&&t.noteLength)return!1;if("x"===n.note.name)return!0;var o=e.bass.stringFret(t.string,n.note);return-1!==o},e.setSubbeatMenu=function(t){console.log("setSubbeatMenu"),e.menu.subbeat=t},e.openSubbeatMenu=function(t,a){console.log(e.menu.element);var l=t.target.getBoundingClientRect();e.menu.element.css("left",l.left+"px"),e.menu.element.css("top",32+l.top+"px"),e.updateNote(a),o.hide().then(function(){e.menu.subbeat=a,n(function(){e.menu.open(t)})})},e.nextNoteLabel=function(t){console.log(t.note.name);var n=e.notesLabels.indexOf(t.note.name)+1;n%=e.notesLabels.length,t.note.name=e.notesLabels[n]},e.noteQuerySearch=function(e,t){if(!t)return e;var n=t.replace("#","♯");return n=n.toUpperCase(),console.log(n),e.filter(function(e){return console.log(e.label.join("")+": "+e.label.join("").indexOf(n)),-1!==e.label.join("").indexOf(n)})},e.playSound=function(e){a.playSound(e)}}e.$inject=["$scope","$element","$timeout","$mdMenu","audioPlayer"],angular.module("bd.app").controller("NoteController",e)}();
