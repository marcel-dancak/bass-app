...
!function(){"use strict";angular.module("templates",[]),angular.module("bd.app",["templates","ngMaterial","ngSanitize","ang-drag-drop","angularResizable","monospaced.mousewheel","ksSwiper"])}();
...
!function(){"use strict";function e(e,n,a,t,o,s,i){function l(){var n,a,t=[];for(n=0;12>n;n++)for(a=0;4>a;a++){var o=new Array(e.bass.strings);e.bass.strings.forEach(function(e){o[e.index]={string:e,beat:n,subbeat:a,note:{style:"finger",length:1/8,volume:.75},width:1}}),t.push(o)}return{bassData:t,nextSubbeat:function(e){return this.bassData[e._index+1]},prevSubbeat:function(e){return this.bassData[e._index-1]}}}function r(){var n=t.currentTime-o.startTime,a=60/e.player.bpm,s=a*bar.timeSignature.top,i=parseInt(n/s)*s,l=(n-i)/s;e.player.playing?(v.style.left=100*l+"%",requestAnimationFrame(r)):(v.style.left=0,v.style.visibility="hidden")}var u;setTimeout(function(){u=t.createAnalyser(),u.fftSize=1024,u.connect(t.destination),o.bass.audio.connect(u),o.drums.audio.connect(t.destination),s.initialize(document.getElementById("canvas"),u)},200),e.player={playing:!1,bpm:60,bass:o.bass,drums:o.drums};var m=new i("B0","G4");e.bass={notes:m,noteStringOctaves:function(e,n){var a=[];return m.list.slice(n.noteIndex,n.noteIndex+24).filter(function(n){-1!==n.label.indexOf(e)&&a.push(n.octave)}),a},stringFret:function(e,n){var a=n.name+n.octave,t=m.list.indexOf(m.map[a]),o=t-e.noteIndex;return o>=0&&24>=o?o:-1},strings:[{label:"E",octave:1,index:0,noteIndex:m.list.indexOf(m.map.E1)},{label:"A",octave:1,index:1,noteIndex:m.list.indexOf(m.map.A1)},{label:"D",octave:2,index:2,noteIndex:m.list.indexOf(m.map.D2)},{label:"G",octave:2,index:3,noteIndex:m.list.indexOf(m.map.G2)}].reverse(),playingStyles:{finger:{name:"finger",label:"Finger",noteLabel:function(e){return e.note.name?"{0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},slap:{name:"slap",label:"Slap",noteLabel:function(e){return e.note.name?"<sup>(Slap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},pop:{name:"pop",label:"Pop",noteLabel:function(e){return e.note.name?"<sup>(Pop)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},tap:{name:"tap",label:"Tap",noteLabel:function(e){return e.note.name?"<sup>(Tap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},hammer:{name:"hammer-on",label:"Hammer on",noteLabel:function(e){return e.note.name?'<span class="hammer-top">)</span>                <span class="hammer-bottom">h</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}},pull:{name:"pull-of",label:"Pull of",noteLabel:function(e){return e.note.name?'<span class="pull-top">p</span>                <span class="pull-bottom">)</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}}}},e.bass.presents=[],console.log(e.bass);for(var p={top:3,bottom:4},b=[{name:""},{name:"i"},{name:"and"},{name:"a"}],c={timeSignature:p,subbeats:[]},d=1;12>=d;d++){var f=angular.copy(b);f[0].name="{0}".format(d),f.forEach(function(e,n){e.beat=d,e.index=n+1}),c.subbeats=c.subbeats.concat(f)}e.barLabels=c;l();e.drumsData=[],e.barsBlock={timeSignature:p,bars:[l(),l(),l(),l()]},e.$watch("player.bpm",function(n){o.playing&&(o.stop(),o.setBpm(e.player.bpm),o.play({timeSignature:p,bass:e.bassData,drums:e.drumsData},s.beatSync.bind(s)))});var v=document.getElementById("time-marker");v.style.visibility="hidden",e.play=function(){e.player.playing=!0,s.reset(),o.setBpm(e.player.bpm),s.enabled=!0,o.play({timeSignature:p,bass:e.barsBlock.bars[0].bassData,drums:e.drumsData},s.beatSync.bind(s)),v.style.visibility="visible",r()},e.stop=function(){e.player.playing=!1,o.stop(),s.enabled=!1},e.toggleVolumeMute=function(e){e.muted?e.audio.gain.value=e._volume:(e._volume=e.audio.gain.value,e.audio.gain.value=0),e.muted=!e.muted},e.playBassSound=function(e){var n=angular.extend({style:"finger",noteLength:{length:.25},volume:.75},e);o.playSound(n)},e.onBarSwiper=function(n){console.log("Bar"),console.log(n),e.barSwiper=n},e.onBassSwiper=function(n){console.log("Bass"),console.log(n),e.barSwiper.params.control=n}}e.$inject=["$scope","$timeout","$mdDialog","context","audioPlayer","audioVisualiser","NotesModel"],angular.module("bd.app").controller("AppController",e).value("context",new AudioContext)}();
!function(){"use strict";function t(){function t(){}function i(){var t=this.visualiser.analyser.context.currentTime;this.visualiser.enabled&&t<this.beat.endTime&&(this.visualiser.draw(),requestAnimationFrame(i.bind({visualiser:this.visualiser,beat:this.beat})))}return t.prototype.initialize=function(t,i){this.x=0,this.y=0,this.width=canvas.offsetWidth,this.height=canvas.offsetHeight,canvas.setAttribute("width",this.width),canvas.setAttribute("height",this.height),this.ctx=canvas.getContext("2d"),this.ctx.fillStyle="rgb(240, 240, 240)",this.ctx.lineWidth=1,this.ctx.strokeStyle="rgb(180, 0, 0)",this.dataArray=new Uint8Array(i.frequencyBinCount),this.analyser=i,this.enabled=!0},t.prototype.reset=function(){this.ctx.clearRect(0,0,this.width,this.height),this.x=0,this.ctx.moveTo(0,this.y)},t.prototype.beatSync=function(t,e,s){1===e&&this.reset();var a=60/t,h=this.analyser.context.currentTime,e={index:e,bpm:t,startTime:h,endTime:h+a};this.beat=e,this.timeSignature=s,requestAnimationFrame(i.bind({visualiser:this,beat:e}))},t.prototype.draw=function(){var t=this.ctx;this.analyser.getByteTimeDomainData(this.dataArray),t.beginPath(),t.moveTo(this.x,this.y);for(var i=this.analyser.context.currentTime,e=(i-this.beat.startTime)/(this.beat.endTime-this.beat.startTime),s=Math.round(this.width/this.timeSignature.top),a=Math.round(s*(this.beat.index-1)),h=Math.round(a+e*s),n=h-this.x,r=0;n>r;r+=1){var o=parseInt((r+1)*this.analyser.frequencyBinCount/n),u=this.dataArray[o-1]/128;this.y=u*this.height/2,0===r||t.lineTo(this.x+1,this.y),this.x+=1}t.stroke()},new t}angular.module("bd.app").factory("audioVisualiser",t)}();
!function(){"use strict";function u(u,o,e){var a=[0,.85,.4];u.drums=[{label:"Tom 1",filename:"sounds/drums/acoustic-kit/tom1",duration:.41},{label:"Tom 2",filename:"sounds/drums/acoustic-kit/tom2",duration:.6},{label:"Tom 3",filename:"sounds/drums/acoustic-kit/tom3",duration:1},{label:"Hi-Hat",filename:"sounds/drums/acoustic-kit/hihat",duration:.25},{label:"Snare",filename:"sounds/drums/acoustic-kit/snare",duration:.36},{label:"Kick",filename:"sounds/drums/acoustic-kit/kick",duration:.27}];var n=u.drums.map(function(u){return u.filename});e.bufferLoader.loadResources(n);var r,t,l=u.drumsData;for(r=0;12>r;r++)for(t=0;4>t;t++){var i=new Array(u.bass.strings);u.drums.forEach(function(u,o){i[o]={beat:r,subbeat:t,drum:u,volume:0}}),l.push(i)}u.toggleDrum=function(u){var o=a.indexOf(u.volume),e=(o+1)%a.length;u.volume=a[e]},u.playSound=function(u){e.playSound(u)},u.volumeControl=function(u,o){u.volume+=o,u.volume<0?u.volume=0:u.volume>1&&(u.volume=1)},u.onDrop=function(u,o,e,a){if(e.volume=o.volume,angular.isDefined(o.beat)&&"move"===u.dataTransfer.dropEffect){var n=a[4*o.beat+o.subbeat].find(function(u){return u.drum.label===e.drum.label});n.volume=0}}}u.$inject=["$scope","$timeout","audioPlayer"],angular.module("bd.app").controller("DrumsController",u)}();
!function(){"use strict";function e(e,t,n,o,a){console.log("NOTE CONTROLLER"),console.log(e),console.log(t[0]),e.selected={subbeat:null},e.bass.strings.forEach(function(t){t.notes=e.bass.notes.list.slice(t.noteIndex,t.noteIndex+25);var n=[];t.notes.forEach(function(e,t){e.label.forEach(function(o){n.push({fret:t,label:o,octave:e.octave})})}),t.stringNoteLabel=n});var l=[];e.bass.notes.scaleNotes.forEach(function(e){l.push.apply(l,e.label)}),e.notesLabels=l,e.dropNote={width:0},e.menu={element:null,open:angular.noop,subbeat:null,maxWidth:window.innerWidth,searchText:"",nextNote:function(){if(e.menu.subbeat.fret=e.menu.subbeat.fret||0,e.menu.subbeat.fret<24){var t=e.menu.subbeat.string.notes[e.menu.subbeat.fret];if(2===t.label.length&&e.menu.subbeat.note.code===t.label[0]+t.octave)e.menu.subbeat.note={code:t.label[1]+t.octave,name:t.label[1],octave:t.octave};else{e.menu.subbeat.fret++;var n=e.menu.subbeat.string.notes[e.menu.subbeat.fret];e.menu.subbeat.note={code:n.label[0]+n.octave,name:n.label[0],octave:n.octave}}}},prevNote:function(){if(e.menu.subbeat.fret=e.menu.subbeat.fret||0,e.menu.subbeat.fret>0){var t=e.menu.subbeat.string.notes[e.menu.subbeat.fret];if(2===t.label.length&&e.menu.subbeat.note.code===t.label[1]+t.octave)e.menu.subbeat.note={code:t.label[0]+t.octave,name:t.label[0],octave:t.octave};else{e.menu.subbeat.fret--;var n=e.menu.subbeat.string.notes[e.menu.subbeat.fret];e.menu.subbeat.note={code:n.label[n.label.length-1]+n.octave,name:n.label[n.label.length-1],octave:n.octave}}}}},n(function(){e.menu.element=angular.element(document.getElementById("subbeat-menu"))},500);var s,u;e.playingStyles=["finger","slap","pop","tap","hammer","pull"],e.clearNote=function(t){t.note={},t.noteLength.length=1/16,e.updateBassSound(t),e.selected.subbeat=null};var r,i,b={};e.onResizeStart=function(t,n){var o=t.noteLength.dotted?1.5*t.noteLength.length:t.noteLength.length,a=(n.width+4)/o,l=[{length:1,dotted:!1},{length:1,dotted:!0},{length:.5,dotted:!1},{length:.5,dotted:!0},{length:.25,dotted:!1},{length:.25,dotted:!0},{length:1/8,dotted:!1},{length:1/8,dotted:!0},{length:1/16,dotted:!1}];b={},r=l.map(function(e){var t=e.dotted?1.5*e.length:e.length,n=t*a-2;return b[n]=e,n});var s=n.element.parent()[0];e.dropNote.visible=!0,e.dropNote.width=n.width,e.dropNote.left=s.offsetParent.offsetLeft,e.dropNote.top=s.offsetTop,e.$apply()},e.onResizeEnd=function(t,n){n.element.css("width",""),angular.extend(t.noteLength,b[i]),e.updateBassSound(t),e.dropNote.visible=!1,e.$apply()},e.onResize=function(t,n){var o,a=r[0];r.forEach(function(e){o=Math.abs(n.width-e),a>o&&(i=e,a=o)}),e.dropNote.width=i,e.$apply()},e.onDrop=function(t,n,o,l){angular.isDefined(n.beat)&&"move"===t.dataTransfer.dropEffect&&(console.log("MOVE"),e.clearNote(l[4*n.beat+n.subbeat][n.string.index])),delete n.beat,delete n.subbeat,delete n.string,console.log(n),angular.extend(o,n),console.log("find fret of "+o.note.name+" od string "+o.string.index),o.fret=e.bass.stringFret(o.string,o.note),e.updateBassSound(o),console.log(o.string),a.fetchSoundResources(o),e.selected.subbeat=o,e.dropNote.visible=!1},e.updateBassSound=function(t){"x"===t.note.name&&(t.noteLength.length=1/16);var n=t.noteLength.length;t.noteLength.dotted&&(n*=1.5),t.noteLength.staccato,t.hasOwnProperty("ui")||(t.ui={}),t.ui.width=100*(n*e.barsBlock.timeSignature.bottom*4)+"%",console.log(t.ui.width)},e.onDragEnter=function(t,o){var a=t.target||t.originalTarget;"BUTTON"===a.tagName&&(a=a.parentElement),n(function(){e.dropNote.visible=!0,e.dropNote.left=a.offsetParent.offsetLeft,e.dropNote.top=a.offsetTop})},e.onDragLeave=function(t,n){e.dropNote.visible=!1},e.$root.$on("ANGULAR_DRAG_START",function(t,n,o,a){if(console.log("ANGULAR_DRAG_START"),s=a.data,"fretboard"===s.source){s.note.label.length>1&&n.clientX>n.target.offsetLeft+n.target.clientWidth/2?s.note.name=s.note.label[1]:s.note.name=s.note.label[0],s.note.code=s.note.name+s.note.octave,delete s.source;var l=angular.toJson(a);n.dataTransfer.setData("text",l),e.dropNote.width=n.target.clientWidth*(25/16)}else e.dropNote.width=n.target.clientWidth;s.noteLength&&(n.ctrlKey||(u=angular.element(n.target),setTimeout(function(){u.addClass("drag-element")},100)),e.$apply())}),e.$on("ANGULAR_DRAG_END",function(t,n,o,a){u&&(u.removeClass("drag-element"),u=null),e.dropNote.visible=!1}),e.dropValidation=function(t,n){if(t.note.name&&t.noteLength)return!1;if("x"===n.note.name)return!0;var o=e.bass.stringFret(t.string,n.note);return-1!==o},e.setSubbeatMenu=function(t){console.log("setSubbeatMenu"),e.menu.subbeat=t},e.openSubbeatMenu=function(t,a){console.log(e.menu.element);var l=t.target.getBoundingClientRect();e.menu.element.css("left",l.left+"px"),e.menu.element.css("top",32+l.top+"px"),o.hide().then(function(){e.menu.subbeat=a,n(function(){e.menu.open(t)})})},e.nextNoteLabel=function(t){console.log(t.note.name);var n=e.notesLabels.indexOf(t.note.name)+1;n%=e.notesLabels.length,t.note.name=e.notesLabels[n]},e.playSound=function(e){a.playSound(e)}}e.$inject=["$scope","$element","$timeout","$mdMenu","audioPlayer"],angular.module("bd.app").controller("NoteController",e)}();
