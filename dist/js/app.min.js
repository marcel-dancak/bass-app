...
!function(){"use strict";angular.module("templates",[]),angular.module("bd.app",["templates","ngMaterial","ngSanitize"])}();
...
!function(){"use strict";function e(e,n){e.$on("ui.layout.toggle",function(e,t){var a=t.element.parent();a.addClass("ui-layout-animation"),n(function(){a.removeClass("ui-layout-animation")},600)})}function n(e,n,t,a,o,l,s){function i(){l.draw(),e.playing&&requestAnimationFrame(i)}var u=a.createAnalyser();u.connect(a.destination),o.initialize(u),u.fftSize=1024,n(function(){l.initialize(document.getElementById("canvas"),u)});var r=new s("B0","G4");e.bass={notes:r,strings:[{label:"E",octave:1,index:0,noteIndex:r.list.indexOf(r.map.E1)},{label:"A",octave:2,index:1,noteIndex:r.list.indexOf(r.map.A1)},{label:"D",octave:2,index:2,noteIndex:r.list.indexOf(r.map.D2)},{label:"G",octave:2,index:3,noteIndex:r.list.indexOf(r.map.G2)}].reverse(),playingStyles:{finger:{name:"finger",label:"Finger",noteLabel:function(e){return e.note.name?"{0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},slap:{name:"slap",label:"Slap",noteLabel:function(e){return e.note.name?"<sup>(Slap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},pop:{name:"pop",label:"Pop",noteLabel:function(e){return e.note.name?"<sup>(Pop)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},tap:{name:"tap",label:"Tap",noteLabel:function(e){return e.note.name?"<sup>(Tap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},hammer:{name:"hammer-on",label:"Hammer on",noteLabel:function(e){return e.note.name?'<span class="hammer-top">)</span>                <span class="hammer-bottom">h</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}},pull:{name:"pull-of",label:"Pull of",noteLabel:function(e){return e.note.name?'<span class="pull-top">p</span>                <span class="pull-bottom">)</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}}}},console.log(e.bass);for(var m={top:4,bottom:4},c=[{name:""},{name:"i"},{name:"and"},{name:"a"}],b={timeSignature:m,subbeats:[],nextSubbeat:function(e){return this.subbeats[e._index+1]},prevSubbeat:function(e){return this.subbeats[e._index-1]}},p=1;12>=p;p++){var d=angular.copy(c);d[0].name="{0}".format(p),d.forEach(function(e,n){e._index=(p-1)*d.length+n,e.beat=p,e.index=n+1,e.bar=b,e.width=1,e.note={volume:.75}}),b.subbeats=b.subbeats.concat(d)}angular.extend(b.subbeats[0],{note:{volume:.75,style:"finger",name:"C",octave:2,length:1/16}}),angular.extend(b.subbeats[1],{note:{volume:.75,style:"hammer",name:"D",octave:2,length:1/16}}),angular.extend(b.subbeats[3],{note:{volume:.75,style:"finger",name:"x"}}),angular.extend(b.subbeats[5],{note:{volume:.75,style:"slap",name:"G",octave:2,length:1/8}}),angular.extend(b.subbeats[7],{note:{volume:.75,style:"pull",name:"F",octave:2,length:1/16}}),e.bar=b,e.play=function(){var n=document.getElementById("time-marker"),t=angular.element(n);Velocity(n,{left:t.parent()[0].offsetWidth},{duration:4e3,easing:"linear",begin:function(){t.css("left","0px")}}),e.playing=!0,l.reset(),i(),o.play(.5)},e.stop=function(){e.playing=!1,o.stop()};var f,v;e.showNoteDialog=function(e,n){console.log("showNoteDialog");var t=angular.element(angular.element(n.target).parent().children()[2]);return v&&(v.addClass("closed"),v[0]===t[0])?void(v=null):(t.removeClass("closed"),f=e,void(v=t))}}n.$inject=["$scope","$timeout","$mdDialog","context","audioPlayer","audioVisualiser","NotesModel"],e.$inject=["$scope","$timeout"],angular.module("bd.app").controller("AppController",n).controller("LayoutAnimationController",e).value("context",new AudioContext)}();
!function(){"use strict";function t(){function t(){}return t.prototype.initialize=function(t,i){this.x=0,this.y=0,this.width=canvas.offsetWidth,this.height=canvas.offsetHeight,canvas.setAttribute("width",this.width),canvas.setAttribute("height",this.height),this.ctx=canvas.getContext("2d"),this.ctx.fillStyle="rgb(240, 240, 240)",this.ctx.lineWidth=1,this.ctx.strokeStyle="rgb(180, 0, 0)",this.dataArray=new Uint8Array(i.frequencyBinCount),this.analyser=i},t.prototype.reset=function(){this.ctx.clearRect(0,0,this.width,this.height),this.x=0,this.ctx.moveTo(0,this.y)},t.prototype.draw=function(){var t=this.ctx;this.analyser.getByteTimeDomainData(this.dataArray),t.beginPath(),t.moveTo(this.x,this.y);for(var i=0;i<this.analyser.frequencyBinCount;i+=60){var s=this.dataArray[i]/128;this.y=s*this.height/2,this.x>this.width&&this.reset(),0===i||t.lineTo(this.x,this.y),this.x+=.75}t.stroke()},new t}angular.module("bd.app").factory("audioVisualiser",t)}();
!function(){"use strict";function t(t,e){var o=[];t.bass.notes.scaleNotes.forEach(function(t){o.push.apply(o,t.label)}),t.notesLabels=o,t.playingStyles=["finger","slap","pop","tap","hammer","pull"],t.clearNote=function(e){if(console.log("clearNote"),console.log(e),e.note={},e.width>1)for(var o=e.width-1,e=e;o--;)e=e.bar.nextSubbeat(e),e.width=1;e.width=1,t.updateNote(e)},t.updateNote=function(e){t.$root.$broadcast("subbeatChanged",e)},t.checkMeasure=function(t){if(t.width>1)for(var e=t.width-1,o=t;e--;)o=t.bar.nextSubbeat(o),o.width=1;if(t.note.length&&(t.width=t.note.length/.25*4),t.width>1)for(var e=t.width-1,o=t;e--;)o=t.bar.nextSubbeat(o),o.width=0},t.bar.subbeats.forEach(t.checkMeasure)}t.$inject=["$scope","$timeout"],angular.module("bd.app").controller("NoteController",t)}();
...
!function(){"use strict";function t(t){function n(){this.playing=!1}function e(n){c.bufferList=n,p=t.createGain(),l=t.createGain(),d=t.createGain(),b=t.createGain(),i()}function i(){r=t.createBufferSource(),u=t.createBufferSource(),s=t.createBufferSource(),f=t.createBufferSource(),r.buffer=c.bufferList[0],u.buffer=c.bufferList[1],s.buffer=c.bufferList[2],f.buffer=c.bufferList[2],r.connect(p),u.connect(l),s.connect(d),f.connect(b)}function a(t,n){t.value-=n,t.value>0&&setTimeout(a,10,t,n)}function o(t,n,e){setTimeout(a,1e3*n,t,e)}var c=new BufferLoader(t,["sounds/slap-C.mp3","sounds/tap-D.mp3","sounds/E.mp3"],e);c.load();var r,u,s,f,p,l,d,b;return n.prototype.initialize=function(t){this.destination=t},n.prototype.playback=function(t){this.playing&&requestAnimationFrame(this.playback.bind(this))},n.prototype.play=function(n){this.playing=!0,i(),this.playback();var e=.025+.1*n,a=.01/e,c=t.currentTime;p.gain.value=1,console.log(this.destination),p.connect(this.destination),r.start(c,0,n),o(p.gain,n-.02,.1),l.gain.value=.5,l.connect(this.destination),u.start(c+n-.05,0,n+.05),o(l.gain,2*n-e,a),d.gain.value=.8,d.connect(this.destination),s.start(c+2*n,0,n),o(d.gain,3*n-e,a),b.gain.value=.8,b.connect(this.destination),f.start(c+3*n,0,n),o(b.gain,4*n-e,a)},n.prototype.stop=function(t){this.playing=!1},new n}t.$inject=["context"],angular.module("bd.app").factory("audioPlayer",t)}();
