...
!function(){"use strict";function e(e,a,n,t,s,o,r){function l(){var a,n=[];for(a=0;a<d.timeSignature.top;a++)for(g=0;4>g;g++){var t=new Array(e.bass.strings);e.bass.strings.forEach(function(e){t[e.index]={string:e,beat:a,subbeat:g,note:{style:"finger",length:1/8,volume:.75},width:1}}),n.push(t)}return n}function i(){var a,n=e.bass.presents.map(function(e){return"v4.bass.present."+e.name});for(a=0;a<localStorage.length;a++){var t=localStorage.key(a);if(t.startsWith("v4.bass.present.")&&-1===n.indexOf(t)){console.log("delete: "+t),localStorage.removeItem(t);break}}}function p(){var a,n=[];for(a=0;a<localStorage.length;a++){var t=localStorage.key(a);if(t.startsWith("v4.bass.present.")){var s=JSON.parse(localStorage.getItem(t));n.push(s)}}n?(e.bass.presents=n,e.loadBassPresent(n[0])):(e.bass.present={name:""},e.bass.presents=[e.bass.present])}var u;setTimeout(function(){u=t.createAnalyser(),u.fftSize=1024,u.connect(t.destination),s.initialize(u),o.initialize(document.getElementById("canvas"),u)},200),e.player={playing:!1,bpm:60};var b=new r("B0","G4");e.bass={notes:b,noteStringOctaves:function(e,a){var n=[];return b.list.slice(a.noteIndex,a.noteIndex+24).filter(function(a){-1!==a.label.indexOf(e)&&n.push(a.octave)}),n},stringFret:function(e,a){var n=a.name+a.octave,t=b.list.indexOf(b.map[n]),s=t-e.noteIndex;return s>=0&&24>=s?s:-1},strings:[{label:"E",octave:1,index:0,noteIndex:b.list.indexOf(b.map.E1)},{label:"A",octave:1,index:1,noteIndex:b.list.indexOf(b.map.A1)},{label:"D",octave:2,index:2,noteIndex:b.list.indexOf(b.map.D2)},{label:"G",octave:2,index:3,noteIndex:b.list.indexOf(b.map.G2)}].reverse(),playingStyles:{finger:{name:"finger",label:"Finger",noteLabel:function(e){return e.note.name?"{0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},slap:{name:"slap",label:"Slap",noteLabel:function(e){return e.note.name?"<sup>(Slap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},pop:{name:"pop",label:"Pop",noteLabel:function(e){return e.note.name?"<sup>(Pop)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},tap:{name:"tap",label:"Tap",noteLabel:function(e){return e.note.name?"<sup>(Tap)</sup> {0}<sub>{1}</sub>".format(e.note.name,e.note.octave||""):void 0}},hammer:{name:"hammer-on",label:"Hammer on",noteLabel:function(e){return e.note.name?'<span class="hammer-top">)</span>                <span class="hammer-bottom">h</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}},pull:{name:"pull-of",label:"Pull of",noteLabel:function(e){return e.note.name?'<span class="pull-top">p</span>                <span class="pull-bottom">)</span>{0}<sub>{1}</sub>'.format(e.note.name,e.note.octave||""):void 0}}}},e.bass.presents=[],console.log(e.bass);for(var m={top:4,bottom:4},c=[{name:""},{name:"i"},{name:"and"},{name:"a"}],d={timeSignature:m,subbeats:[],nextSubbeat:function(e){return this.subbeats[e._index+1]},prevSubbeat:function(e){return this.subbeats[e._index-1]}},f=1;12>=f;f++){var v=angular.copy(c);v[0].name="{0}".format(f),v.forEach(function(e,a){e._index=(f-1)*v.length+a,e.beat=f,e.index=a+1,e.bar=d,e.width=1,e.note={volume:.75}}),d.subbeats=d.subbeats.concat(v)}var g={note:{style:"finger",name:"A",octave:2,length:1/8,staccato:!1,string:1}},y=l();e.bassData=y,e.drumsData=[],e.bar=d,e.$watch("player.bpm",function(a){s.playing&&(s.stop(),s.setBpm(e.player.bpm),s.play({timeSignature:m,bass:e.bassData,drums:e.drumsData},o.beatSync.bind(o)))}),e.play=function(){e.player.playing=!0,o.reset(),s.setBpm(e.player.bpm),s.play({timeSignature:m,bass:e.bassData,drums:e.drumsData},o.beatSync.bind(o))},e.stop=function(){e.player.playing=!1,s.stop()},e.playBassSound=function(e){var a=angular.extend({style:"finger",noteLength:{length:.25},volume:.75},e);s.playSound(a)},e.newBar=function(){e.bass.present={name:"New",data:l()},e.bass.presents.push(e.bass.present),e.bassData=e.bass.present.data},e.deleteBar=function(a){var n=e.bass.presents.indexOf(a);e.bass.presents.splice(n,1),i(),e.bass.presents?e.loadBassPresent(e.bass.presents[0]):(e.bass.present={name:""},e.bass.presents=[e.bass.present])},e.saveBar=function(){i();var a="v4.bass.present."+e.bass.present.name;e.bass.present.data=e.bassData,console.log(e.bass.present);var n=e.bass.present,t={name:n.name,data:n.data};console.log(t),localStorage.setItem(a,JSON.stringify(t))},e.loadBassPresent=function(a){a&&a!==e.bass.present&&(console.log("Load: "+a.name),e.bassData=a.data,e.bass.present=a)},p()}e.$inject=["$scope","$timeout","$mdDialog","context","audioPlayer","audioVisualiser","NotesModel"],angular.module("bd.app").controller("AppController",e).value("context",new AudioContext)}();
