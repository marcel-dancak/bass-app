        ...
        return {
            ...
            link: function(scope, element, attr) {
                ...
                var updateInfo = function() {
                    ...
                    if(axis == 'x')
                        info.width = scope.rFlex ? parseInt(element[0].style.flexBasis) : parseInt(element[0].style.width) || element[0].clientWidth;
                    else
                ...
                var dragEnd = function(e) {
                    ...
                    // scope.onResizeEnd({info: info, '$event': e});
                    // scope.$apply();
                    $timeout(function() {
                        scope.onResizeEnd({info: info, '$event': e});
                    }, 60);
